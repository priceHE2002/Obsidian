...
| 泊松积分 | $\int_0^\infty e^{-x^2}\,\mathrm{d}x = \dfrac{\sqrt{\pi}}{2}$ | 概率论高频 |
...
- 三角组合积分：$\sin\cos$ 奇次凑微分、偶次降幂；$1$ 的妙用、$\cos$ 消 1、$\sin\cos$ 转 $\sin$；$\dfrac{C\sin x+D\cos x}{A\sin x+B\cos x}$ 拆成 $E(A\sin x+B\cos x)+F(A\cos x-B\sin x)$
