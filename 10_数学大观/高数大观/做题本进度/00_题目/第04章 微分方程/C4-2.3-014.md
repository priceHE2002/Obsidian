...
备注:
---
# 2.3-014 · 高阶常系数线性齐次微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> y′′′+y′′−2y =exsin2x 设 为常数，则微分方程 有特解形如（ ） A,B,C ex(A−B
> xcos2x−Cxsin2x) ex(A+Bcos2x+Csin2x) A. B. ex(Ax−Bxcos2
> x−Cxsin2x) ex(Ax+Bcos2x+Csin2x) C. D. 已知解反求微分方程（逆问题） 3
>  一阶
>
> 题源：900 第六章数二 B 类 3　|　题源类型：900　|　页码：p.300　|　模块：2.3 高阶常系数线性齐次微分方程
