...
> −y ∆2y 差分方程 的通解为 y = =5 t x x = 的通解为 的基础上再追加 百万元．若以 表示
> 第 30% 4 W t t 满足的差分方程是 ． W t 5%，希望连续 年以每年 元的速率取款，若 以年为
> 单 20 12000 t 元。 −y =t2−1 的特解具有形式 y t+1 t y¯(t)=At3+Bt2
> +Ct B. y¯(t)=At2+Bt+C D. 的一个特解是 π π t−cos B. y¯(t)=2si
> n t 2 2 π π y¯(t)=−2sin D. t+cos t 2 2 ·第 页，共 页· 287 4
> 02
>
> 题源：2018 数三　|　题源类型：真题　|　页码：p.298　|　模块：2.2 二阶
