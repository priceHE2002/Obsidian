...
> y′+py =eqx 若微分方程 的任何积分曲线均有拐点, 则 ( ). A. p+q >0 B. p+q 
> <0 p=−q ̸=0 ̸=0,pq ̸=0 C. D. p+q 微分方程解的切法线
>
> 题源：26 版 1000 第十五章强化 39　|　题源类型：1000　|　页码：p.309　|　模块：4.4 4.4
