...
> f′(x)−g(x)=ex g′(x)−f(x)=0，f(0)=g(0)=0，计算 已知函数 满足方程 及 
> f(x),g(x) Z 1 −x2 ′ ′ (x)−2xg e f (x) dx. 0
>
> 题源：26 版 1000 第十五章强化 21　|　题源类型：1000　|　页码：p.313　|　模块：5.2 含导数等式
