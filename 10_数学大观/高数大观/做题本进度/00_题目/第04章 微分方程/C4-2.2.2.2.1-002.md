...
> 设微分方程 d2y dy −2xy −3x. + +e =e dx2 dx t=e−x 利用变换 将微分方程
> 化为 关于 的方程，并求原方程的通解 y(x)； (I) y t 若 中的 满足 y(x)=1，y(0)=1
> ，求 y(x)。 (II) (I) y(x) lim x→+∞ ▶2.2.2.2.2 二阶欧拉齐次
>
> 题源：880 第六章综合解答 3　|　题源类型：880　|　页码：p.295　|　模块：2.2 二阶
