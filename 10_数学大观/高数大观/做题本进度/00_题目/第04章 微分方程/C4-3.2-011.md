...
> (10)若二阶常系数线性齐次微分方程y′′+ay′+by x)ex，则非齐次方程y′′+ay′+by =0的
> 通解为y =(C +C = 1 2 y(0)=2，y′(0)=0 满足条件 的解为 x y = ·第 页，共
>  页· 291 402
>
> 题源：2009 数一; 880 第六章综合选择 2　|　题源类型：真题　|　页码：p.302　|　模块：3.2 二阶
