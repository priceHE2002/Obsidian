...
> [0,+∞) 【25】设 在 上有二阶连续的导数，点 为凹曲线 上任意一点，沿曲线从 y(x) P(x,y)
> (x>0) y =y(x) 点 到点 的弧长在数值上等于该曲线在点 处的切线的斜率，且曲线在点 处有水平 (
> 0,1) P(x,y) P(x,y) (0,1) 切线。 求 的表达式；(cid:18) (I) y =y(
> x) 5 5 求曲线 从点 到点 的一段弧长。 (II) y =y(x) ln2, ln3, 4 3
>
> 题源：880 第六章综合解答 25　|　题源类型：880　|　页码：p.318　|　模块：5.4 5.4
