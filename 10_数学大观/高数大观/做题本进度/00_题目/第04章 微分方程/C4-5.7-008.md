...
> 有二阶连续导数，f(1)=f′(1)=1，在 【13】设 的平面区域内，存在函数 u(x,y)，使得 f(t
> ) x>0 (cid:17)(cid:21) h (cid:17)i y2 y y ′ y−xf du(x,
> y)= +xf dx+ dy. x x x 求 的极值。 及 f(t) f(t)
>
> 题源：880 第六章综合解答 13　|　题源类型：880　|　页码：p.326　|　模块：5.7 多元微分
