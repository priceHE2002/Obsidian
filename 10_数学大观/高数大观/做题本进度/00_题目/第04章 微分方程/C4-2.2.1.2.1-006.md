...
> y′′−3y′+2y =3x−2ex 设 为待定常数，则微分方程 的特解具有形式 a,b,c (ax+b)e
> x (A) (ax+b)xex (B) (ax+b)+cex (C) (ax+b)+cxex (D) (ax
> +b)ex (ax+b)xex A. B. (ax+b)+cex (ax+b)+cxex C. D. ·第 
> 页，共 页· 278 402
>
> 题源：26 版 660 数一二三第 213 题　|　题源类型：660　|　页码：p.289　|　模块：2.2 二阶
