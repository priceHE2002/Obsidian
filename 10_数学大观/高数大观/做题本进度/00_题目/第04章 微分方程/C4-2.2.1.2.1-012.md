...
> y′′+4y =sin2x 设下列 为任意常数，则微分方程 有特解形如（）. A,B,C Asin2x Ac
> os2x A. B. C. x(A+Bcos2x+Csin2x) D. A+x(Bcos2x+Csin2x)
>  ▶2.2.1.2.2 非齐次项为幂指函数
>
> 题源：26 版 1000 第十五章强化 23　|　题源类型：1000　|　页码：p.290　|　模块：2.2 二阶
