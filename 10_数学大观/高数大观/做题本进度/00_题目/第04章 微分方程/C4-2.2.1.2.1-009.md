...
> y′′−2y′+5y =excos2x 设 都是不等于零的常数，则微分方程 有特解 A,B y∗ y∗ =x
> ex(Acos2x+Bsin2x) =ex(Acos2x+Bsin2x) A. B. y∗ y∗ =Axex
> cos2x =Axexsin2x C. D.
>
> 题源：26 版 660 数一二三第 215 题　|　题源类型：660　|　页码：p.290　|　模块：2.2 二阶
