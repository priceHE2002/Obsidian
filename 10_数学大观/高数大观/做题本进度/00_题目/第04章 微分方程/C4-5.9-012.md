...
> 某汽车生产厂家测试一种新型刹车元件。现有一质量为 的汽车，开始刹车时的初始速度为 km/h。 1500 kg
>  70 3.5×106）。问从刹车点算 经测试，开始刹车后，汽车所受的总阻力与汽车的速度成正比（比例系数为 
> k = 起，汽车滑行的最长距离是多少？ （注：kg 表示千克，km/h 表示千米/小时。）
>
> 题源：900 第六章数二 B 类 29　|　题源类型：900　|　页码：p.330　|　模块：5.9 物理及实际应用
