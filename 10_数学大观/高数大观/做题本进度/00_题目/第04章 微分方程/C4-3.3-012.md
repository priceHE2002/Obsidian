...
> y′′ −3y′ y′′′ −2ay′′ 已知二阶常系数齐次线性微分方程 的解都是三阶常系数齐次线性微分方程
>  +2y = 0 + (a2+2)y′−2ay 的解，则 =0 a= 处理微分方程解 4 微分方程解的有界性
> 、奇偶性、周期性
>
> 题源：900 第六章数二 B 类 10（重点）　|　题源类型：900　|　页码：p.305　|　模块：3.3 三阶及以上
