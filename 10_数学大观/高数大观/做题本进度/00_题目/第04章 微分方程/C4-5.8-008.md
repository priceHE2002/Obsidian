...
> 【11】设 8 (cid:16)p (cid:17)3 2 ZZ >>>< x2+y2 F 4 5 1− x
>  dxdy, t>0, x2+y2 x2+y2⩽t2 F(t)= >>>: x⩾0,y⩾0 0, t=0, 
> [0,+∞) 在 上连续，求函数 的表达式。 F(t)
>
> 题源：880 第五章综合解答 11　|　题源类型：880　|　页码：p.328　|　模块：5.8 二重积分
