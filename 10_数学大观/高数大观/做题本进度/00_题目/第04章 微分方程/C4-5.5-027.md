...
> Z x 1 (−∞,+∞) f(x)− f(t)dt=− 设函数 在 上连续，且满足 f(x) +sinx.
>  2 0 求 的表达式； (1) f(x) π 5π 求曲线 与 在 上围成的图形绕 轴旋转一周所成旋转体的
> 体积。 (2) y =f(x) y =0 , x 4 4
>
> 题源：26 版 1000 第十五章强化 20　|　题源类型：1000　|　页码：p.322　|　模块：5.5 变限积分
