...
> y′′+ay′+by (−∞,+∞) 下列四种情形中，可使得微分方程 的所有解在 上都有界的个数为（） =0
>  ⃝ a=0,b>0． 1 ⃝ a=0,b<0． 2 ⃝ a>0,b=0． 3 ⃝ a<0,b=0． 4 A
> . 1 B. 2 C. 3 D. 4 ·第 页，共 页· 294 402
>
> 题源：900 第六章数二 B 类 6　|　题源类型：900　|　页码：p.305　|　模块：4.1 4.1
