...
> 设 是一条平面曲(cid:18)线，(cid:19)其上任意一点 到坐标原点的距离恒等于该点处的切线在 轴上
> 的截 L P(x,y)(x > 0) y 1 距，且 经过点 L ,0 2 （1）试求曲线 的方程； L （
> 2）求 位于第一象限部分的一条切线，使该切线与 以及两坐标轴所围图形的面积最小。 L L
>
> 题源：2001 数二　|　题源类型：真题　|　页码：p.315　|　模块：5.4 5.4
