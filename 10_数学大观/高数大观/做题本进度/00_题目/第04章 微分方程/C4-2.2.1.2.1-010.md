...
> y′′+2y′+5y =e−xcos2x 设 为常数，则微分方程 有特解形如（ ） A,B,C e−x(Ac
> osx+Bsinx) e−x(Axcosx+Bxsinx) A. B. e−x(A+Bxcos2x+Cxsi
> n2x) e−x(Ax+Bcos2x+Csin2x) C. D.
>
> 题源：900 第六章数二 B 类 1　|　题源类型：900　|　页码：p.290　|　模块：2.2 二阶
