...
> [0,+∞) (0,+∞) 设函数 在 上连续，在 上可导，f(0)=0，且存在反函数，其反函数为 若 f(
> x) g(x). Z Z f(x) x f(t)dt=xex−ex+1. g(t)dt+ 0 0 求 f(x
> ).
>
> 题源：26 版 1000 第十五章强化 37　|　题源类型：1000　|　页码：p.320　|　模块：5.5 变限积分
