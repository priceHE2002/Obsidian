...
> y′′+y =x2+1+sinx 微分方程 的特解形式可设为（ ）。 (11) y∗ y∗ =ax2+bx+
> c+x(Asinx+Bcosx) =x(ax2+bx+c+Asinx+Bcosx) A. B. y∗ y∗ 
> =ax2+bx+c+Asinx =ax2+bx+c+Acosx C. D.
>
> 题源：2004 数二　|　题源类型：真题　|　页码：p.289　|　模块：2.2 二阶
