...
> e2x，则该微分方程为（）。 设三阶常系数齐次线性微分方程有特解 与 cosx y′′′+2y′′+y′+2
> y y′′′−2y′′+y′−2y A. =0 B. =0 y′′′+2y′′−y′+2y y′′′−2y′
> ′−y′+2y C. =0 D. =0
>
> 题源：26 版 1000 第十五章强化 29　|　题源类型：1000　|　页码：p.304　|　模块：3.3 三阶及以上
