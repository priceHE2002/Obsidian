...
> 【20】设曲线 在点 处有水平切线，曲线上任一点 处的曲率 y =y(x)(y >0) (0,2) (x,y
> ) 1 1 ′′ √ √ K = , y (x)>0 y(1+y′2) 2 2 =y(x)(x⩾0)，并求 
> 记 =y(x)，x=0，x=2 及 轴所围图形为 D，求 绕 旋转一周所得旋转 y x y D x=2 体的
> 体积。 ·第 页，共 页· 307 402
>
> 题源：880 第六章综合解答 20　|　题源类型：880　|　页码：p.318　|　模块：5.4 5.4
