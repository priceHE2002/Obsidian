...
> y (0,+∞) 【14】设 在 内有二阶连续导数，记 。若 满足 f(t) g(x,y)=f g(x,y)
>  x ∂2g ∂2g ∂2g x3 +x2y +xy2 =y, ∂x2 ∂y2 ∂x∂y ∂g(cid:12
> ) 2 且 g(y,y)=1， ，求 f(t)。 = ∂y y (y,y)
>
> 题源：880 第六章综合解答 14　|　题源类型：880　|　页码：p.326　|　模块：5.7 多元微分
