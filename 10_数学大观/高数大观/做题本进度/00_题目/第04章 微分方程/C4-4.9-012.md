...
> y′′+4y′+4y 设曲线 过原点且在原点处与曲线 有公共切线，且函数 满足方程 0， y = y(x) 
> y = sinx y(x) = Z +∞ 则 y(x)dx= . 0
>
> 题源：26 版 1000 第十五章强化 42　|　题源类型：1000　|　页码：p.312　|　模块：4.9 微分方程解的反常积分
