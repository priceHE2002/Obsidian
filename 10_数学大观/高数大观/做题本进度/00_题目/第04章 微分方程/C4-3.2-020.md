...
> 1 1 cos2x− sin2x− 已知 xcos2x，y 是某二阶线性常系数非齐次微分方程的两个解，y y
>  = = xcos2x = 1 2 3 4 4 是它所对应的齐次方程的一个解，则该微分方程是 cos2x 三
> 阶及以上
>
> 题源：26 版 660 数一二三第 84 题　|　题源类型：660　|　页码：p.303　|　模块：3.2 二阶
