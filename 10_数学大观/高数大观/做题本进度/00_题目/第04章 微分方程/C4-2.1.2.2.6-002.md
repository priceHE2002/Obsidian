...
源题号: "2.1.2.2.6-002"
序: 2276
题源: "1994 数一; 26 版 1000 第十五章强化 51"
题源大类: "真题"
重点: false
页码: 287
状态: "未开始"
...
> 具有二阶连续导数，f(0)=0，f′(0)=1，且 设 f(x) ′ [xy(x+y)−f(x)y]dx+[
> f (x)+x2y]dy =0 为一全微分方程，求 及此全微分方程的通解。 f(x)
>
> 题源：1994 数一; 26 版 1000 第十五章强化 51　|　题源类型：真题　|　页码：p.287　|　模块：2.1 一阶
