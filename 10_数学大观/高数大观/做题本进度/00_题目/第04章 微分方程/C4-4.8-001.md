...
备注:
---
# 4.8-001 · 微分方程解的定积分（应用）

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z 1 ∗ (1+x2)y′−2xy y∗(x)，则 设微分方程 满足 的特解是 =x y(0)=1 y (
> x)dx= 0 3 1 1 3 − − A. B. C. D. 2 2 2 2
>
> 题源：26 版 660 数三第 217 题　|　题源类型：660　|　页码：p.310　|　模块：4.8 微分方程解的定积分（应用）
