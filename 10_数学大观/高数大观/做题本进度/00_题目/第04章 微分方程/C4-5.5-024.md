...
> Z x ′ x⩾0 f(x)=−1+x+2 (x−t)f(t)f 设当 时，f(x) 有连续的一阶导数，并且
> 满足 (t)dt，则 f(x)= 0 ·第 页，共 页· 310 402
>
> 题源：26 版 1000 第十五章强化 11　|　题源类型：1000　|　页码：p.321　|　模块：5.5 变限积分
