...
> x2y′′+2xy′−2y 方程 的通解为 =0 ex+C e2x x)ex A. y =C B. y =(
> C +C 1 2 1 2 C 1 x2 +C x C. y =C x+C D. y = 2 1 2 x2 ▶
> 2.2.2.3 反函数
>
> 题源：26 版 660 数一第 222 题　|　题源类型：660　|　页码：p.295　|　模块：2.2 二阶
