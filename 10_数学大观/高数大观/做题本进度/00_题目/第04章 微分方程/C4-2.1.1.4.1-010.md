...
> 8 <dy +λy =1, λ∈(−∞,+∞)，则 dx 设 是微分方程满足初值 的解，其中参数 的表 y 
> =φ(x,λ) y =φ(x,λ) : y(0)=0 达式是 ·第 页，共 页· 270 402
>
> 题源：26 版 660 数二第 500 题　|　题源类型：660　|　页码：p.281　|　模块：2.1 一阶
