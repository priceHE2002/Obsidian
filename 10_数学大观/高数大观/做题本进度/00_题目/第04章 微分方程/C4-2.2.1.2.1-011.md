...
> y′′+4y =x2−2x−sin2x 微分方程 的特解形式为（） ax2+bx+c+Acos2x+Bsin
> 2x x(ax2+bx+c)+Acos2x+Bsin2x A. B. ax2+bx+c+x(Acos2x+B
> sin2x) x(ax2+bx+c+Acos2x+Bsin2x) C. D.
>
> 题源：900 第六章数二 A 类 9　|　题源类型：900　|　页码：p.290　|　模块：2.2 二阶
