...
源题号: "3.3-005"
序: 2473
题源: "2008 数一二; 26 版 660 数二第 609 题"
题源大类: "真题"
重点: false
页码: 304
状态: "未开始"
...
> ex+C 在下列微分方程中，以 sin2x（C 为任意常数）为通解的是（ ）． y =C cos2x+C ,
> C ,C 1 2 3 1 2 3 y′′′+y′′−4y′−4y y′′′+y′′+4y′+4y A. =0
>  B. =0 y′′′−y′′−4y′+4y y′′′−y′′+4y′−4y C. =0 D. =0
>
> 题源：2008 数一二; 26 版 660 数二第 609 题　|　题源类型：真题　|　页码：p.304　|　模块：3.3 三阶及以上
