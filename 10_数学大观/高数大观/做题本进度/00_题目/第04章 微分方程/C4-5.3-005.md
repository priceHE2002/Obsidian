...
> y∆x =y(x)在[0,+∞)可导，在∀x∈(0,+∞)处的增量∆y =y(x+∆x)−y(x)满足∆y(
> 1+∆y)= 设y +α， 1+x ∆x→0 其中 当 时是与 等价的无穷小. 又 y(0)=1，则 α ∆
> x y(x)= .
>
> 题源：25 版 660 数一二三第 76 题　|　题源类型：660　|　页码：p.314　|　模块：5.3 导数定义
