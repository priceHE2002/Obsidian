...
> y′(x) 【24】设在第一象限内的曲线 满足 0，且 0，曲线上任一点 处的切线段为 y = y(x) y
> (0) = > M(x,y) 所示，△PMT MT，(cid:18)点 M(cid:19)到 轴的垂线为 P
> M，如图 的面积与曲边三角形 的面积之比恒为常 x 6-1 OPM 1 数 。求 =y(x)。 k k > 
> y 2
>
> 题源：880 第六章综合解答 24　|　题源类型：880　|　页码：p.325　|　模块：5.6 定积分应用（面积体积）
