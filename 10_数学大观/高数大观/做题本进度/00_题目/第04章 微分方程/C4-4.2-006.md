...
备注:
---
# 4.2-006 · 微分方程解的极限及渐近线

> [!question] 题目（程序自动提取，公式可能有偏差）
> [0,+∞) =b̸=0，则（ 设 在 上连续且有水平渐近线 ）. f(x) y b 时，y′+ay 当 的
> 任意解都满足 A. a>0 =f(x) lim y(x)= a x→+∞ ·第 页，共 页· 296 402
>
> 题源：26 版 1000 第十五章强化 4　|　题源类型：1000　|　页码：p.307　|　模块：4.2 微分方程解的极限及渐近线
