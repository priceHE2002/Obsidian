...
> (y2−1)dx+(2xy−cosy)dy 其中 为任意常数，微分方程 的通解是 C =0 y2x−siny
>  y2x−cosy A. =C B. =C (y2−1)x−cosy (y2−1)x−siny C. =C 
> D. =C
>
> 题源：26 版 660 数一第 217 题　|　题源类型：660　|　页码：p.286　|　模块：2.1 一阶
