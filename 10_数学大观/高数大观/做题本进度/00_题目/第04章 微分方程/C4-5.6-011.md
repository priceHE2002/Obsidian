...
> d d d 【8】设 是连接 和 的一段向上凸的曲线弧，P(x,y) 为 上任一点，曲线弧 与有向 OA O
> (0,0) A(1,1) OA OP d x2，求曲线弧 线段 所围图形的面积为 的方程。 OP OA ·第
>  页，共 页· 313 402
>
> 题源：880 第六章基础解答 8　|　题源类型：880　|　页码：p.324　|　模块：5.6 定积分应用（面积体积）
