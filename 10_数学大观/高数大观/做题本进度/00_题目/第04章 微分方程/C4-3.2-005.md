...
> y∗ e−2x+(x2+2)ex y′′+ay′+by (cx+d)ex 已知 是二阶常系数线性非齐次微分方
> 程 的一个特解，则 = = 方程中的系数 与 以及非齐次项中的常数 和 分别是 a b c d a=1,b=
> −2,c=6,d=2 a=1,b=2,c=6,d=−2 A. B. a=1,b=−2,c=−6,d=2 a=
> 1,b=−2,c=6,d=−2 C. D.
>
> 题源：26 版 660 数一二三第 220 题　|　题源类型：660　|　页码：p.302　|　模块：3.2 二阶
