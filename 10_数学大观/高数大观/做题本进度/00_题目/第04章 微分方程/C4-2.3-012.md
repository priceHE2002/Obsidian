...
备注:
---
# 2.3-012 · 高阶常系数线性齐次微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 φ(x) < x̸=0, , cosx+cos2x−2 连续，其中φ(x)满足微分方程y′′′−4y′ 
> 设定义在[−1,1]上的函数f(x)= =0， : −8, x=0 则 φ(x)=
>
> 题源：900 第六章数二 B 类 13　|　题源类型：900　|　页码：p.300　|　模块：2.3 高阶常系数线性齐次微分方程
