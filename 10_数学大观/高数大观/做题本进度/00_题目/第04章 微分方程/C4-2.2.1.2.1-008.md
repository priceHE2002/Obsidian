...
> 4y′′−12y′+9y =e3 x(3x2+2) 微分方程 的特解形式为 ( ). 2 Ax2+Bx+C+
> De3 3x x (Ax2+Bx+C)e2 A. B. 2 3x 3x x(Ax2+Bx+C)e2 x2(A
> x2+Bx+C)e2 C. D.
>
> 题源：26 版 1000 第十五章基础 17　|　题源类型：1000　|　页码：p.290　|　模块：2.2 二阶
