...
源题号: "3.2-010"
序: 2458
题源: "26 版 660 数三第 637 题; 26 版 660 数二第 608 题"
题源大类: "660"
重点: false
页码: 302
状态: "未开始"
...
> e−x−2xe−x e2x+C 设 是两个任意常数，则函数 满足的一个微分方程是 C ,C y =C 1 2
>  1 2 y′′+y′−2y =6e−x y′′−y′−2y =6e−x A. B. y′′+y′−2y =
> 3xe−x y′′−y′−2y =3xe−x C. D.
>
> 题源：26 版 660 数三第 637 题; 26 版 660 数二第 608 题　|　题源类型：660　|　页码：p.302　|　模块：3.2 二阶
