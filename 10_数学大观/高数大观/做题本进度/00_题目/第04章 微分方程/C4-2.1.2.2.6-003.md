...
> [f(x)−ex]sinydx−f(x)cosydy 设 是一个二元函数的全微分，且 具有一阶连续导数，f(
> 0) 0，则 f(x) = 等于 f(x) ex+e−x ex+e−x −1 1− A. B. 2 2 e−
> x−ex ex−e−x C. D. 2 2 ▶2.1.2.3 含多个三角
>
> 题源：26 版 660 数二三第 222 题　|　题源类型：660　|　页码：p.287　|　模块：2.1 一阶
