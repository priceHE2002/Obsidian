...
> =y(x)经过原点，且在原点的切线平行于直线2x−y−5=0，而y(x)满足微分方程y′′−6y′+9y 已
> 知曲线y = e3x，则此曲线的方程为 1 x2e2x+sin2x A. y =sin2x B. y = 2
>  x (x+4)e3x =(x2cosx+sin2x)e3x C. y = D. y 2
>
> 题源：26 版 660 数一二三第 214 题　|　题源类型：660　|　页码：p.292　|　模块：2.2 二阶
