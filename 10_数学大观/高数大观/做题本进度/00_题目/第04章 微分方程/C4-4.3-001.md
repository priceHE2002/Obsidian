...
> 1 ey 已知微分方程 满足 =t+ y(0)=0. y′ 求该微分方程的特解 (1) y =y(t); (
>  √ d2y 1+t2, x= 设 计算 (2) . dx2 y =y(t), t=1
>
> 题源：26 版 1000 第十五章基础 7　|　题源类型：1000　|　页码：p.308　|　模块：4.3 微分方程解的导数
