...
> 【5】发现一架飞机在原点 处沿 轴正向以常速度 飞行，随即从点 处发射导弹追击，且导 O(0,0) y v 
> P (16,0) 0 弹方向始终指向飞机，导弹速度为 2v，如图 所示。求： 6-2 （I）导弹飞行轨迹 的
> 表达式； y =y(x) ·第 页，共 页· 319 402
>
> 题源：880 第六章拓展 5　|　题源类型：880　|　页码：p.330　|　模块：5.9 物理及实际应用
