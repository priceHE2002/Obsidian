...
> 【7】设 是一条(cid:18)平面(cid:19)曲线，其上任意一点 到原点的距离恒等于该点处的切线在 轴
> 上的截 L P(x,y)(x > 0) y 1 距，且 过点 L ,0 . 2 求曲线 的方程； (I) L
>  求 位于第一象限部分的一条切线，使该切线与 以及两坐标轴所围的面积最小. (II) L L
>
> 题源：880 第六章基础解答 7　|　题源类型：880　|　页码：p.317　|　模块：5.4 5.4
