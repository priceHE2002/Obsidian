...
> y′′+p(x)y′+q(x)y （3）设线性无关的函数 都是二阶非齐次线性方程 的特解，C 是任 y ,y
>  ,y = f(x) ,C 1 2 3 1 2 意常数，则该非齐次方程的通解是（ ） −(C A. C y 
> +C y +y B. C y +C y +C )y 1 1 2 2 3 1 1 2 2 1 2 3 −(1−
> C −C +(1−C −C C. C y +C y )y D. C y +C y )y 1 1 2 2 1 
> 2 3 1 1 2 2 1 2 3
>
> 题源：1989 数一　|　题源类型：真题　|　页码：p.278　|　模块：1.2 二阶及以上
