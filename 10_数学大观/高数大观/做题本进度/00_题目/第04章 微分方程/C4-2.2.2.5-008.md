...
> 2 f′(x)=f 设函数 满足 f(x) (x>0). x x2f′′(x)+2f(x)=0(x>0); 
> 证明 (1) x=et, 令 化 中方程为常系数线性微分方程, 并求 (2) (1) f(x). 差分方程（
> 数学三）
>
> 题源：26 版 1000 第十五章强化 44　|　题源类型：1000　|　页码：p.297　|　模块：2.2 二阶
