...
> Z x 【例4.12】设f(x)为[0,+∞)上的非负连续函数，曲线y f(u)du，x轴，x=t(t>0)
> 所围区域绕y 轴 = 0 t2，求 旋转一周所得旋转体的体积与曲线 =f(x)，x 轴，x=0，x=t(t>
> 0) 所围区域的面积之和为 f(x)。 y
>
> 题源：姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.324　|　模块：5.6 定积分应用（面积体积）
