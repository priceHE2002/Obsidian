...
> y′(x) ⩾ 设函数 二阶可导且 0，y(0) 1。过曲线 上任意一点 作该曲线的切线 y(x)(x 0)
>  > = y = y(x) P(x,y) 及 轴的垂线，上述两直线与 轴所围成的三角形的面积记为 ，区间 上
> 以 为曲边的曲边 x x S [0,x] y =y(x) 1 −S 梯形面积记为 ，并设 恒为 1，求此曲线
>  的方程。 S 2S y =y(x) 2 1 2
>
> 题源：1999 数一二; 880 第六章综合解答 23　|　题源类型：真题　|　页码：p.323　|　模块：5.6 定积分应用（面积体积）
