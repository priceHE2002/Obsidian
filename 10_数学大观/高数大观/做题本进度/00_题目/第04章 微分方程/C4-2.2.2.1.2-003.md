...
> ( 1+(y′)2 =2yy′′, 初值问题 的特解是 y′(1)=−1 y(1)=1, 1 1 (x2−4
> x+5) (x2−3x+4) A. y = B. y = 2 2 =−x2+x+1 =x2−3x+3 C. 
> y D. y ▶2.2.2.2 欧拉方程 ·第 页，共 页· 283 402
>
> 题源：26 版 660 数二第 217 题　|　题源类型：660　|　页码：p.294　|　模块：2.2 二阶
