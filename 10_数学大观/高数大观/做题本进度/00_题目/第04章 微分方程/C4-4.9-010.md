...
> y′′ +2my′ y′(0) +n2y 设 是二阶常系数线性微分方程 满足 与 的特解，其中 y = y(
> x) = 0 y(0) = a = b Z +∞ m>n>0，则 y(x)dx= . 0 ·第 页，共 页·
>  300 402
>
> 题源：26 版 660 数一二三第 81 题　|　题源类型：660　|　页码：p.311　|　模块：4.9 微分方程解的反常积分
