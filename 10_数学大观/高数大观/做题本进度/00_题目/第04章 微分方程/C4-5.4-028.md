...
> 设第一象限中有一光滑凹曲线 与 轴相切于 (1,0)，其上任意两点 之间的弧长等于曲线在 y = f(x) 
> x A,B 点的切线在 轴上的截距之间的距离，求 的表达式。 A,B y f(x)
>
> 题源：26 版 1000 第十五章强化 50　|　题源类型：1000　|　页码：p.318　|　模块：5.4 5.4
