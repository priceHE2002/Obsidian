...
> y′+p(x)y （2）设 是一阶线性非齐次微分方程 的两个特解，若常数 使 是该方程 y ,y =q(x)
>  λ,µ λy +µy 1 2 1 2 −µy 的解，λy 是该方程对应的齐次方程的解，则（ ） 1 2 1
>  1 1 1 λ=− ,µ=− A. λ= ,µ= B. 2 2 2 2 1 2 2 2 ,µ= D. λ=
>  ,µ= C. λ= 3 3 3 3
>
> 题源：2010 数二三; 880 第六章综合选择 4　|　题源类型：真题　|　页码：p.277　|　模块：1.1 一阶
