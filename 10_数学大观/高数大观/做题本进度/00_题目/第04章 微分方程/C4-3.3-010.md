...
> =xex, =exsinx 以函数 为特解的最低阶常系数齐次线性微分方程是 y y ( ). 1 2 y′′
> ′−3y′′+4y′−2y y′′′+y′′−y′+y A. =0 B. =0 y(4)−2y′′′+y′′
> +2y′−2y y(4)−4y′′′+7y′′−6y′+2y C. =0 D. =0
>
> 题源：26 版 1000 第十五章强化 30　|　题源类型：1000　|　页码：p.305　|　模块：3.3 三阶及以上
