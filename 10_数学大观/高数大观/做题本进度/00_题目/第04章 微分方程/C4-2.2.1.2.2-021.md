...
> y′′−y x→0 =x2 x2 设 的解 是当 时较 高阶的无穷小量，则 y =φ(x) φ(x)= ex
> +e−x−x2−2 ex+e−x−x2−2x2 A. B. ex−e−x2 ex−e−x+x2−2 +2x2
>  C. D. ▶2.2.1.2.3 非齐次项为三角函数
>
> 题源：26 版 660 数一二三第 223 题　|　题源类型：660　|　页码：p.292　|　模块：2.2 二阶
