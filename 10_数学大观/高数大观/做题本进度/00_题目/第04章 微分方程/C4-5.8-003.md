...
> [0,+∞) 【2】设 在 上连续，且满足 f(t) (cid:19)(cid:21) ZZ p 1 f(t
> )=e4πt2 x2−y2+f x2+y2 dxdy. + 2 x2+y2⩽4t2 求 f(t)； (I) 
> 1 求 (II) lim [f(t)]t 2. t→0+
>
> 题源：880 第六章拓展 2　|　题源类型：880　|　页码：p.327　|　模块：5.8 二重积分
