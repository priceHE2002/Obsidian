...
> e4 x(lnx−1)y′(x)+(3−lnx2)y(x)=0，x>e，且 y(e2)= 已知函数 满足 ，
> 求 的最小值。 y =y(x) y =y(x) 2 ·第 页，共 页· 298 402
>
> 题源：26 版 1000 第十五章强化 16　|　题源类型：1000　|　页码：p.309　|　模块：4.6 微分方程解的最值
