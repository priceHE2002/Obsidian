...
> p p ∂2u ∂2u 1∂u − +u=x2+y2, 设 有二阶连续的偏导数，且满足 则 x2+y2) x
> 2+y2 u=u( (r = >0) + ∂x2 ∂y2 x∂x p x2+y2)= u( .
>
> 题源：26 版 660 数一二三第 592 题　|　题源类型：660　|　页码：p.326　|　模块：5.7 多元微分
