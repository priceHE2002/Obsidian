...
> y′+p(x)y 已知 和 是方程 的两个不同的特解，则该方程的通解为 y (x) y (x) =0 1 2
>  A. y =Cy (x) B. y =Cy (x) 1 2 (x)−y C. y =C y (x)+C y
>  (x) D. y =C(y (x)) 1 1 2 2 1 2 ·第 页，共 页· 266 402
>
> 题源：26 版 660 数一二三第 210 题　|　题源类型：660　|　页码：p.277　|　模块：1.1 一阶
