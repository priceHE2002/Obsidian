...
> ∂2F y2 ∂2F y − 设函数f(u)在(0,+∞)内具有二阶连续导数. 二元函数F(x,y)=x2f
>  +f(xy)，且满足 = ∂x2 x2 ∂y2 x 2y y 若 f(1)=1，求 的表达式. ln . 
> f(u) x x ·第 页，共 页· 315 402
>
> 题源：900 第六章数二 B 类 18　|　题源类型：900　|　页码：p.326　|　模块：5.7 多元微分
