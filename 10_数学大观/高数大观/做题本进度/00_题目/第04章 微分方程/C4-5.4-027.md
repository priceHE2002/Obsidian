...
> 设曲线 为 上任意一点, 为 上的一定点, 且曲线 与极径 所围成 L:r =r(θ), P(r,θ) L 
> P (2,0) L L OP , OP 0 0 的曲边扇形面积值等于曲线 上 两点间弧长值的一半, 求曲线 
> 的方程. L P , P L 0
>
> 题源：26 版 1000 第十五章强化 49　|　题源类型：1000　|　页码：p.318　|　模块：5.4 5.4
