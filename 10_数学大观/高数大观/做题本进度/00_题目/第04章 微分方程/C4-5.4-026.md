...
> 1,y′(0) 设平面曲线 满足 0，且对曲线上任意点 0)，沿曲线从点 到点 y = y(x) y(0) 
> = = P(x,y)(x > (0,1) 的弧长等于该曲线在点 的切线斜率. P(x,y) P(x,y) 求
>  y(x)(x>0)； (1) 求 与 及坐标轴所围平面区域 的形心. (2) y(x) x=ln2 D
>
> 题源：26 版 1000 第十五章强化 48　|　题源类型：1000　|　页码：p.318　|　模块：5.4 5.4
