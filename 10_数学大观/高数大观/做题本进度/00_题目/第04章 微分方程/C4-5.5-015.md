...
> Z Z x x tf(t−x)dt，求 (3)(第十届北京市大学生数学竞赛题,1998 年) 设连续函数 满
> 足 f(t)dt+ f(x) x = 0 0 f(x)。 ·第 页，共 页· 309 402
>
> 题源：1998 第十届北京市大学生数学竞赛题（重点）　|　题源类型：真题　|　页码：p.320　|　模块：5.5 变限积分
