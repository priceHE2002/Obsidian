...
备注:
---
# 4.2-002 · 微分方程解的极限及渐近线

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 1 y′+ 1 设函数 是微分方程 满足 的解. y(x) y =2ex y =0 x2 2 求 的表达
> 式; (1) y =y(x) 求曲线 的斜渐近线. (2) y(x)
>
> 题源：26 版 1000 第十五章基础 6　|　题源类型：1000　|　页码：p.307　|　模块：4.2 微分方程解的极限及渐近线
