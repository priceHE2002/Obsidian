...
> =y(x)经过原点，且在原点处的切线与直线2x+y+6=0平行，而y(x)满足微分方程y′′−2y′+5y 
> 设曲线y 0，则此曲线的方程为（ ）. =exsin2x A. y =ex(cos2x−sin2x) C. 
> y
>
> 题源：26 版 1000 第十五章基础 14　|　题源类型：1000　|　页码：p.288　|　模块：2.2 二阶
