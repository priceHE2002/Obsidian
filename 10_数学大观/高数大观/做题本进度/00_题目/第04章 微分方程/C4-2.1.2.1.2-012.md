...
> 3 xf′(x)=f(x)+ ax2。曲线 设函数 在 上连续，在 内大于零，且满足微分方程 与 f(x) 
> [0,1] (0,1) y =f(x) 2 直线 x=1，y 围成区域 的面积为 2，则 =0 D f(x)
> = 3 3 (a−4)x+ (4−a)x+3ax2 (4−a)x+ (a−4)x+3ax2 ax2 ax2 
> A. B. C. D. 2 2 ▶2.1.2.1.3 三角 撇 y ·第 页，共 页· 272 402
>
> 题源：26 版 660 数一二三第 211 题　|　题源类型：660　|　页码：p.283　|　模块：2.1 一阶
