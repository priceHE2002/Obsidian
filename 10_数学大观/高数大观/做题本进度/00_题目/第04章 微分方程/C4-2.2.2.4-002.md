...
> d2y dy (−1,1) 二阶可导，满足方程：(1−x2) −x +a2y 设 在 =0，作变量替换 后，
> y 作 y =y(x) x=sint dx2 dx 为 的函数满足的方程是 t
>
> 题源：25 版 660 数一二三第 39 题　|　题源类型：660　|　页码：p.296　|　模块：2.2 二阶
