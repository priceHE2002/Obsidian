...
备注:
---
# 2.3-013 · 高阶常系数线性齐次微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> y′′′−(k+2)y′′+(2k+1)y′−ky ̸=1) 已知函数 为三次多项式，且 与 的特征方程同根
> ， f(x) f(x)=0 =0 (k f(x) 1 f(2)=− 且根的重数相同。若 =1，且 ，则 li
> m k = x−k 4 x→k
>
> 题源：900 第六章数二 B 类 14　|　题源类型：900　|　页码：p.300　|　模块：2.3 高阶常系数线性齐次微分方程
