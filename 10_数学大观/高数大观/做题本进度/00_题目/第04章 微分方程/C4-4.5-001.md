...
> √ xy′−6y =−6，且满足 设 满足微分方程 3)=10。 y =y(x)(x>0) y( （I）求 
> y(x)； （II）设 为曲线 上的一点，曲线 在点 的法线在 轴上的截距为 ，为使 最小， P y = y
> (x) y = y(x) P y I I P P 求 的坐标。 P 微分方程解的最值
>
> 题源：2021 数二　|　题源类型：真题　|　页码：p.309　|　模块：4.5 微分方程解的切法线
...
→ 所属模块：[[C4-4.5 微分方程解的切法线|4.5 微分方程解的切法线]]