...
备注:
---
# 4.8-003 · 微分方程解的定积分（应用）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 2xy′−4y =2lnx−1 设函数 是微分方程 满足条件 的解，求曲线 在 上的 y =y(x) y
> (1)= y =y(x) [1,e] 4 平均值。
>
> 题源：26 版 1000 第十五章基础 11　|　题源类型：1000　|　页码：p.310　|　模块：4.8 微分方程解的定积分（应用）
