...
> f′(x)−f(x)=2xex 若 的积分曲线没有极值点, 但有拐点, 则 f(x)=( ). ex(x+C
> ),1⩽C ex(x2+C),1⩽C A. <2 B. <2 ex(x2+C),0⩽C ex(x+C),0⩽
> C C. <1 D. <1
>
> 题源：26 版 1000 第十五章基础 1　|　题源类型：1000　|　页码：p.281　|　模块：2.1 一阶
