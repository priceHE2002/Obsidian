...
> 上有连续导数，f(0)=1，f′ 【16】设 在 (0)=1，且 f(x) [0,1] + ZZ ZZ ′′
>  f(x+y)+(x−y)3 f (x+y)dxdy = dxdy D D ={(x,y)|0⩽y ⩽t−x
> , 0⩽x⩽t} (0<t⩽1)，求 其中 f(x)。 D
>
> 题源：880 第六章综合解答 16　|　题源类型：880　|　页码：p.327　|　模块：5.8 二重积分
