...
备注:
---
# 4.2-007 · 微分方程解的极限及渐近线

> [!question] 题目（程序自动提取，公式可能有偏差）
> xy′−(2x2−1)y =x3(x⩾1)，y(1)=a。 【9】设 满足 y =y(x) （I）求 y(x
> )； y(x) （II）若 存在，求曲线 的斜渐近线方程。 lim y =y(x) x x→+∞
>
> 题源：880 第六章基础解答 9　|　题源类型：880　|　页码：p.308　|　模块：4.2 微分方程解的极限及渐近线
