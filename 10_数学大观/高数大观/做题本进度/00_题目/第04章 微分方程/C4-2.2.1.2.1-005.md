...
> y′′−4y′+8y y∗ =e2x(1+cos2x) 微分方程 的特解可设为 =（ ） Ae2x+e2x(
> Bcos2x+Csin2x) Axe2x+e2x(Bcos2x+Csin2x) A. B. Ae2x+xe2
> x(Bcos2x+Csin2x) Axe2x+xe2x(Bcos2x+Csin2x) C. D.
>
> 题源：2017 数二　|　题源类型：真题　|　页码：p.289　|　模块：2.2 二阶
