...
备注:
---
# 2.2-009 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ ={(x,y)||x|+|y|⩽3}，D sin(x−y)dxdy，则 【2】设 是 的第 象限部分，
> I D (k =1,2,3,4) D k = k k Dk （ ）。 I >0 B. >0 C. >0 D.
>  >0 A. I I I 1 2 3 4
>
> 题源：25 版 0.1w 强化 2　|　题源类型：150/0.1w　|　页码：p.407　|　模块：2.2 二重积分比大小以及定正负
