...
> ZZ ⩽x，则 :x2+y2 【5】设 )。 D f(x,y)dxdy =( D Z Z Z Z sinθ 
> π cosθ π f(rcosθ,rsinθ)rdr dθ f(rcosθ,rsinθ)rdr B. dθ 
> A. Z0 Z0 Z0 Z0 π π cosθ sinθ 2 2 C. dθ f(rcosθ,rsinθ)r
> dr dθ f(rcosθ,rsinθ)rdr D. −π −π 0 0 2 2 二重积分比大小以及定正负
>
> 题源：880 基础选择 5　|　题源类型：880　|　页码：p.405　|　模块：2.1 交换积分次序
