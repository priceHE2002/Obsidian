...
备注:
---
# 2.2-003 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ ⩽1 (y− x2+y2 位于第k 象限的部分，记I 【例6.16】(2013，数二、三)设D 为圆域
> D = = (x,y) k k Dk =1,2,3,4)，则【 】 x)dxdy (k A. I >0 B.
>  I >0 C. I >0 D. I >0 1 2 3 4
>
> 题源：2013 数二三　|　题源类型：真题　|　页码：p.406　|　模块：2.2 二重积分比大小以及定正负
