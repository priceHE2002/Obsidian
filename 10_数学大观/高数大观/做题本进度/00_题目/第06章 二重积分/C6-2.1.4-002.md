...
> √ （4）设 是第一ZZ象限中的曲线 =1，4xy 与直线 =x，y 围成的平面区域，函数 在 D 2xy 
> =1 y = 3x f(x,y) 上连续，则 =（ ） D f(x,y)dxdy D Z Z Z Z π 1
>  π 1 √ 3 sin2θ 3 sin2θ f(rcosθ,rsinθ)rdr A. dθ f(rcosθ
> ,rsinθ)rdr B. dθ π 1 π 1 √ Z4 Z2sin2θ Z4 2sin2θ Z π 1 
> π 1 √ 3 sin2θ 3 sin2θ C. dθ f(rcosθ,rsinθ)dr D. dθ f(r
> cosθ,rsinθ)dr π 1 π 1 √ 4 2sin2θ 4 2sin2θ
>
> 题源：2015 数一二　|　题源类型：真题　|　页码：p.405　|　模块：2.1 交换积分次序
