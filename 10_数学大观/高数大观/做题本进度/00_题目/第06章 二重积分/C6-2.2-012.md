...
备注:
---
# 2.2-012 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ ZZ n o √ ex2+y2 (x,y)(cid:12)x2 2 3x−ydxdy，I −1 ⩽1,
> x⩾0,y ⩾0 设平面区域D dxdy， 。记I = = +y3 = 3 2 1 ZZ D D (x2+y
> 2)ex2+y2 dxdy，则（ ） I = 3 D A. I <I <I B. I <I <I C. I 
> <I <I D. I <I <I 2 1 3 1 3 2 1 2 3 3 2 1 以二重积分形式给出的函数
>
> 题源：900 第五章数二 A 类 4　|　题源类型：900　|　页码：p.407　|　模块：2.2 二重积分比大小以及定正负
