...
> ZZ ≤2y x2+y2 【例 6.7】(2004，数二) 设 连续，区域 ，则 =【 】 f(u) D =
>  (x,y) f(xy)dxdy √ D √ Z Z Z Z 2y−y2 1+x2 1 2 A. dx f(
> xy)dy B. 2 dy f(xy)dx √ Z−1 Z− 1−x2 0 0 Z Z π 2sinθ π 
> 2sinθ f(r2sinθcosθ)dr f(r2sinθcosθ)rdr C. dθ D. dθ 0 0
>  0 0
>
> 题源：2004 数二　|　题源类型：真题　|　页码：p.405　|　模块：2.1 交换积分次序
