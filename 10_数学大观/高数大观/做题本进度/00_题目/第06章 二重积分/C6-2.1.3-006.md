...
> Z Z 1−y 1 设 是连续函数，则 f(x,y)dx=（ ） dy (3) f(x,y) √ − 1−y
> 2 0 √ Z Z Z Z x−1 1−x2 0 1 dx f(x,y)dy+ dx A. f(x,y)dy
>  Z−1 Z0 Z0 Z0 1−x 1 0 0 f(x,y)dy B. dx f(x,y)dy+ dx √ 
> 1−x2 −1 − 0 0 ·第 页，共 页· 393 402
>
> 题源：2014 数一　|　题源类型：真题　|　页码：p.404　|　模块：2.1 交换积分次序
