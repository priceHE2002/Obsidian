...
> Z Z π 1 2 设 是连续函数，则 )。 f(x,y) dx f(x,y)dy =( π sinx Z 
> Z Z Z 6 π 1 arcsiny 1 2 A. dy f(x,y)dx B. dy f(x,y)dx 
> 1 π 1 arcsiny Z2 Z6 Z Z2 1 π 1 arcsiny 2 2 2 C. dy dy 
> f(x,y)dx f(x,y)dx D. π 0 0 arcsiny 6
>
> 题源：2024 数二三　|　题源类型：真题　|　页码：p.402　|　模块：2.1 交换积分次序
