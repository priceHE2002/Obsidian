...
备注:
---
# 2.4-006 · 利用含二重积分等式求函数表达式

> [!question] 题目（程序自动提取，公式可能有偏差）
> (−∞,+∞) 【7】设 在 内有连续导数，且 f(t) ZZ (cid:16)p ⩽t2, x2+y2 d
> xdy+t4, :x2+y2 x2+y2 f(t)=2 f D D 求 f(t)。
>
> 题源：880 综合解答 7　|　题源类型：880　|　页码：p.409　|　模块：2.4 利用含二重积分等式求函数表达式
