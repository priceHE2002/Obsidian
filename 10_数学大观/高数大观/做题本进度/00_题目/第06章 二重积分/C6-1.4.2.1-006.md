...
源题号: "1.4.2.1-006"
序: 3236
题源: "北京竞赛题; 姜晓千强化例题; 25 版 660 数一二三第 116"
题源大类: "660"
重点: false
页码: 400
状态: "未开始"
...
备注:
---
# 1.4.2.1-006 · 被积函数为分段函数

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ p |y−x2|dxdy，其中 ={(x,y)|−1⩽x⩽1,0⩽y ⩽2}。 计算 D D
>
> 题源：北京竞赛题; 姜晓千强化例题; 25 版 660 数一二三第 116　|　题源类型：660　|　页码：p.400　|　模块：1.4 被积函数为分段函数
