...
备注:
---
# 2.4-008 · 利用含二重积分等式求函数表达式

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z x 1 f¯= f(y)f(y−x)dy 【4】设 是 上的连续函数且其在 上的平均值 ，满足 1， f
> (x) [0,1] [0,1] f(x)+a = 2 1 求常数 的值。 a ·第 页，共 页· 398 4
> 02
>
> 题源：25 版 0.1w 强化 4　|　题源类型：150/0.1w　|　页码：p.409　|　模块：2.4 利用含二重积分等式求函数表达式
