...
备注:
---
# 2.2-004 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ √ 3x−ydxdy {(x,y) | ≤ ≤ ≤ ≤ 1}， 【例 6.7】(2016，数三) 设 
> 1,2,3)，其中 J = (i = D = 0 x 1,0 y i 1 √Di ={(x,y)|0≤x≤1
> ,0≤y ≤ x}，D ={(x,y)|0≤x≤1,x2 ≤y ≤1}，则 D 2 3 A. J <J <J
>  B. J <J <J C. J <J <J D. J <J <J 1 2 3 3 1 2 2 3 1 2 
> 1 3
>
> 题源：2016 数三; 25 版 0.1w 强化 5　|　题源类型：真题　|　页码：p.406　|　模块：2.2 二重积分比大小以及定正负
