...
源题号: "1.3.6-008"
序: 3194
题源: "25 版 0.1w 基础 15; 24 版 8 套数二第六套"
题源大类: "150/0.1w"
重点: false
页码: 396
状态: "未开始"
...
> ZZ p f(x,y) √ ={(x,y)|2x2+y2 ⩽2 ⩾x⩾0}，若 设平面区域 =a>0，f(x
> ,y) 是 上 x2+y2,y D dσ D 1−x2 D 的连续函Z数Z. 1 √ 计算 dσ； (1) 
> 1−x2 √ D 2 (ξ,η)∈D，使得 |f(ξ,η)|⩾ 证明：存在 (2) a. π
>
> 题源：25 版 0.1w 基础 15; 24 版 8 套数二第六套　|　题源类型：150/0.1w　|　页码：p.396　|　模块：1.3 极坐标
