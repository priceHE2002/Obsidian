...
备注:
---
# 2.2-001 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ ZZ ZZ p ={(x,y)| cos(x2+y2)dσ，I cos(x2+y2)2dσ，其中 设 
> x2+y2dσ，I (8) I = cos = = D 1 2 3 D D D ·第 页，共 页· 394 
> 402
>
> 题源：2005 数三; 880 综合选择 1　|　题源类型：真题　|　页码：p.405　|　模块：2.2 二重积分比大小以及定正负
