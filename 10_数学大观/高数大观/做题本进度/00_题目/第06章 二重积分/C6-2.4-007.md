...
备注:
---
# 2.4-007 · 利用含二重积分等式求函数表达式

> [!question] 题目（程序自动提取，公式可能有偏差）
> ⩽4,x⩾0,y ⩾0，f(x,y) :x2+y2 【9】设 在 上连续，且 D D ZZ x2+y2−x+
> y−1 f(x,y)= + f(u,v)dudv, D 求 f(x,y)。
>
> 题源：880 综合解答 9　|　题源类型：880　|　页码：p.409　|　模块：2.4 利用含二重积分等式求函数表达式
