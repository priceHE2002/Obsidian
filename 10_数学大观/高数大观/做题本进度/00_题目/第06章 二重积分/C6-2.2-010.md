...
备注:
---
# 2.2-010 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ ZZ ZZ 2 − ln(x2 y2)dxdy，N ln(x2+y2) (x2 y2 【3】设 dxd
> y，P 1)dxdy，其中 M = + = = + D D D ={(x,y)|1⩽x2+y2 ⩽2}，则必
> 有（）. D A. M <N <P B. N <M <P C. M <P <N D. N <P <M
>
> 题源：25 版 0.1w 强化 3　|　题源类型：150/0.1w　|　页码：p.407　|　模块：2.2 二重积分比大小以及定正负
