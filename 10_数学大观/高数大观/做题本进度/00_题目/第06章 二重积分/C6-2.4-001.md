...
备注:
---
# 2.4-001 · 利用含二重积分等式求函数表达式

> [!question] 题目（程序自动提取，公式可能有偏差）
> ZZ =x2，x=1 设 连续，且 f(u,v)dudv，其中 是由 =0，y 所围区域，则 (2) f(x
> ,y) f(x,y)=xy+ D y D 等于（ ） f(x,y) ·第 页，共 页· 397 402
>
> 题源：1999 数三　|　题源类型：真题　|　页码：p.408　|　模块：2.4 利用含二重积分等式求函数表达式
