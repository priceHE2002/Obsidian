...
备注:
---
# 2.2-008 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> A(1,1)，B(−1,1)，C(−1,−1) 【3】设 是ZZxOy 平面上以 为顶点的三角形区域，D 是
>  在第一象限的部 D D 1 分，则 )。 I = (xy+cosxsiny)dxdy =( ZZ D A.
>  0 B. 2 xydxdy ZZ ZZD1 C. 2 cosxsinydxdy D. 4 (xy+cosx
> siny)dxdy D1 D1
>
> 题源：880 基础选择 3　|　题源类型：880　|　页码：p.407　|　模块：2.2 二重积分比大小以及定正负
