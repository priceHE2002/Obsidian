...
备注:
---
# 2.4-005 · 利用含二重积分等式求函数表达式

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 (cid:16)p (cid:17)3 2 ZZ >>>< x2+y2 F 4 5 1− t̸=0, x
>  dxdy, x2+y2 求函数 的表达式。 设 F(t) F(t)= x2+y2≤t2,x≥0,y≥0 >
> >>: 0, t=0,
>
> 题源：880 综合解答 6　|　题源类型：880　|　页码：p.409　|　模块：2.4 利用含二重积分等式求函数表达式
