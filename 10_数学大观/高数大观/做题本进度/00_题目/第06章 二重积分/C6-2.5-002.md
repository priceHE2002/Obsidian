...
> ≤4,x≥0,y ≥0 x2+y2 【例 6.15】(2005，数二) 设区域 ，f(x) 为正值连续函数，
> a,b 为常数， D = (x,y) p p ZZ a f(x)+b f(y) p p 则 =【 】 dxd
> y f(x)+ f(y) D ab a+b A. abπ B. π C. (a+b)π D. π 2 2
>
> 题源：2005 数二; 880 基础填空 4　|　题源类型：真题　|　页码：p.410　|　模块：2.5 抽象函数二重积分
