...
> Z Z 1−y 0 交换积分次序 dy f(x,y)dx= . . −1 2 Z Z Z √ 2a−y ay
>  2a f(x,y)dx+ dy f(x,y)dx= 0 a 0 Z Z Z Z 4−y 2 2 2 连续，
> 则 f(x,y)dx=【 】 dx f(x,y)dy+ dy 1 x 1 y Z Z 4−x 2 B. dx
>  f(x,y)dy Z1 Zx 2 2 D. dy f(x,y)dx 1 y . = 的积分次序 . sin
> 2θ 为 f(rcosθ,rsinθ)rdr(a>0) 3 可以写成（ ） √ Z Z 1−y2 1 B. 
> dy f(x,y)dx 0 0 ·第 页，共 页· 392 402
>
> 题源：2001 数一　|　题源类型：真题　|　页码：p.403　|　模块：2.1 交换积分次序
