...
> 【Z例Z 6.2】(2011，数一、数二) 已知函数 具有二阶连续偏导数，且 0，f(x,1) 0， f(x
> ,y) f(1,yZ)Z= = ′′ ={(x,y)|0≤x≤1,0≤y ≤1}，计算二重积分 =a，其中 
> (x,y)dxdy。 f(x,y)dxdy D I = xyf xy D D 积分区域 由参数方程给出（摆线
> ）
>
> 题源：2011 数一二　|　题源类型：真题　|　页码：p.389　|　模块：1.2 直角坐标
