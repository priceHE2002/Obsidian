...
备注:
---
# 2.2-002 · 二重积分比大小以及定正负

> [!question] 题目（程序自动提取，公式可能有偏差）
> {(x,y) | |x| ⩽ 1,|y| ⩽ 1} （Z2Z）如图，正方形 被其对角线划分为四个区域 1,2
> ,3,4)，I D (k = = k k {I }=（ ycosxdxdy，则 ） max k 1⩽k⩽4 
> Dk A. I B. I C. I D. I 1 2 3 4
>
> 题源：2009 数一　|　题源类型：真题　|　页码：p.406　|　模块：2.2 二重积分比大小以及定正负
