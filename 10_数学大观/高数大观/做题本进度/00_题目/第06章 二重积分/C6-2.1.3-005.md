...
> Z Z π 2sinθ 2 【6】将二重积分 化为直角坐标系下的二次积分，则 )。 I = dθ f(rco
> sθ,rsinθ)rdr I =( π 0 Z Z 4 1 x A. dx f(x,y)dy √ − 1−x
> 2 Z0 Z1√ 1−x2 1 B. dx f(x,y)dy √ x 0 Z Z Z Z 2y−y2 1 y
>  2 C. dy f(x,y)dx+ dy f(x,y)dx 0√ 0 1 0 Z Z 2y−y2 1 D.
>  dy f(x,y)dx 0 y
>
> 题源：880 基础选择 6　|　题源类型：880　|　页码：p.404　|　模块：2.1 交换积分次序
