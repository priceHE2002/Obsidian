...
备注:
---
# 1.4.2.3-003 · 被积函数为分段函数

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ hp i √ 3 x2 +y2 1，x2 +y2 设区域 由圆 以及直线 x，y 围成， 表示不超过 x
> 2+y2 D = = 9 y = = 3x ZZ 3 hp i p y 的最大整数，计算二重积分 dxdy。
>  x2+y2 x2+y2 x D 其他 2 交换积分次序
>
> 题源：900 第五章数二 A 类 32　|　题源类型：900　|　页码：p.402　|　模块：1.4 被积函数为分段函数
