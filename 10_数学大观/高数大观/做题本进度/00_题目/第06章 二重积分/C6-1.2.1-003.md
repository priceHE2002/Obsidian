...
> (1,1)，(−1,1) (−1,−1) （4）Z设Z 是 平面上以 和 为顶点的三角形区域，D 是 在第一
> 象限的部分， D xOy D 1 则 等于 (xy+cosxsiny)dxdy ZZ ZZ D 2 A. c
> osxsinydxdy B. 2 xydxdy ZZD1 D1 C. 4 (xy+cosxsiny)dxdy
>  D. 0 D1
>
> 题源：1991 数一　|　题源类型：真题　|　页码：p.386　|　模块：1.2 直角坐标
