...
备注:
---
# 2.4-003 · 利用含二重积分等式求函数表达式

> [!question] 题目（程序自动提取，公式可能有偏差）
> (x,y)|x2+y2 ≤y,x≥0 设 在区域 上连续，满足 f(x,y) D = ZZ p 8 1−x2
> −y2− f(x,y)= f(u,v)dudv, π D 求 f(x,y)。
>
> 题源：复习全书（红）　|　题源类型：其他　|　页码：p.409　|　模块：2.4 利用含二重积分等式求函数表达式
