...
备注:
---
# 2.1.3.1.1.5-008 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ √ 在曲线 上的横坐标为 处作曲线的切线，将切线与 轴、y 轴所围成的图形绕 x+ y = 1 a(0 
> < a < 1) x y 轴旋转一周，使得旋转体的体积最大，求 的值。 a
>
> 题源：1000 第十章强化 20　|　题源类型：1000　|　页码：p.252　|　模块：2.1 几何应用
