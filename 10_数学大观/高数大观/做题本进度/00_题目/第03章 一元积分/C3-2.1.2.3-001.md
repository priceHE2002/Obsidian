...
> ( x=f(t), π π f(0)=0，f′(t)>0 0⩽t< 已知曲线 ，其中函数 具有连续导数，且 
> L: f(t) 0<t< 2 2 y =cost 若曲线 的切线与 轴的交点到切点的距离恒为 1，求函数 的
> 表达式，并求以曲线 及 轴和 轴为 L x f(t) L x y 边界的区域的面积。
>
> 题源：2012 数一　|　题源类型：真题　|　页码：p.245　|　模块：2.1 几何应用
