...
> [!note]- 题干预览（自动提取，仅供参考）
> 为清除井底的污泥，用缆绳将抓斗放入井底，抓起污泥后提出井口（如图）。已知井深 缆绳每米重 50N，抓斗抓起的污泥重 斗缝隙中漏掉。现将抓起污泥的抓斗提升至井口，问克服重力需作多少焦耳的功？（说明：⃝ 分别表示米，牛顿，秒，焦耳；⃝ m,N,s,J
>
> 题源：1999 数一二　|　页码：p.268　|　模块：2.2 物理应用（数一二）
