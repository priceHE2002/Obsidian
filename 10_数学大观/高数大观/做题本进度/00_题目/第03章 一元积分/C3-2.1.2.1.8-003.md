...
> ⩽ ⩽ ⩽ ⩽ x2(0 (t,t2), x2(0 t2 在曲线 上取一点 设 是曲线 直线 135 y =
>  x 1) (0 < t < 1), A y = x 1), y = 1 ⩽ ⩽ x2(0 t2 时 和 围
> 成的面积; 是由曲线 直线 和 围成的面积, 则 取 x = 0 A y = x 1) y = x = 1 
> t 2 取最小值. A=A +A 1 2
>
> 题源：660 数二 135　|　题源类型：660　|　页码：p.241　|　模块：2.1 几何应用
