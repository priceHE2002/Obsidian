...
备注:
---
# 2.1.3.1.1.4-001 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =x1 设 是由曲线 ，直线 及 轴围成的平面图形，V 、V 分别是 绕 轴、y 轴旋转一 D y x=a(
> a>0) x D x 3 x y 周所得旋转体的体积．若 ，求 的值． V =10V a y x
>
> 题源：2013 数二三　|　题源类型：真题　|　页码：p.250　|　模块：2.1 几何应用
