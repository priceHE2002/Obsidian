...
备注:
---
# 2.1.3.1.1.4-003 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> π arcsinx2(x 记曲线 与直线 以及 轴所围区域为 ，与直线 以及 轴所围区域为 y = > 0)
>  x = 1 x D y = y 1 2 。若 绕 轴旋转一周所得旋转体与 绕 轴旋转一周所得旋转体的体积之
> 和为 a，则 绕 轴旋 D D x D y D x 2 1 2 2 转一周所得旋转体的体积为
>
> 题源：900 第三章数二 B 类 37　|　题源类型：900　|　页码：p.251　|　模块：2.1 几何应用
