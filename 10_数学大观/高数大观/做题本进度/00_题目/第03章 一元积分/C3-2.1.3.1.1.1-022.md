...
备注:
---
# 2.1.3.1.1.1-022 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> ex+e−x x=−1，x=1，y 由曲线 及三条直线 围成的曲边梯形绕 轴旋转一周而成的旋转 y =chx
> = =0 y 2 体的体积等于 1 1 1 1 1− 1− A. 4π B. 2π C. 4π 1+ D. 
> 2π 1+ e e e e ·第 页，共 页· 236 402
>
> 题源：660 数二 374　|　题源类型：660　|　页码：p.247　|　模块：2.1 几何应用
