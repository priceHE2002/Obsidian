...
> Z x3t x xt+1 [例 设 ，f(x)= g(t)dt。 3.32] g(x)= lim xt+2 
> t→+∞ 0 求曲线 的渐近线； (I) y =f(x) 求曲线 与其渐近线及 轴所围区域的面积 A。 (I
> I) y =f(x) y ▶2.1.2.1.7 面积关系
>
> 题源：真题同源 150　|　题源类型：真题同源　|　页码：p.240　|　模块：2.1 几何应用
