...
备注:
---
# 2.2.3.1-003 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 1 设一单位质量细杆的长为1，G 为引力常数. 当质量为a 的质点在细杆延长线上距杆右端点的 处移至 处
>  2 3 时，引力做功大小为（）. 4 5 A. Galn B. Galn C. Galn2 D. Galn
> 3 3 3
>
> 题源：1000 第十二章基础 6　|　题源类型：1000　|　页码：p.262　|　模块：2.2 物理应用（数一二）
