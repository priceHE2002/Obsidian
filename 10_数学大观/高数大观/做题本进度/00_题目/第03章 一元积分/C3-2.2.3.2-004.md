...
备注:
---
# 2.2.3.2-004 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设如图 所示为同一等腰三角形薄板，已知其底为 2b、高为 h，将其垂直放入静水中，图 (37) 3-2 (a
> ), 3-2 (b) 是其底与水面相齐，图 是其顶点与水面相齐，设图 与图 薄板一侧所受压力分别为 和 ， 
> (a) (b) (a) (b) P P 1 2 P 2。 求 P 1
>
> 题源：880 综合解答 37　|　题源类型：880　|　页码：p.264　|　模块：2.2 物理应用（数一二）
