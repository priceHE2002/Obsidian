...
> [!note]- 题干预览（自动提取，仅供参考）
> 一三角形平面薄板铅直地浸没于水中，设当该薄板的一条边与水面相平齐时薄板一侧所受的水压力的大小为 ，当倒转薄板使原来与水面相平齐的那条边与水面平行而该边相对的顶点与水面相齐时薄板一侧所受的水 F 1 压力的大小为 3 A. F = F 2 1 2
>
> 题源：1000 第十二章强化 1　|　页码：p.264　|　模块：2.2 物理应用（数一二）
