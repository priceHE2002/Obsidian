...
备注:
---
# 2.1.3.1.1.3-002 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ x−2 过点 作抛物线 的切线，该切线与上述抛物线及 轴围成一平面图形，求此图形绕 轴 P(1,0) y
>  = x x 旋转一周所成旋转体的体积。 ·第 页，共 页· 237 402
>
> 题源：1990 数二　|　题源类型：真题　|　页码：p.248　|　模块：2.1 几何应用
