...
> Z +∞ x2+bx+1 −1 设 为常数，积分 收敛，则 及该积分的值分别为 b dx b x(x+2) 
> 1 1 1 A. 2,ln3 B. 2, ln3 C. 1, ln2 D. 1,ln2 2 2 ·第 页，共
>  页· 264 402
>
> 题源：26 版 660 数一二三第 207 题　|　题源类型：660　|　页码：p.275　|　模块：3.2 敛散性和参数的关系
