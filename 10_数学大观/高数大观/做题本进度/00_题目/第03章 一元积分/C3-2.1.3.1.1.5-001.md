...
备注:
---
# 2.1.3.1.1.5-001 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> xdy+(x−2y)dx=0 求微分方程 的一个解 =y(x)，使得由曲线 与直线 x=1，x=2 以及 轴
>  y y =y(x) x 所围成的平面图形绕 轴旋转一周的旋转体体积最小。 x
>
> 题源：2002 数二　|　题源类型：真题　|　页码：p.251　|　模块：2.1 几何应用
