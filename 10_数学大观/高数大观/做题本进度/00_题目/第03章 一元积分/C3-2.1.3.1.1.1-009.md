...
备注:
---
# 2.1.3.1.1.1-009 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 √ (cid:12)0≤y ≤ ,x≥1 【例 3.47】(2023，数二、三) 设区域 . D = (
> x,y) 1+x2 x 求 的面积； (I) D 求 绕 轴旋转所围旋转体的体积 (II) D x V . 
> x
>
> 题源：2023 数二三　|　题源类型：真题　|　页码：p.246　|　模块：2.1 几何应用
