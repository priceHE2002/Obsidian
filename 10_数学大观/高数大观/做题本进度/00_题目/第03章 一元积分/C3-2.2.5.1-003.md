...
备注:
---
# 2.2.5.1-003 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> x2 y2 椭圆 所围位于第一象限部分的平面图形的形心是 + =1 a2 b2 4b 4a 4b 4a 3b
>  3a 3b 3a , B. , C. , D. , A. 2π 3π 3π 3π 3π 2π 2π 2π
>
> 题源：660 数二 375　|　题源类型：660　|　页码：p.270　|　模块：2.2 物理应用（数一二）
