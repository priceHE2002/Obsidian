...
备注:
---
# 2.2.4.1.1.2-010 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ π 0⩽x⩽ =tanx2 【59】设曲线 L:y . 2 求由 与曲线 以及 轴围成的图形 绕 轴旋转
> 一周所得旋转体的体积 (I) y =1 L y D y V; 设 中旋转体内盛满水，问将水抽完至少需要做多少
> 功？用 表示所做的功，用 表示水的密度，用 (II) (I) W ρ 表示重力加速度. g ▶2.2.4.1
> .2 提拉物体 ▶2.2.4.1.2.1 平地干拉
>
> 题源：880 第三章综合解答 59　|　题源类型：880　|　页码：p.268　|　模块：2.2 物理应用（数一二）
