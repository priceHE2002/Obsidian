...
> Z p 2 12−x2u2du (x⩾0) 求曲线 的全长。 4y = x 0 √ y 9−t2，其中 0⩽
> t⩽3，x>0。 x3 ，y(1)= = x 的表达式； 的全长。 y =f(x) 1 0⩽x⩽ 的一段弧的
> 长度。 2 54 1 1 − ⩽x⩽ 的一段弧的长度 s= 2 2
>
> 题源：880 第三章综合解答 38　|　题源类型：880　|　页码：p.256　|　模块：2.1 几何应用
