...
备注:
---
# 2.1.3.1.1.5-007 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =x2 设直线 1)，x=1 与曲线 所围成的平面图形记为 ，直线 与曲 y =ax(0<a< y D y 
> =ax(0<a< 1) 1 ∪D =x2 线 所围成的平面图形记为 ，记 ，则当平面图形 绕 轴旋转所得旋转
> 体体积最小 y D D =D D x 2 1 2 时，a=
>
> 题源：900 第三章数二 A 类 70　|　题源类型：900　|　页码：p.252　|　模块：2.1 几何应用
