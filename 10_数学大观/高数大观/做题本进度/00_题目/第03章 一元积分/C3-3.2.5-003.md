...
> Z h i n√ m dx（[·] 设常数 m>0,n>0，则 是取整符号）的敛散性（ ）。 x x 0 仅
> 与 有关 仅与 有关 A. m B. n 与 均有关 与 均无关 C. m,n D. m,n
>
> 题源：26 张老师 1000 第 8 章强化 9　|　题源类型：1000　|　页码：p.276　|　模块：3.2 敛散性和参数的关系
