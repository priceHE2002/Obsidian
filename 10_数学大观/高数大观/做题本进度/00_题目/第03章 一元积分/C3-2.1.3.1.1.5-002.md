...
备注:
---
# 2.1.3.1.1.5-002 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ xa− x a(a>1,0⩽x<+∞) 设 是位于曲线 下方、x 轴上方的无界区域. D y = 2 求
> 区域 绕 轴旋转一周所成旋转体的体积 V(a)； (1) D x 当 为何值时，V(a) 最小？并求此最小值
> . (2) a
>
> 题源：2007 数二　|　题源类型：真题　|　页码：p.251　|　模块：2.1 几何应用
