...
备注:
---
# 2.1.3.1.2.4-002 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂f f(y,y)=(y+1)2−(2−y)lny，求曲线 已知函数 满足 =2(y+1)，且 所围图形绕直
>  f(x,y) f(x,y)=0 ∂y =−1 线 旋转所成旋转体的体积。 y
>
> 题源：2014 数二　|　题源类型：真题　|　页码：p.254　|　模块：2.1 几何应用
