...
备注:
---
# 2.1.3.1.1.3-013 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =1−(x−1)2 由曲线 及直线 围成图形绕 轴旋转一周而成立体的体积 是 372 y y =0 y V 
> Z Z p p 1 1 π(1− 1−y)2dy 1+y)2dy A. π(1+ B. Z0 Z0 p p 
> p p 1 1 2 1−y)−(1− 1−y) 1−y)2−(1− 1−y)2 C. π (1+ dy D.
>  π (1+ dy 0 0
>
> 题源：660 数二 372　|　题源类型：660　|　页码：p.250　|　模块：2.1 几何应用
