...
备注:
---
# 2.1.3.1.2.1-002 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> [0,+∞) D(t)={(x,y)|0⩽x⩽t,0⩽y ⩽f(x)}，D(t) 【1】设 在 上非负连续，
> 曲边梯形 所围图 y =f(x) S(t)=tet，D(t) 形的面积 绕直线 旋转一周所得旋转体的体积为 
> V(t)，求 的表达式。 x=t V(t)
>
> 题源：880 第三章拓展 1　|　题源类型：880　|　页码：p.253　|　模块：2.1 几何应用
