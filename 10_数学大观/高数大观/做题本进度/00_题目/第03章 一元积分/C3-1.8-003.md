...
> Z lnx p 求不定积分 dx. 1+x2(lnx−1)2 √ √ Z x−1) 1+ln( x+1+ √
>  √ √ dx. x2−1( x+1− x−1) Z x+1 dx. x(1+xex)
>
> 题源：2009 浙江竞赛　|　题源类型：真题　|　页码：p.234　|　模块：1.8 复杂函数凑微分训练专项
...
→ 所属模块：[[C3-1.8 复杂函数凑微分训练专项|1.8 复杂函数凑微分训练专项]]