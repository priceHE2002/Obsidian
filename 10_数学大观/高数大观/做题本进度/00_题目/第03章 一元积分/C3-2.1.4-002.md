...
> =x2−1 如图所示，设立体的底是 平面上介于 和 之间的平面区域，该立体垂直于 轴的任一 xOy y y 
> =0 x 截面是一个等边三角形，则此立体的体积为（ ）. √ √ √ 3 2 3 4 3 A. B. C. 
> D. 15 15 15 ·第 页，共 页· 244 402
>
> 题源：早年 1000; 880 第三章基础解答 22　|　题源类型：1000　|　页码：p.255　|　模块：2.1 几何应用
