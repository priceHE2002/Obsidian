...
备注:
---
# 2.2.3.2-001 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 某闸门的形状与大小如图所示，其中直线 为对称轴，闸门的上部为矩形 ABCD，下部由二次抛物线与线段 l 所围
> 成。当水面与闸门的上端相平时，欲使闸门矩形部分承受的水压力与闸门下部承受的水压力之比为 AB 5:4，闸门矩
> 形部分的高 应为多少米？（单位：m） h ·第 页，共 页· 252 402
>
> 题源：2002 数二　|　题源类型：真题　|　页码：p.263　|　模块：2.2 物理应用（数一二）
