...
模块: "2.1"
模块名: "几何应用"
题号: "C3-2.1.3.1.1.5-009"
源题号: "2.1.3.1.1.5-009"
序: 2102
题源: "2002 数三; 30 习题 10.7"
题源大类: "真题"
重点: false
页码: 252
状态: "未开始"
...
备注:
---
# 2.1.3.1.1.5-009 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 2x2 2x2 设 是由抛物线 和直线 及 所围成的平面区域；D 是由抛物线 和直 D y = x = a,
> x = 2 y = 0 y = 1 2 线 所围成的平面区域，其中 0<a<2。 y =0,x=a （1）试
> 求 绕 轴旋转而成的旋转体体积 ；D 绕 轴旋转而成的旋转体体积 ； D x V y V 1 1 2 2 （
> 2）问当 为何值时，V 取得最大值？试求此最大值。 a +V 1 2 ▶2.1.3.1.1.6 与极限结合
>
> 题源：2002 数三; 30 习题 10.7　|　题源类型：真题　|　页码：p.252　|　模块：2.1 几何应用
