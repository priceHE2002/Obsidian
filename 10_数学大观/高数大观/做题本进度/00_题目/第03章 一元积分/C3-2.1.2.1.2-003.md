...
> [!note]- 题干预览（自动提取，仅供参考）
> 例 P210 8.5 Z +∞ −x|sinx|dx； ⃝ e 1 (cid:12)Z0 (cid:12) +∞ (cid:12) −xsinxdx ⃝ e (cid:12) 2 (cid:12) 0 Z (cid:12) Xn (cid:12) ⃝ (cid:12) l im 3 (cid:12) → ∞ n k=0 其中正确表达式的个数是（ A. 0
>
> 题源：30 例 8.5　|　页码：p.238　|　模块：2.1 几何应用
