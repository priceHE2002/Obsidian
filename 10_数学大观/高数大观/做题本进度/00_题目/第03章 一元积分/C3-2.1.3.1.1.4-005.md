...
备注:
---
# 2.1.3.1.1.4-005 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> π π ⩽x⩽ − 与 轴所围成的平面图形绕 轴旋转一周所成旋转体的体积与绕 轴旋转 由曲线 x x y y
>  =cosx 2 2 一周所成旋转体的体积之差为 . ▶2.1.3.1.1.5 旋转体最值
>
> 题源：900 第三章数二 A 类 64　|　题源类型：900　|　页码：p.251　|　模块：2.1 几何应用
