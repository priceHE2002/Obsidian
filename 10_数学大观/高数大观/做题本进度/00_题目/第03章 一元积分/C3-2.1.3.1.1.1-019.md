...
备注:
---
# 2.1.3.1.1.1-019 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> y(x) y′′+3y′+2y =e−x，且 设函数 满足方程 =1，求曲线 与 轴正半轴之间的平 y =y
> (x) lim y =y(x) x x x→0 面图形的面积及该平面图形绕 轴旋转一周所形成的旋转体体积。 
> y
>
> 题源：1000 第十章强化 4　|　题源类型：1000　|　页码：p.247　|　模块：2.1 几何应用
