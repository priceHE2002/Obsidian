...
备注:
---
# 2.1.3.1.2.3-004 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> ex ex 过坐标原点作曲线 的切线，该切线与曲线 以及 轴围成的向 轴负向无限伸展的图形记为 y = y 
> = x x D. 求 的面积； (1) D 求 绕直线 旋转一周所成的旋转体体积. (2) D x=1 ▶2
> .1.3.1.2.4 复杂区域
>
> 题源：1000 第十章强化 6　|　题源类型：1000　|　页码：p.254　|　模块：2.1 几何应用
