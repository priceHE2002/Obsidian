...
> Z x π π tcostdt，x∈ − 设函数 ，则曲线 与 轴所围图形的面积为（） f(x)= , y 
> =f(x) x 2 2 −1 Z Z 1 1 x2sinxdx A. 2 xsinxdx B. 2 Z0 Z
> 0 1 1 x2cosxdx C. 2 xcosxdx D. 2 0 0
>
> 题源：900 第三章数二 B 类 1　|　题源类型：900　|　页码：p.239　|　模块：2.1 几何应用
