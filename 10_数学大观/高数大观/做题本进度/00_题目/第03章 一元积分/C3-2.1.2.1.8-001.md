...
> π =sinx,0⩽x⩽ 考虑函数 。问： y 2 取何值时，右图中阴影部分的面积 与 之和 最小？ (1)
>  t S S S =S +S 1 2 1 2 取何值时，面积 最大？ (2) t S =S +S 1 2
>
> 题源：1987 数三; 880 第三章基础解答 19　|　题源类型：真题　|　页码：p.241　|　模块：2.1 几何应用
