...
备注:
---
# 2.1.3.1.1.1-004 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> π π − ⩽x⩽ 曲线 与 轴所围成的图形，绕 轴旋转一周所成旋转体的体积为（） y =cosx x x 
> 2 2 π2 π π2 A. B. π C. D. 2 2 ·第 页，共 页· 234 402
>
> 题源：1989 数二　|　题源类型：真题　|　页码：p.245　|　模块：2.1 几何应用
