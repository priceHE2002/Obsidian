...
> 用铁锤将一铁钉打击入木板，设木板对铁钉的阻力与铁钉击入木板的深度成正比．在铁锤击第一次时能把铁 钉击入 1c
> m，如果铁锤每次打击做的功相等，则第二次能把铁钉击入 √ √ √ √ 1 1 2−1cm 2− A. 2+1
> cm B. 2cm C. D. cm 2 2 ▶2.2.4.3 运动 ·第 页，共 页· 258 402
>
> 题源：660 数二 376; 30 例 12.1　|　题源类型：660　|　页码：p.269　|　模块：2.2 物理应用（数一二）
