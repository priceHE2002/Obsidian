...
备注:
---
# 1.1.1.1.2.1-008 · 有理函数

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z 2 2x−4 dx= x2+2x+4 0 4 . dx。 Z Z x2 dx , J = dx, K =
>  . 1−x6 1+x2+x4 Z Z x2 dx , J = dx, K = . 1−x2+x4 1+x6
>
> 题源：2022 数三　|　题源类型：真题　|　页码：p.208　|　模块：1.1 有理函数
