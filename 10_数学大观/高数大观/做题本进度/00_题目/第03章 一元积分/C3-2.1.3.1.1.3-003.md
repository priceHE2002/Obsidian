...
模块: "2.1"
模块名: "几何应用"
题号: "C3-2.1.3.1.1.3-003"
源题号: "2.1.3.1.1.3-003"
序: 2017
题源: "1994 数三; 880 第三章综合解答 36"
题源大类: "真题"
重点: false
页码: 249
状态: "未开始"
...
备注:
---
# 2.1.3.1.1.3-003 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ √ 已知曲线 与曲线 在点 处有公共切线，求： y =a x (a>0) y =ln x (x ,y )
>  0 0 常数 及切点 )； (1) a (x ,y 0 0 两曲线与 轴围成的平面图形绕 轴旋转所得旋转体
> 的体积 (2) x x V x
>
> 题源：1994 数三; 880 第三章综合解答 36　|　题源类型：真题　|　页码：p.249　|　模块：2.1 几何应用
