...
> Z xcos3x−sinx esinx· dx。 I = cos2x Z esinx(xcos3x−sinx
> ) dx. 1+cos2x x<1, 则 的一个原函数是 f(x) ( ) x≥1, ·第 页，共 页· 2
> 12 402
>
> 题源：880 第三章综合解答 3　|　题源类型：880　|　页码：p.223　|　模块：1.4 三角相关
