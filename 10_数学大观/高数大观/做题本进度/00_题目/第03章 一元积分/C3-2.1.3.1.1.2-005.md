...
备注:
---
# 2.1.3.1.1.2-005 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> e−xcosx y′+y √ ⩾ 设函数 满足微分方程 ，且 0，求曲线 绕 轴旋转一周 y = f(x) 
> = f(π)= y = f(x)(x 0) x 2 sinx 所得旋转体的体积. ▶2.1.3.1.1.3 
> 补全作差
>
> 题源：1000 第十章强化 11　|　题源类型：1000　|　页码：p.248　|　模块：2.1 几何应用
