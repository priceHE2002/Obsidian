...
> 下列反常积分中发散的是 ( ). Z Z +∞ +∞ e−x −x2 √ x2e A. dx B. dx x
>  Z0 Z0 +∞ +∞ dx dx D. C. xln2x (x+2)ln2(x+2) 0 0
>
> 题源：26 张老师 1000 第 8 章强化 15　|　题源类型：1000　|　页码：p.272　|　模块：3.1 审敛
