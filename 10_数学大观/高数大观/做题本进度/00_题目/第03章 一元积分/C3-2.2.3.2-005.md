...
备注:
---
# 2.2.3.2-005 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 边长为 的等边三角形薄平板铅直沉没在水中，且一条边与水面相齐．记重力加速度为 g，水的密度为 ρ． 2 （1
> ）求该平板一侧所受的水压力； （2）当水面开始以 的速度上涨时，求平板一侧所受水压力的变化率．
>
> 题源：1000 第十二章强化 2　|　题源类型：1000　|　页码：p.264　|　模块：2.2 物理应用（数一二）
