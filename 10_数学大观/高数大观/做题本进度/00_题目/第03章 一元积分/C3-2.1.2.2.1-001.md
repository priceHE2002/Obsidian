...
> eaθ(a （4）设曲线的极坐标方程为 0)，则该曲线上相应于 从 变到 的一段弧与极轴所围成的图 ρ = 
> > θ 0 2π 形的面积为 ▶2.1.2.2.2 三叶玫瑰线
>
> 题源：2003 数二; 基础严选第六章填空 6　|　题源类型：真题　|　页码：p.243　|　模块：2.1 几何应用
