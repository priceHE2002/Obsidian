...
备注:
---
# 2.2.4.3-001 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> ct2 设一物体按规律 在某介质中做直线运动，其中 为时间参数。已知介质的阻力与速度成正比，比例 x = t
>  系数为 k，则物体由 到 这段时间内克服介质阻力所做的功为 x=0 x=a 形心质心
>
> 题源：900 第三章数二 A 类 76　|　题源类型：900　|　页码：p.270　|　模块：2.2 物理应用（数一二）
