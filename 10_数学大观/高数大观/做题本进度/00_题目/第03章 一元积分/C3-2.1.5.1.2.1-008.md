...
备注:
---
# 2.1.5.1.2.1-008 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> ! √ 1 2 设位于第一象限的曲线 过点 ，其上任一点 处的法线与 轴的交点为 Q，且线段 y =f(x)
>  , P(x,y) y 2 2 被 轴平分。 PQ x 求曲线 的方程； (1) y =f(x) 已知曲线 
> 在 上的弧长为 l，试用 表示曲线 的弧长 s。 (2) y =sinx [0,π] l y =f(x)
>
> 题源：2003 数二　|　题源类型：真题　|　页码：p.257　|　模块：2.1 几何应用
