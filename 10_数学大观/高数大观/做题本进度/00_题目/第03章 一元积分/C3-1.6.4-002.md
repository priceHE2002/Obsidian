...
> Z Z π 1 x f(x) ln(t+1) f(x)dx。 √ 计算 dx，其中 dt。 f(x)= t 
> x 0 1 Z 1 f(x)dx= 0 1 x2f(x)dx= . 0 Z 1 . xf(x)dx= 0 Z
>  1 x2f(x)dx； I = 0
>
> 题源：2013 数一; 基础严选第五章解答 5　|　题源类型：真题　|　页码：p.232　|　模块：1.6 定积分特殊题型
