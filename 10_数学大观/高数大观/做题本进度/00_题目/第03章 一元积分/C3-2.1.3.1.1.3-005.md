...
模块: "2.1"
模块名: "几何应用"
题号: "C3-2.1.3.1.1.3-005"
源题号: "2.1.3.1.1.3-005"
序: 2062
题源: "2020 数二; 30 例 10.6"
题源大类: "真题"
重点: false
页码: 249
状态: "未开始"
...
备注:
---
# 2.1.3.1.1.3-005 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> x2+2x 1 1 √ 设函数f(x)的定义域为(0,+∞)且满足2f(x)+x2f 。求f(x)，并求曲线
> y =f(x)，y ， = = x 2 1+x2 √ 3 及 轴所围图形绕 轴旋转所成旋转体的体积。 y =
>  y x 2
>
> 题源：2020 数二; 30 例 10.6　|　题源类型：真题　|　页码：p.249　|　模块：2.1 几何应用
