...
模块: "2.1"
模块名: "几何应用"
题号: "C3-2.1.3.1.2.1-001"
源题号: "2.1.3.1.2.1-001"
序: 1949
题源: "1996 数二; 基础严选第六章选择 4"
题源大类: "真题"
重点: false
页码: 252
状态: "未开始"
...
备注:
---
# 2.1.3.1.2.1-001 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设 在区间 上连续，且 g(x)<f(x)<m（m 为常数），由曲线 =g(x)，y =f(x)，x=a 及
>  f(x),g(x) [a,b] y 所围平面图形绕直线 旋转而成的旋转体体积为（ ） x=b y =m ·
> 第 页，共 页· 241 402
>
> 题源：1996 数二; 基础严选第六章选择 4　|　题源类型：真题　|　页码：p.252　|　模块：2.1 几何应用
