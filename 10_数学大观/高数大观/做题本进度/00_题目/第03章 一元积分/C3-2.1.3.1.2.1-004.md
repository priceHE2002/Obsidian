...
备注:
---
# 2.1.3.1.2.1-004 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设平面 是由 =lnx，x=1，y 围成的第一象限的有界区域，记 绕 轴与绕 旋转一周所得 D y =1 D
>  x y =1 旋转体的体积分别为 ，V ，则（ ）。 V 1 2 π π π π A. V > >V B.
>  V > >V C. >V >V D. >V >V 1 2 2 1 1 2 2 1 2 2 2 2 ▶2.1
> .3.1.2.2 圆域
>
> 题源：1000 第十章基础 16　|　题源类型：1000　|　页码：p.253　|　模块：2.1 几何应用
