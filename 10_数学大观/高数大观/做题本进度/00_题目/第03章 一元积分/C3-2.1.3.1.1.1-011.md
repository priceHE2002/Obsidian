...
备注:
---
# 2.1.3.1.1.1-011 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ 1 2 y′−xy ex √ 设函数 是微分方程 满足条件 的特解. y(x) = y(1)= e 2 
> 2 x 求 (1) y(x); ={(x,y)|1⩽x⩽2,0⩽y ⩽y(x)}, 设平面区域 求 绕 轴旋
> 转所得旋转体的体积. (2) D D x
>
> 题源：2019 数二三　|　题源类型：真题　|　页码：p.246　|　模块：2.1 几何应用
