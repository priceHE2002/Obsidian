...
备注:
---
# 2.1.3.1.1.3-006 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 2 π 0⩽x⩽ 设平面区域 由曲线 =sinx，y 围成，则区域 的面积以及该区域绕 轴旋转一周 D y 
> = x D x π 2 所得旋转体体积分别为 5π2 5π2 π2 π2 π π π π 1− 1− ， ，
>  ， ， A. B. 1+ C. D. 1+ 4 12 4 12 4 12 4 12
>
> 题源：660 数二 369　|　题源类型：660　|　页码：p.249　|　模块：2.1 几何应用
