...
备注:
---
# 2.1.3.1.1.5-003 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 0⩽x⩽1 ⩾0，又已知该抛物线与 =ax2+bx+c 设抛物线 过原点，当 时 轴及直线 所围图形 y y
>  x x=1 1 的面积为 ．试确定 的值，使此图形绕 轴旋转一周而成的旋转体的体积 最小． a,b,c x
>  V 3
>
> 题源：1989 数二　|　题源类型：真题　|　页码：p.251　|　模块：2.1 几何应用
