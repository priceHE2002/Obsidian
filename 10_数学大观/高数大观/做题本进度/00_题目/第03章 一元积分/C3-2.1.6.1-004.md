...
> ex+e−x 曲线 与直线 及 围成一曲边梯形. 该曲边梯形绕 轴旋转一周得一旋 y = x=0, x=t(
> t>0) y =0 x 2 转体, 其体积为 侧面积为 在 处的底面积为 V(t), S(t), x=t F
> (t). S(t) 求 的值; (1) V(t) S(t) 计算极限 (2) lim . t→+∞F(t)
>
> 题源：2004 数二　|　题源类型：真题　|　页码：p.259　|　模块：2.1 几何应用
