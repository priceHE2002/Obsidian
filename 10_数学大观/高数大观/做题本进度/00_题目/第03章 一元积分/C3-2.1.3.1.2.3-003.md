...
备注:
---
# 2.1.3.1.2.3-003 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =ex =ex 过坐标原点作曲线 的切线，该切线与曲线 以及 轴围成的向 轴负向无限伸展的平面图形记 y y
>  x x 为 D。求： 的面积 A； (1) D 绕直线 旋转一周所成的旋转体的体积 V。 (2) D x=
> 1
>
> 题源：30 例 10.7　|　题源类型：其他　|　页码：p.254　|　模块：2.1 几何应用
