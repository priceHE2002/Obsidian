...
备注:
---
# 2.1.3.1.1.6-003 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> i h √ π sinn 1−x2，x ∈ ∈ xn 与 【45】设 与 所围平面区域的面积为 ，g(x) 
> x，x f(x) = [0,1] y = 0 S = 0, 2 n 2 πS n。 (n=1,2,···)，
> 求极限 所围平面区域绕 轴旋转一周所得体积为 y =0 x V lim n V n→∞ n ▶2.1.3.1
> .2 绕坐标轴平行线转 ▶2.1.3.1.2.1 常规
>
> 题源：880 第三章综合解答 45　|　题源类型：880　|　页码：p.252　|　模块：2.1 几何应用
