...
备注:
---
# 2.1.3.1.2.2-003 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =a(0⩽a⩽1)，x=1，x=−1 ⩾0)，直线 x2+y2 所围成。记区 设区域 如图所示，由上半圆周 
> D =1(y y 域 绕直线 旋转一周所得旋转体的体积为 V(a)。求 的最大值与最小值。 D y =a V
> (a) ▶2.1.3.1.2.3 切线
>
> 题源：900 第三章数二 B 类 62　|　题源类型：900　|　页码：p.253　|　模块：2.1 几何应用
