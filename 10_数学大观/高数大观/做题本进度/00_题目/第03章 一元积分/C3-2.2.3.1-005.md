...
备注:
---
# 2.2.3.1-005 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> (−1,0), 设线密度为 的均匀细棒的两个端点分别在 (1,0)，在 处有一个质量为 的质点，G 为引力 
> 1 (0,1) m 常数，则细棒对质点的万有引力为（ ） Z Z 1 1 Gmx Gm A. 2 dx B.
>  2 dx (x2+1)1 (x2+1)1 2 2 Z0 Z0 1 1 Gmx Gm C. 2 dx D. 
> 2 dx (x2+1)3 3 (x2+1)2 2 0 0
>
> 题源：2026 数二　|　题源类型：真题　|　页码：p.263　|　模块：2.2 物理应用（数一二）
