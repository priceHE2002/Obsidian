...
备注:
---
# 2.1.3.1.1.4-002 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> π π 0⩽x⩽ 设 A>0，D 是由曲线段 及直线 =0，x= 所围成的平面区域，V ，V 分别表 y =
> Asinx y 1 2 2 2 示 绕 轴与绕 轴旋转所成旋转体的体积。若 ，求 的值。 D x y V =
> V A 1 2 ·第 页，共 页· 239 402
>
> 题源：2015 数二　|　题源类型：真题　|　页码：p.250　|　模块：2.1 几何应用
