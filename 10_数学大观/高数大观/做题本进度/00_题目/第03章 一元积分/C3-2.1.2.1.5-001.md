...
> ( x=t2+1, (t⩾0). 已知曲线 的方程为 L =4t−t2 y （1）讨论 的凹凸性； L (−
> 1,0) （2）过点 引 的切线，求切点 )，并写出切线的方程； L (x ,y 0 0 x⩽x （3）求此
> 切线与 L（对应于 的部分）及 轴所围成的平面图形的面积。 x 0
>
> 题源：2006 数二　|　题源类型：真题　|　页码：p.239　|　模块：2.1 几何应用
