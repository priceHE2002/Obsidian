...
备注:
---
# 2.1.3.1.1.1-018 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> xy′′−y′+2=0，当曲线 =y(x)(x⩾0) 设非负函数 满足微分方程 过原点时，其与直线 及 y 
> y =y(x) x=1 围成平面区域 的面积为 2，求 绕 轴旋转所得旋转体体积。 y =0 D D y
>
> 题源：2009 数二　|　题源类型：真题　|　页码：p.247　|　模块：2.1 几何应用
