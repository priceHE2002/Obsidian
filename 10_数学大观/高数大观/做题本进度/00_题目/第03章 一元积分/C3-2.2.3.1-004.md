...
备注:
---
# 2.2.3.1-004 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设单位质点 分别位于点 和 处，P 从点 出发沿 轴正向移动，记 为引力常量，则 P,Q (0,0) (0,
> 1) (0,0) x G 当质点 移动到点 时，克服质点 的引力所做的功为 P (l,0) Q ·第 页，共
>  页· 251 402
>
> 题源：2025 数二　|　题源类型：真题　|　页码：p.262　|　模块：2.2 物理应用（数一二）
