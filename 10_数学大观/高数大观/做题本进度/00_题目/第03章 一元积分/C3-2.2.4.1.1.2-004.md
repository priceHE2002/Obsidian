...
备注:
---
# 2.2.4.1.1.2-004 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 的半球形水池蓄满了水，现在要将水全部抽到距水池原水面 (仅数学一、数学二) 有一半径为 高的水 4m 6m 
> ρ=1000kg/m3，重力加速度 =9.8m/s2，π 箱中，求需做多少功。(水的密度 g =3.14)
>
> 题源：30 习题 12.3　|　题源类型：其他　|　页码：p.267　|　模块：2.2 物理应用（数一二）
