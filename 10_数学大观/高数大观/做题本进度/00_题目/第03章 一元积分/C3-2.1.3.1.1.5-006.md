...
备注:
---
# 2.1.3.1.1.5-006 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ xe−x 设 t>0，求曲线 与直线 x=t，x=2t 及 轴所围平面图形，绕 轴旋转所得的旋转体体积为
>  y = x x V(t)，求 的最大值。 V(t)
>
> 题源：2024 数二　|　题源类型：真题　|　页码：p.252　|　模块：2.1 几何应用
