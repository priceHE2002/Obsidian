...
备注:
---
# 2.1.5.1.2.1-010 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z x n 设非负函数y(x)是微分方程2yy′ y(t)dt(0⩽x⩽nπ) =cosx满足条件y(0)=
> 0的解，求曲线f (x)=n n 0 的弧长。 ▶2.1.5.1.2.2 x(y)
>
> 题源：1000 第十章强化 23　|　题源类型：1000　|　页码：p.257　|　模块：2.1 几何应用
