...
模块: "2.1"
模块名: "几何应用"
题号: "C3-2.1.3.1.1.1-002"
源题号: "2.1.3.1.1.1-002"
序: 1980
题源: "1988 数二; 基础严选第六章选择 3"
题源大类: "真题"
重点: false
页码: 245
状态: "未开始"
...
备注:
---
# 2.1.3.1.1.1-002 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =sin3 (0⩽x⩽π) 由曲线 与 轴围成的平面图形绕 轴旋转而成的旋转体的体积为（ ） (4) y x
>  x x 2 4 4 2 2 π2 A. B. π C. D. π 3 3 3 3
>
> 题源：1988 数二; 基础严选第六章选择 3　|　题源类型：真题　|　页码：p.245　|　模块：2.1 几何应用
