...
> π 0⩽x⩽ (0⩽x⩽π) 【20】设曲线 ，y 及 所围平面图形为 ，y 及 所 y =sinx =1 
> x=0 D =sinx y =0 1 2 围平面图形为 D 2 π 求 绕直线 旋转一周所得体积 ； (I)
>  D x= V 1 1 2 求 绕 轴旋转一周所得体积 (II) D y V 2 2
>
> 题源：880 第三章基础解答 20　|　题源类型：880　|　页码：p.253　|　模块：2.1 几何应用
