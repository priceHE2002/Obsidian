...
备注:
---
# 2.1.3.1.1.1-010 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> ( ) √ √ x2−1 (x,y)(cid:12)0⩽y ⩽ 2⩽x⩽2 设平面区域 ，求： , D = 
> x2 的面积； (1)D 绕 轴旋转一周所成旋转体的体积。 (2)D x
>
> 题源：1000 第十章基础 19　|　题源类型：1000　|　页码：p.246　|　模块：2.1 几何应用
