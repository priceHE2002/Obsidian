...
> 3π 3π cosx 已知函数 在 上连续，在 内是函数 的一个原函数，且 f(x) 0, 0, f(0)=
> 0. 2x−3π 2 2 3π 求 在区间 上的平均值； (I) f(x) 0, (cid:18)2 3π 
> 证明 在区间 内存在唯一零点. (II) f(x) 0, 2
>
> 题源：2016 数二; 1000 第十章强化 17（第一问）　|　题源类型：真题　|　页码：p.236　|　模块：2.1 几何应用
