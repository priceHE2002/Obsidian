...
备注:
---
# 2.1.3.1.1.3-001 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 =x2(x≥0) 在曲线 上某点 处作一切线，使之与曲线以及 轴所围图形（如右图）的面积为 ，试求： y
>  A x 12 切点 的坐标； (1) A 过切点 的切线方程； (2) A 由上述所围平面图形绕 轴旋转一
> 周所成旋转体的体积。 (3) x
>
> 题源：1988 数三　|　题源类型：真题　|　页码：p.248　|　模块：2.1 几何应用
