...
> ( x=a(t−sint), ⩽ ⩽ 记曲线 与 轴所围区域为 D。D 绕 轴旋转一周所得旋转体体积 (a 
> > 0,0 t 2π) x x =a(1−cost) y 为 ，绕直线 旋转一周所得旋转体体积为 ，则（ ）
>  V y =2a V 1 2 V <V B. =V A. V 1 2 1 2 的大小关系与 有关 C. V 
> >V D. V ,V a 1 2 1 2 ▶2.1.3.3 极坐标
>
> 题源：900 第三章数二 B 类 16　|　题源类型：900　|　页码：p.255　|　模块：2.1 几何应用
