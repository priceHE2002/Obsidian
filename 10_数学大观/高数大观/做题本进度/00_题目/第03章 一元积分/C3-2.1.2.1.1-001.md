...
源题号: "2.1.2.1.1-001"
序: 1928
题源: "1995 数二; 880 第三章综合填空 3; 基础严选第六章选择 1"
题源大类: "真题"
重点: false
页码: 237
状态: "未开始"
...
> =x(x−1)(2−x) 曲线 与 轴所围图形面积可表示为（ ） y x Z Z Z 2 1 2 − x(x
> −1)(2−x)dx x(x−1)(2−x)dx− x(x−1)(2−x)dx A. B. Z0 Z Z0 
> 1 1 2 2 − x(x−1)(2−x)dx+ x(x−1)(2−x)dx x(x−1)(2−x)dx C
> . D. 0 1 0
>
> 题源：1995 数二; 880 第三章综合填空 3; 基础严选第六章选择 1　|　题源类型：真题　|　页码：p.237　|　模块：2.1 几何应用
