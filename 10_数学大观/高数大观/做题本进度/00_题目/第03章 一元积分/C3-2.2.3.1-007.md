...
备注:
---
# 2.2.3.1-007 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> −a，右端点为 将质量为 的均匀细棒放置在 轴上，其左端点为 a。设 为引力系数，则均匀细棒对于 k y m
>  x (0,−a) 轴上点 处的质量为 的质点的引力大小为 m 0
>
> 题源：900 第三章数二 B 类 38　|　题源类型：900　|　页码：p.263　|　模块：2.2 物理应用（数一二）
