...
备注:
---
# 2.1.3.1.1.3-004 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 过点 作曲线 的切线，切点为 A。又 与 轴交于 点，区域 由 与直线 围成。 (0,1) L:y =lnx
>  L x B D L AB 求区域 的面积及 绕 轴旋转一周所得旋转体的体积。 D D x
>
> 题源：2012 数二　|　题源类型：真题　|　页码：p.249　|　模块：2.1 几何应用
