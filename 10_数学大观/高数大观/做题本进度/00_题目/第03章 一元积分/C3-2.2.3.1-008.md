...
备注:
---
# 2.2.3.1-008 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设沿 轴上的区间 放置一长度为 且线密度为 的均匀细杆，在 轴上 处有一单位质点，则该 y [0,1] 1 
> ρ x x=1 细杆对此质点的引力（G 为引力常量）沿 轴正向的分力为 x
>
> 题源：1000 第十二章基础 1　|　题源类型：1000　|　页码：p.263　|　模块：2.2 物理应用（数一二）
