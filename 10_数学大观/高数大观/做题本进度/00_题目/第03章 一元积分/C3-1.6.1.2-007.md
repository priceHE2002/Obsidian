...
> Z 2 2+tan3(x−1) 计算定积分 . dx. x2−2x+2 0 Z 2x+ex+1−e3−x 2
>  dx. x2−2x−3 0 Z π 1 2 dx。 √ 2 1+(tanx) 0 Z π sinxdx 2
>  ; 1+sinx+cosx 0 Z +∞ dx . (1+x2)(1+xα) 0
>
> 题源：真题同源 150　|　题源类型：真题同源　|　页码：p.229　|　模块：1.6 定积分特殊题型
