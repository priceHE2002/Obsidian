...
> =1−cosθ 心形线 的全长 . r s= 的弧长为 到 的一段弧长为 =0 θ =α(α>0) Z q 
> α 1+(abebθ)2dθ B. s= Z0 q α abebθ 1+(abebθ)2dθ D. s= 0
>  从 到 一段的弧长为 0 2π . 李正元例
>
> 题源：900 第三章数二 A 类 56　|　题源类型：900　|　页码：p.258　|　模块：2.1 几何应用
