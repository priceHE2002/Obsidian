...
备注:
---
# 2.2.3.1-002 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 【例 3.34】（江苏省高等数学竞赛题，1994 年）设质量为 M，长为 的均匀杆 吸引着质量为 的质点 C
> ， l AB m 位于 的延长线上与近端距离为 a，引力常数为 G。 C AB （I）求杆对质点的引力 F；
>  （II）求将质点 沿杆 的延长线移至无穷远处引力所作的功 W。 C AB
>
> 题源：1994 江苏竞赛　|　题源类型：真题　|　页码：p.262　|　模块：2.2 物理应用（数一二）
