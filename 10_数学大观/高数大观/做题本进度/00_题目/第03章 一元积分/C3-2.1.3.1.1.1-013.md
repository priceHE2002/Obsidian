...
备注:
---
# 2.1.3.1.1.1-013 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =xex，直线 已知曲线 与 轴所围平面图形的面积为 1，则由上述平面图形绕 轴旋转一周 y x=a (a>
> 0) x x ·第 页，共 页· 235 402
>
> 题源：900 第三章数二 A 类 68　|　题源类型：900　|　页码：p.246　|　模块：2.1 几何应用
