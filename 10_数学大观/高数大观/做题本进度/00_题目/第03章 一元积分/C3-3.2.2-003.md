...
> 8 lnα+1(1+x) 1 >< Z , 0<x< , 1 1+x 2 设函数 若积分 收敛，则（） f(
> x)= f(x)dx x 1 >: ⩽x<1. , 0 (1−x2)α 2 2 −2<α<0 −2<α<2 
> A. B. −2<α<0 或 C. 0<α<2 D. 0<α<2
>
> 题源：900 第三章数二 A 类 25　|　题源类型：900　|　页码：p.274　|　模块：3.2 敛散性和参数的关系
