...
备注:
---
# 2.1.3.1.1.6-002 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ x 【13】曲线 绕 轴旋转一周所得的旋转体，将它在 与 之间部分的体积记为 y = x x = 0 x
>  = ξ(ξ > 0) 1+x2 1 V(ξ)，且 V(ξ)，则 V(a)= lim a= 2ξ→+∞
>
> 题源：880 第三章基础填空 13　|　题源类型：880　|　页码：p.252　|　模块：2.1 几何应用
