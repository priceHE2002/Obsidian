...
备注:
---
# 2.1.3.1.1.3-010 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> =x2+1 过原点与曲线 相切的两条切线与 所围成的图形绕 轴旋转生成的旋转体体积 371 C :y C y
>  V = π π π A. B. C. D. π 4 2 6 ·第 页，共 页· 238 402
>
> 题源：660 数二 371　|　题源类型：660　|　页码：p.249　|　模块：2.1 几何应用
