...
模块: "2.1"
模块名: "几何应用"
题号: "C3-2.1.3.1.1.1-001"
源题号: "2.1.3.1.1.1-001"
序: 1943
题源: "1987 数二; 880 第三章基础填空 17"
题源大类: "真题"
重点: false
页码: 245
状态: "未开始"
...
备注:
---
# 2.1.3.1.1.1-001 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设 是由曲线 与三条直线 围成的曲边梯形，求 绕 轴旋转一周所生成 D y =sinx+1 x=0,x=π,
> y =0 D x 的旋转体的体积。
>
> 题源：1987 数二; 880 第三章基础填空 17　|　题源类型：真题　|　页码：p.245　|　模块：2.1 几何应用
