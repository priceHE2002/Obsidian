...
> 8 1 <√ x⩽0, , 1+x2 函数 f(x)= : (x+1)cosx, x>0 ( (cid:0)
> √ 1+x2−x ln , A. F(x)= (x+1)cosx−sinx, ( (cid:0)√ 1+x2
> +x ln , C. F(x)= (x+1)sinx+cosx,
>
> 题源：2023 数二三; 30 例 8.2　|　题源类型：真题　|　页码：p.224　|　模块：1.5 分段函数
