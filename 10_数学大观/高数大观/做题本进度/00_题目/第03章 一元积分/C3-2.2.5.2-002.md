...
备注:
---
# 2.2.5.2-002 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> x=a(t−sint), =a(1−cost) (0⩽t⩽2π) 摆线的一支 的质心是 379 y 2 5 
> 7 4 a) B. (πa, a) C. (πa, a) D. (πa, a) A. (πa, 3 3 4 
> 4
>
> 题源：660 数二 379　|　题源类型：660　|　页码：p.271　|　模块：2.2 物理应用（数一二）
