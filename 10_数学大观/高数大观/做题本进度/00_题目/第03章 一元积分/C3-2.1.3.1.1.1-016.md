...
备注:
---
# 2.1.3.1.1.1-016 · 几何应用

> [!question] 题目（程序自动提取，公式可能有偏差）
> xf′(x) f(x)+x2. 设函数 在 上连续，在 内可导，且满足 已知曲线 与 0， f(x) [0,
> 1] (0,1) = y = f(x) x = x=1，y 所围的图形 面积为 求 的表达式，以及图形 绕 
> 轴旋转一周所得旋转体的体积. =0 S 2. f(x) S x
>
> 题源：1000 第十章强化 9　|　题源类型：1000　|　页码：p.247　|　模块：2.1 几何应用
