...
备注:
---
# 2.2.4.1.2.2-002 · 物理应用（数一二）

> [!question] 题目（程序自动提取，公式可能有偏差）
> 【例 3.59】设有一半径为 R，长度为 的圆柱体，平放在深度为 的水池中（圆柱体的侧面与水面相切）．设 l
>  2R 圆柱体的比重为 ρ（ρ>1），现将圆柱体从水中移出水面，问需做多少功？ ▶2.2.4.2 打桩
>
> 题源：李正元例 3.59　|　题源类型：其他　|　页码：p.269　|　模块：2.2 物理应用（数一二）
