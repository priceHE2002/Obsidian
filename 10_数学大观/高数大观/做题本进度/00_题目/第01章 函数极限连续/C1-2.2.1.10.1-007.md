...
> Z x tf(x−t)dt f(0)=f′(0)=f′′(0)=0，f′′′(0)≠ Z0 【例 1.4】
> 设 在 处三阶可导，且 0，则 f(x) x=0 lim = x x→0 f(x−t)dt x . 0
>
> 题源：姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.41　|　模块：2.2 极限计算
