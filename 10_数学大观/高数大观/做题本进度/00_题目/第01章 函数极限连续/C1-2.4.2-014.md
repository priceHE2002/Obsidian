...
源题号: "2.4.2-014"
序: 602
题源: "880 第一章综合解答 18; 姜晓千真题同源 150（重点）"
题源大类: "真题同源"
重点: true
页码: 79
状态: "未开始"
...
> 【18】求下列极(cid:20)限： f(x) ln 1+ 1 f(x) sinx (a>0,a̸=1)，求
>  设 ； (I) lim = lim ax−1 x2 2 x→0 x→0 f(x) f(x) f(x) =1
> (a̸=0)，求 设 是三次多项式，且有 (II) f(x) lim = lim lim x→2ax−2a 
> x→4ax−4a x→3ax−3a 已知极限求函数值
>
> 题源：880 第一章综合解答 18; 姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.79　|　模块：2.4 已知极限相关
