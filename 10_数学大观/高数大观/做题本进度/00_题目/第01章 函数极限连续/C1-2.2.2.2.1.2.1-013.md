...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.1-013"
源题号: "2.2.2.2.1.2.1-013"
序: 326
题源: "24 版 1000 第八章 B 组 8"
题源大类: "1000"
重点: false
页码: 54
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.1-013 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ √ √ 1 √ 2+···+ ( 1+ n) 1+ lim (n+1)(n+2) n→∞
>
> 题源：24 版 1000 第八章 B 组 8　|　题源类型：1000　|　页码：p.54　|　模块：2.2 极限计算
