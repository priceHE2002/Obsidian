...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.5-002"
源题号: "2.2.2.2.1.2.5-002"
序: 119
题源: "24 版 1000 第九章 B 组 12"
题源大类: "1000"
重点: false
页码: 57
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.5-002 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 1 x >>>< lim 1+cos +cos n→∞n n 设 f(x)= 1, >>>: f(−x)
> , f′(0)； （1）求 [−π,π] （2）求 在 上的最大值。 f(x)
>
> 题源：24 版 1000 第九章 B 组 12　|　题源类型：1000　|　页码：p.57　|　模块：2.2 极限计算
