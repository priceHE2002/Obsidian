...
> ′ ′ (0,+∞) 设函数 在 内可导，且 (x)+f(x)]=1，则 f(x)， 分别为 f(x) li
> m [f lim lim f (x) x→+∞ x→+∞ x→+∞ A. 0,0 B. 1,1 C. 0,1
>  D. 1,0
>
> 题源：26 版 660 数一二三第 166 题　|　题源类型：660　|　页码：p.50　|　模块：2.2 极限计算
