...
> π {x } ，n=1,2,···。 已知数列 满足 ，x 0<x < +tanx =2x n 1 n+1 
> n n 4 证明 存在，并求其值； (1) lim x n(cid:18) n→∞ 1 1 − 求极限 (2
> ) lim x2 x x n→∞ n n+1 n
>
> 题源：26 版 1000 第二章强化 8　|　题源类型：1000　|　页码：p.62　|　模块：2.2 极限计算
