...
> π {x } −x ，n=1,2,···。 设数列 满足 ，cosx 0<x < =cosx n n n+1
>  n+1 n 2 证明 存在并求其值； (1) lim x n n→∞ x n+1。 计算 (2) lim 
> x2 n→∞ n
>
> 题源：26 版 1000 第二章强化 7　|　题源类型：1000　|　页码：p.62　|　模块：2.2 极限计算
