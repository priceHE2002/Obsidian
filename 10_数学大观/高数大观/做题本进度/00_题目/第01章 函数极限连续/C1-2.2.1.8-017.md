...
> (cid:19)(cid:21) n+1 n+2 =ln(2x2−1)有公共的切线，则 −f 已知(1,0)
> 在曲线y =f(x)上，且曲线在该点与y lim n f = n n n→∞ .
>
> 题源：26 版 1000 第三章强化 15　|　题源类型：1000　|　页码：p.37　|　模块：2.2 极限计算
