...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.2-002"
源题号: "2.2.2.2.1.2.2-002"
序: 116
题源: "浙江省 2009 年竞赛题（重点）"
题源大类: "其他"
重点: true
...
备注:
---
# 2.2.2.2.1.2.2-002 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> X2n n ； （1） lim i(n+i) n→∞ i=n X3n n （2） lim i(n+i) n→
> ∞ i=n+1
>
> 题源：浙江省 2009 年竞赛题（重点）　|　题源类型：其他　|　页码：p.55　|　模块：2.2 极限计算
