...
> 1 −x )(n=1,2,···)，求 【5】(I) 设 x =1,x =2,x = (3x lim x 1
>  2 n+2 n+1 n n 2 n→∞ 1 设 )，求 (II) x =1,x =2,x = (x +x 
> lim x 1 2 n+2 n n+1 n 2 n→∞ ▶2.2.2.4 其他
>
> 题源：880 综合解答 5（选做）　|　题源类型：880　|　页码：p.64　|　模块：2.2 极限计算
