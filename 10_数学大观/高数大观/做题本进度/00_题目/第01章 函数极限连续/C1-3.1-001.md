...
> 下列函数在其定义域内连续的是 (1) ( ) ( x⩽0, sinx, A. f(x)=lnx+sinx B
> . f(x)= cosx, x>0 8 8 >><x+1, 1 ><p x<0, x̸=0, , |x| C
> . f(x)= D. f(x)= 0, x=0, >>: >: 0, x=0 x−1, x>0
>
> 题源：1987 数三　|　题源类型：真题　|　页码：p.110　|　模块：3.1 判断或讨论连续性
