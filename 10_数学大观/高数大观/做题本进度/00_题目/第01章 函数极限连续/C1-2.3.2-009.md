...
> {a } {a } 设正项数列 单调增加，则以下选项中使得 收敛的是（）. n n n o n(cid:16
> ) o an 1 1 收敛于 收敛于 A. (1+a )a 1 B. 1+ e n n oa n n {a 
> } ln a 收敛于 收敛于 C. lna 0 D. 0 n n n a n
>
> 题源：26 版 1000 第二章强化 2　|　题源类型：1000　|　页码：p.69　|　模块：2.3 数列极限
