...
备注:
---
# 2.2.2.2.1.3-012 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> f(x)=x2，f[g(x)]=−x2+2x+3，且 【18】设 求 的定义域与值域； (I) g(x) X
> n k 1 k 求 (II) lim en n n+g(x) n→∞ k=1
>
> 题源：880 第三章综合解答 18　|　题源类型：880　|　页码：p.58　|　模块：2.2 极限计算
