...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.4-004"
源题号: "2.2.2.2.1.2.4-004"
序: 177
题源: "25 版 660 数一二三第 113（重点）"
题源大类: "660"
重点: true
页码: 57
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.4-004 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ Z 1 n2−1 2 n −y2 √ 计算 lim e dy+ n→∞ n2n+1 1 ▶2.2.2.2
> .1.2.5 到 x，n 等分，取端点（变限积分） 0
>
> 题源：25 版 660 数一二三第 113（重点）　|　题源类型：660　|　页码：p.57　|　模块：2.2 极限计算
