...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.3-001"
源题号: "2.2.2.2.1.2.3-001"
序: 81
题源: "2021 数一二"
题源大类: "真题"
重点: false
...
备注:
---
# 2.2.2.2.1.2.3-001 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设函数 在区间 上连续，则 f(x) [0,1] Xn 2k−1 1 A. lim f 2n 2n n→∞ 
> k=1 X2n k−1 1 C. lim f 2n n n→∞ k=1
>
> 题源：2021 数一二　|　题源类型：真题　|　页码：p.56　|　模块：2.2 极限计算
