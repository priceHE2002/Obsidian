...
> (−∞,+∞) 设 为 内的连续函数，a 为常数，则下述积分为 的偶函数的是（ ） f(u) x Z Z Z
>  Z u x u x v3 v2 f dv du f dv B. du A. Za Z0 Za Z0 x u
>  x u [f(v)]2dv [f(v)]3dv C. du D. du a 0 a 0
>
> 题源：24 版 1000 第八章 B 组 1　|　题源类型：1000　|　页码：p.15　|　模块：1.2 函数性质考察
