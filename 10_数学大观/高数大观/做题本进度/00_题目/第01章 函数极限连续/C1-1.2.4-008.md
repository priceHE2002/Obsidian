...
> [a,+∞) [a,+∞) 设 在 上连续，则“ 存在”是“f(x) 为 上的有界函数”的（ ） f(x) 
> lim f(x) x→+∞ 充分非必要条件 必要非充分条件 A. B. 充分必要条件 既非充分条件又非必要条
> 件 C. D. 综合
>
> 题源：26 版 660 数二第 519 题　|　题源类型：660　|　页码：p.19　|　模块：1.2 函数性质考察
