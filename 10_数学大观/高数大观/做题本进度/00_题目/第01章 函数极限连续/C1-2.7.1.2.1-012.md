...
> Z Z 5x sinx sint (1+t)1 x→0 设 则当 时, 是 的 (2) α(x)= dt, 
> β(x)= tdt, α(x) β(x) ( ) t 0 0 高阶无穷小 低阶无穷小 A. B. 同阶但不等
> 价的无穷小 等价无穷小 C. D.
>
> 题源：1999 数二; 880 第三章基础填空 7　|　题源类型：真题　|　页码：p.93　|　模块：2.7 无穷小阶数
