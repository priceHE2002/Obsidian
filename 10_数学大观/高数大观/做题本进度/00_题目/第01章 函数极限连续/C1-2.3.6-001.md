...
> Z Xn n [0,+∞) f(k)− (n=1,2,···)，证明数 设 是区间 上单调减少且非负的连续函
> 数，a f(x) = f(x)dx n 1 k=1 {a } 列 的极限存在。 n
>
> 题源：1999 数二; 880 第三章综合解答 54　|　题源类型：真题　|　页码：p.72　|　模块：2.3 数列极限
