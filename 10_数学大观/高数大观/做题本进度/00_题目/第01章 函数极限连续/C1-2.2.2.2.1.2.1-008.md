...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.1-008"
源题号: "2.2.2.2.1.2.1-008"
序: 259
题源: "25 版 660 数一二三第 60 题"
题源大类: "660"
重点: false
页码: 54
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.1-008 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> Xn √ . = k k=1 lim = . Xn √ n→∞ n+k k=1
>
> 题源：25 版 660 数一二三第 60 题　|　题源类型：660　|　页码：p.54　|　模块：2.2 极限计算
