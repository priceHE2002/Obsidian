...
> 【13】设f(x,y)在区域：0⩽x⩽1,0⩽y R√ R x2 t dt f(t,u)du 0 x 求 l
> im 4 1−e−x x→0+ 4 ▶2.2.1.12 含取整求极限
>
> 题源：880 第五章综合解答 13（选做）　|　题源类型：880　|　页码：p.45　|　模块：2.2 极限计算
