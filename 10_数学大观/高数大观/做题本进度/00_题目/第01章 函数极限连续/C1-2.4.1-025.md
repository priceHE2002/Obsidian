...
> sinx (cosx−b)=A，则 若 lim −a x→0ex2 A. a=1,b=0,A=1. B. a
> =1,b=0,A=0. C. a=0,b=1,A=1. D. a=1,b=1,A=0.
>
> 题源：26 版 660 数二第 512 题　|　题源类型：660　|　页码：p.75　|　模块：2.4 已知极限相关
