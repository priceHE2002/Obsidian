...
> 设 为连续的偶函数，a 是常数，则 f(u) (cid:20)Z (cid:20)Z Z Z u x u x
>  必是奇函数 必是奇函数 f(t)dt du tf(t)dt du B. A. a 0 0 a ·第 页，共
>  页· 4 402
>
> 题源：26 版 660 数二第 584 题　|　题源类型：660　|　页码：p.15　|　模块：1.2 函数性质考察
