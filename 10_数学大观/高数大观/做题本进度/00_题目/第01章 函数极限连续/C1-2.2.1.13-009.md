...
> [!note]- 题干预览（自动提取，仅供参考）
> 考察下列运算： − 1 e 2 x ⃝ lim 1 x x→0 √ ⃝ lim 2 x→+∞ 1+x2 由于分子与分母一直反复，所以该极限不存在。 ⃝ 由于 lim 3 +∞x x→ 法则， lim x→+∞x+cosx 其中运算与结论都正确的个数为 A. 0 ▶2.2.1.14 其他
>
> 题源：26 版 660 数二第 511 题　|　页码：p.47　|　模块：2.2 极限计算
