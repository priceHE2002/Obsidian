...
> f(x) 【11】设 在 的某邻域内连续，f(0)=0，lim =2，则 在 处（ ）。 f(x) x=0 
> f(x) x=0 x→01−cosx f′(0)̸=0 不可导 可导且 A. B. 有极小值 有极大值 C.
>  D.
>
> 题源：1990 数一; 880 第二章基础选择 11　|　题源类型：真题　|　页码：p.81　|　模块：2.4 已知极限相关
