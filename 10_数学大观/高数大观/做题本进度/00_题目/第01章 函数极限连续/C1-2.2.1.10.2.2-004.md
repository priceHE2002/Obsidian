...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.1.10.2.2-004"
源题号: "2.2.1.10.2.2-004"
序: 168
题源: "900 第三章数二 B 类 35（重点）"
题源大类: "900"
重点: true
页码: 44
状态: "未开始"
...
备注:
---
# 2.2.1.10.2.2-004 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> R x sinxtlnxtdt 1 . R lim = . x 1 x→+∞ 1dt 1 t x ·第 页，
> 共 页· 33 402
>
> 题源：900 第三章数二 B 类 35（重点）　|　题源类型：900　|　页码：p.44　|　模块：2.2 极限计算
