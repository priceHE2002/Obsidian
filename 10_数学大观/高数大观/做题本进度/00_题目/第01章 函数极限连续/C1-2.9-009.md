...
> r 1+x a+bx+cx2，则（ 设函数 在 处的 次泰勒多项式为 ）. f(x)= x=0 2 1−x 
> 1 A. a=1,b=1,c=1 B. a=1,b=1,c= 2 1 a=0,b=−1,c= a=0,b=−
> 1,c=1 C. D. 2
>
> 题源：26 版 1000 第一章强化 33　|　题源类型：1000　|　页码：p.110　|　模块：2.9 泰勒多项式
