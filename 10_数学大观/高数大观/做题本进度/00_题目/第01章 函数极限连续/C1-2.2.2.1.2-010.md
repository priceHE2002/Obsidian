...
> Z π (n=1,2,···). xsinnxdx 【22】设 a = n 0 n−1 (n=3,4,···
> )； 证明：a (I) = a n−2 n n a n 求 (II) lim . n→∞a n−1 ▶2.2
> .2.2 项数列极限计算 n ▶2.2.2.2.1 项和 n ▶2.2.2.2.1.1 夹逼定理
>
> 题源：880 第三章综合解答 22　|　题源类型：880　|　页码：p.53　|　模块：2.2 极限计算
