...
> −2x+x1− 2 设 存在，且有 limf(x)，则 limf(x) f(x)=e f(x)= x x→1
>  x→1
>
> 题源：26 版 660 数一二三第 16 题　|　题源类型：660　|　页码：p.90　|　模块：2.6 根据含极限等式确定函数
...
→ 所属模块：[[C1-2.6 根据含极限等式确定函数|2.6 根据含极限等式确定函数]]