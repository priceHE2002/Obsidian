...
> f′(x) ∈(a,b) 设 在 内可导，x 是 的间断点，则该间断点一定是 f(x) (a,b) 0 ∞，
> 称 注：若 中有一个为 是 的无穷型间断点。 lim g(x) x g(x) 0 x→x± 0 可去间断点 
> 跳跃间断点 A. B. 无穷型间断点 非无穷型第二类间断点 C. D.
>
> 题源：26 版 660 数二第 566 题　|　题源类型：660　|　页码：p.118　|　模块：3.3 间断点
