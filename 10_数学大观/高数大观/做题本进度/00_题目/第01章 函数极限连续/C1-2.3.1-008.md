...
> 【10】设 与 均不存在，则下列选项正确的是（ ）. lim a lim b n n n→∞ n→∞ −b 
> −b 若 不存在，则 必不 若 )不存在，则 )必存在 A. lim (a +b ) lim (a ) B.
>  lim (a +b lim (a n n n n n n n n n→∞ n→∞ n→∞ n→∞ 存在 −
> b −b 若 )存在，则 )必不存在 若 存在，则 必存在 C. lim (a +b lim (a D. l
> im (a +b ) lim (a ) n n n n n n n n n→∞ n→∞ n→∞ n→∞
>
> 题源：880 第一章基础选择 10　|　题源类型：880　|　页码：p.67　|　模块：2.3 数列极限
