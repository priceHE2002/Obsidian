...
> 8 ln(x−1) >< x∈(1,2)∪(2,+∞) , (x−1)(x−2) 设函数 ，则 f(x)= 
> f(x) >: 0, x=2 (2,+∞) 在 区间有界. 在 区间有界. A. (1,2) B. (1,+
> ∞) (2,+∞) 在 区间有界. 在 和 区间都无界. C. D. (1,2)
>
> 题源：25 版 660 数一二三第 135 题　|　题源类型：660　|　页码：p.19　|　模块：1.2 函数性质考察
