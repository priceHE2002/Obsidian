...
> 8 +be− ><aex 1 1 x x̸=0, , −e− 2 1 若函数 在 上连续，则（ ） f(x)
> = R ex x >: 0, x=0 a̸=0,b=0 A. a=0,b=0 B. 可以取任意值，b=0 可
> 以取任意值 C. a D. a=0,b ·第 页，共 页· 102 402
>
> 题源：900 数二第一章 A 类 27　|　题源类型：900　|　页码：p.113　|　模块：3.2 已知连续确定参数
