...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.4-005"
源题号: "2.2.2.2.1.4-005"
序: 204
题源: "900 第五章数二 C 类 1（重点）"
题源大类: "900"
重点: true
页码: 59
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.4-005 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> Xn−i Xn i 1 −sin 记 sin I = lim 1 n→∞n2 n i=1j=1 X−1 X−
> 1 1 i I = lim sin +sin 3 n→∞n2 n i=−nj=−n−i 则 中，（ ） I 
> ,I ,I ,I 1 2 3 4 最小，I 最大 A. I 1 2 最小，I 最大 C. I 3 2 ▶2.
> 2.2.2.1.5 极坐标
>
> 题源：900 第五章数二 C 类 1（重点）　|　题源类型：900　|　页码：p.59　|　模块：2.2 极限计算
