...
> [!note]- 题干预览（自动提取，仅供参考）
> 1 记 I = lim 1 n→∞n2 X−1 1 I = lim 3 n→∞n2 i=−nj=−n−i 则 中，（ I ,I ,I ,I 1 2 3 4 最小，I 最大 A. I 1 2 最小，I 最大 C. I 3 2 ▶2.2.2.2.1.5 极坐标
>
> 题源：900 第五章数二 C 类 1（重点）　|　页码：p.59　|　模块：2.2 极限计算
