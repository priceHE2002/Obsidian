...
> {x } 设 是数列. 下列命题中不正确的是 (1) ( ) n 若 =a，则 若 =a，则 A. lim 
> x lim x = lim x =a B. lim x = lim x lim x =a n 2n 2n+1
>  2n 2n+1 n n→∞ n→∞ n→∞ n→∞ n→∞ n→∞ 若 =a，则 若 =a，则 C. li
> m x lim x = lim x =a D. lim x = lim x lim x =a n 3n 3n
> +1 3n 3n+1 n n→∞ n→∞ n→∞ n→∞ n→∞ n→∞ ·第 页，共 页· 55 402
>
> 题源：2015 数三; 880 基础解答 4　|　题源类型：真题　|　页码：p.66　|　模块：2.3 数列极限
