...
> 2 3 1 y− x2+ 【24】设 有连续的二阶导数，曲线 在其上点 处的曲率圆方程为 ，则 f(x) y
>  =f(x) (0,1) = 2 4 在 处的二次泰勒多项式为（ ）． f(x) x=0 1 1−x2 1−
>  1+x2 x2 1+2x2 A. B. C. D. 2 ·第 页，共 页· 98 402
>
> 题源：880 第二章综合选择 24　|　题源类型：880　|　页码：p.109　|　模块：2.9 泰勒多项式
