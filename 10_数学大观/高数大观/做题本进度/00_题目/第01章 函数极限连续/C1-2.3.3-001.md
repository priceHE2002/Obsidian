...
> {a }，{b } {a } 无界，{b } 设 均为正项数列，其中 有界，则下列数列中，一定有界的是（ ）
>  (cid:27)n n n n b b n n A. B. a 1+a b (cid:8)√n n n {
> a −a } na C. b D. b b n−1 n−1 n n n n
>
> 题源：900 数二第一章 A 类 4　|　题源类型：900　|　页码：p.70　|　模块：2.3 数列极限
