...
> (−∞,+∞) 【例 3.34】(2020，数三) 设奇函数 上有一阶连续导数，则【 】 在 f(x) Z 
> Z x x ′ ′ 为奇函数 为偶函数 A. [cosf(t)+f (t)]dt B. [cosf(t)+f
>  (t)]dt Z0 Z0 x x ′ ′ 为奇函数 为偶函数 C. [cosf (t)+f(t)]dt D
> . [cosf (t)+f(t)]dt 0 0
>
> 题源：2020 数三　|　题源类型：真题　|　页码：p.14　|　模块：1.2 函数性质考察
