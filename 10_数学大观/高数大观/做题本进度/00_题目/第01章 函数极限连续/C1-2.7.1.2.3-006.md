...
> p p √ √ √ =1−cos x→0+ 设 当 时, 以上三个无穷小量按照从低阶到 3 α = x+ x
> , α = xtan(x+ x), α x. 1 2 3 高阶的排序是 ( ) A. α ,α ,α B. 
> α ,α ,α C. α ,α ,α D. α ,α ,α 1 2 3 1 3 2 2 1 3 3 1 2
>
> 题源：900 数二第一章 A 类 14　|　题源类型：900　|　页码：p.96　|　模块：2.7 无穷小阶数
