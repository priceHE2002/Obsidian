...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.1.10.1-028"
源题号: "2.2.1.10.1-028"
序: 427
题源: "26 版 660 数二第 478 题"
题源大类: "660"
重点: false
页码: 43
状态: "未开始"
...
> (cid:20)Z Z 2x+1 1 1 et2 et2 dt− lim . dt = x→0x2 2x−1
>  −1 . R ex f(t)dt 1 处满足 =∆x+o(∆x)，则极限 (1,0) ∆y lim = x
> →0x2+ln(1+x3) 2 . 12 Z 8 2x ><1 x cost2dt xf(x)+g(x) s
> in , x<0, 1 x 2 0 ，且函数g(x)= 则 lim = 1 >: 2 xg(x) x→0 x
> ⩾0, x+ , 2 3 (x−1)3 R lim = . x x→1 y(t)dt 1 ·第 页，共 页·
>  32 402
>
> 题源：26 版 660 数二第 478 题　|　题源类型：660　|　页码：p.43　|　模块：2.2 极限计算
