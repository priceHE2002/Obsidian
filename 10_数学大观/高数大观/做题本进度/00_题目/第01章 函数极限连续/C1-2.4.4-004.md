...
源题号: "2.4.4-004"
序: 553
题源: "26 版 660 数一二三第 40 题; 26 版 1000 第五章强化 2"
题源大类: "660"
重点: false
页码: 79
状态: "未开始"
...
> [f(x)+1]x2 设f(x)在x=0处连续，且 =2，则曲线y =f(x)在点(0,f(0))处的切线方
> 程为 lim x−sinx x→0
>
> 题源：26 版 660 数一二三第 40 题; 26 版 1000 第五章强化 2　|　题源类型：660　|　页码：p.79　|　模块：2.4 已知极限相关
