...
> Z ln(1+x) tf(t)dt 1 f(0)=0，f′(0)= (cid:20)0Z 设函数 连续，且 
> ，则 = f(x) lim xp 2 2 x→0+ f(t)dt 0 ·第 页，共 页· 30 402
>
> 题源：900 第三章数二 B 类 33　|　题源类型：900　|　页码：p.41　|　模块：2.2 极限计算
