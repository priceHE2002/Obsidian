...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.5-003"
源题号: "2.2.2.2.1.2.5-003"
序: 150
题源: "26 版 1000 第八章强化 18"
题源大类: "1000"
重点: false
页码: 57
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.5-003 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> x x2 − −4 【18】设 e f(x)= lim +e 2 n n→∞n （1）f(x) 的表达式； 
> =ex2f(x) （2）曲线 的拐点。 y ▶2.2.2.2.1.3 定积分定义 夹逼 +
>
> 题源：26 版 1000 第八章强化 18　|　题源类型：1000　|　页码：p.57　|　模块：2.2 极限计算
