...
> {x } {y } 均无界，{z } 设 与 有界，则以下命题正确的是 n n n {x } {x } {x
>  } {x } 无界 无界 无界 无界 A. +y B. y C. +z D. z n n n n n n 
> n n
>
> 题源：26 版 660 数一二三第 136 题　|　题源类型：660　|　页码：p.70　|　模块：2.3 数列极限
