...
> x2en(x−1)+ax+b 设 ，求 并讨论 的连续性及可导性与 的关系. f(x)= lim f(x) 
> f(x) a,b 5+en(x−1) n→∞ 根据含极限等式确定函数
>
> 题源：26 版 1000 第三章基础 15　|　题源类型：1000　|　页码：p.90　|　模块：2.5 以极限形式给出的函数
