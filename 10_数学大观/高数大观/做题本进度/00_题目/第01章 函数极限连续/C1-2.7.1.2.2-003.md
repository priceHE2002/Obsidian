...
> x→0 当 时，以下无穷小中，阶数最高的是（ ）。 Z Z ln(1+x2)√ sinx (1+t)2 co
> s3tdt A. dt B. t Z0 Z0 x−tanx x (ecost−esint)dt C. D. 
> arctantdt 0 0
>
> 题源：26 版 1000 第一章强化 26　|　题源类型：1000　|　页码：p.95　|　模块：2.7 无穷小阶数
