...
> (x−1)2+y2 → 已知曲线 在其点 处的曲率圆方程为 2，且当 时，二阶可导函数 y = f(x) (
> 0,1) = x 0 f(x) a+bx+cx2 x2 与 的差为 ，则（ ）. o 3 A. a=0,b=
> 1,c= B. a=1,b=0,c=1 2 a=1,b=1,c=−1 a=1,b=0,c=−1 C. D.
>
> 题源：26 版 1000 第五章基础 10　|　题源类型：1000　|　页码：p.110　|　模块：2.9 泰勒多项式
