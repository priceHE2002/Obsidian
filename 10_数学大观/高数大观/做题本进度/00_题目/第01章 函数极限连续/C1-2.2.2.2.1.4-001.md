...
备注:
---
# 2.2.2.2.1.4-001 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> Xn Xn n (4) lim =( (n+i)(n2+j2) n→∞ i=1j=1 Z Z 1 x 1 A
> . dx dy (1+x)(1+y2) Z0 Z0 1 1 1 C. dx dy (1+x)(1+y) 0 
> 0
>
> 题源：2010 数一　|　题源类型：真题　|　页码：p.59　|　模块：2.2 极限计算
