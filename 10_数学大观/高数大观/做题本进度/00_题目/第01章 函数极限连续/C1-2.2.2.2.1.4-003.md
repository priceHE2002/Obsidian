...
> [!note]- 题干预览（自动提取，仅供参考）
> Xn Xn lim n→∞ (n+i) i=1j=1 π C. ln2 2 (cid:18) X−1 Xn+i 1 sin i=−nj=1 (cid:18) X−1 Xn 1 sin i=1j=i−n 最小，I 最大 B. I 1 4 最小，I 最大 D. I 3 4 A，则 A=( Xn 8π3i2 C. lim n3 n→∞ i=1 (cid:19) 2
>
> 题源：25 版 0.1w 强化 1　|　页码：p.59　|　模块：2.2 极限计算
