...
> {a },{b }，满足 已知数列 ，则下列命题中，正确的是（） 0<a <b <2a n n n n n 
> ⃝ 若 =0，则 =0。 lim a lim b 1 n n n→∞ n→∞ ⃝ 若 =0，则 =0。 li
> m b lim a 2 n n n→∞ n→∞ ⃝ 若 存在，则 存在。 lim a lim b 3 n n
>  n→∞ n→∞ ⃝ −b ⩽ 若 存在，则 lim (a ) lim a lim b 4 n n n n 
> n→∞ n→∞ n→∞ ⃝ ⃝ ⃝ ⃝ ⃝ ⃝ ⃝ ⃝ ⃝ ⃝ 2。 3。 3。 4。 A. B. C. D
> . 1 2 1 2 1 3
>
> 题源：900 数二第一章 B 类 10　|　题源类型：900　|　页码：p.69　|　模块：2.3 数列极限
