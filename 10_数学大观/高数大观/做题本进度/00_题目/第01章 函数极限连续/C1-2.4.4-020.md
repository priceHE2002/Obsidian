...
> f(x) f′′′(0)= 设 在 处存在 阶导数，且 =1。则 f(x) x=0 3 lim x→0tan
> x−sinx A. 0 B. 1 C. 2 D. 3 已知极限，推导其他
>
> 题源：26 版 660 数一二三第 154 题　|　题源类型：660　|　页码：p.81　|　模块：2.4 已知极限相关
