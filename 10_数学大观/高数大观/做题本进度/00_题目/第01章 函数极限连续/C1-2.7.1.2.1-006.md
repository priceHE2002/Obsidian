...
> Z √ 2x t x→0+ 若函数 连续，g(x)= 的（ ）。 dt，则当 时，g(x) 是 f x+ f
> (x) x 2 0 高阶无穷小 低阶无穷小 A. B. 等价无穷小 同阶非等价无穷小 C. D.
>
> 题源：25 版 1000 第九章基础 12　|　题源类型：1000　|　页码：p.92　|　模块：2.7 无穷小阶数
