...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.1-005"
源题号: "2.2.2.2.1.2.1-005"
序: 201
题源: "900 第三章数二 A 类 87"
题源大类: "900"
重点: false
...
备注:
---
# 2.2.2.2.1.2.1-005 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> r Xn k k 求 lim arctan n2 n n→∞ k=1 180 n +···+ = n2+n2
>  π π C. D. 3 6
>
> 题源：900 第三章数二 A 类 87　|　题源类型：900　|　页码：p.54　|　模块：2.2 极限计算
