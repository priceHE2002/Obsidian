...
> f(x) 设函数 在 处连续，且 =2，则曲线 在 处的法线方程为 f(x) x=0 lim y =f(x)
>  x=0 x→0ex−1 ·第 页，共 页· 68 402
>
> 题源：26 版 660 数一二三第 28 题　|　题源类型：660　|　页码：p.79　|　模块：2.4 已知极限相关
