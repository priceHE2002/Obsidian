...
> (−∞,+∞) 【15】设 在 内为连续的奇函数，a 为常数，则必为偶函数的是（ ） f(x) Z Z Z 
> Z x u x u A. du tf(t)dt B. du f(t)dt Z0 Za Za Z0 x u x
>  u C. du f(t)dt D. du tf(t)dt 0 a a 0
>
> 题源：880 第一章综合选择 15　|　题源类型：880　|　页码：p.15　|　模块：1.2 函数性质考察
