...
> √ {a } nn,n=1,2,···，则下列命题中，正确的是（） 设数列 满足 a = n n {a } 
> {a } 数列 能取到最小值，但取不到最大值 数列 能取到最大值，但取不到最小值 A. B. n n {a 
> } {a } 数列 既能取到最大值，又能取到最小值 数列 既不能取到最大值，又不能取到最小值 C. D. n
>  n
>
> 题源：900 数二第一章 A 类 5　|　题源类型：900　|　页码：p.71　|　模块：2.3 数列极限
