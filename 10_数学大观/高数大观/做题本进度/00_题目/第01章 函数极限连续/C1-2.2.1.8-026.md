...
> 1 1 =1−en −sin =f(x)−sinx −f(a 1 已知 ，可导函数 在 处取得极值。计算 a
>  y x=0 l im n f ) n n 2 n n → ∞ n ·第 页，共 页· 27 402
>
> 题源：26 版 1000 第三章强化 22　|　题源类型：1000　|　页码：p.38　|　模块：2.2 极限计算
