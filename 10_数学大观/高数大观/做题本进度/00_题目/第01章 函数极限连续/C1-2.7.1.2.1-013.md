...
> Z x x7 x6 可导，f(0)=0，f′(0)=2，F(x)= t2f(x3−t3)dt，g(x)= x
> →0 设 ，则当 时，F(x) 是 f(x) + 5 6 0 的 g(x) 低阶无穷小 高阶无穷小 A. B
> . 等价无穷小 同阶但非等价无穷小 C. D. ·第 页，共 页· 82 402
>
> 题源：26 版 660 数二第 570 题　|　题源类型：660　|　页码：p.93　|　模块：2.7 无穷小阶数
