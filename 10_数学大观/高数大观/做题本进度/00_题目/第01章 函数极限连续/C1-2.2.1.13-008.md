...
> 下列极限中，能用洛必达法则计算极限的为 ex−e−x x+sinx A. lim B. lim x→+∞ex
> +e−x x x→∞ 1 x2sin ex−esinx x C. lim D. lim x−sinx sin
> x x→0 x→0
>
> 题源：26 版 660 数一二三第 148 题　|　题源类型：660　|　页码：p.47　|　模块：2.2 极限计算
