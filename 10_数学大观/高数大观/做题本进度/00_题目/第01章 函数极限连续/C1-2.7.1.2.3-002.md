...
> Z Z √ √ x2 x x→0+ 1−x2−1 cost2dt，β 将 时的三个无穷小量 tdt，γ 排列
> 起来，使得排在后 α= = sin = 0 0 面一个是前面一个的高阶无穷小，则正确的排列次序是 A. α,
> β,γ B. α,γ,β C. β,α,γ D. β,γ,α
>
> 题源：26 版 660 数三第 630 题　|　题源类型：660　|　页码：p.95　|　模块：2.7 无穷小阶数
