...
> sin6x−(sinx)f(x) 6−f(x) 设 =0，则 lim lim = x3 x2 x→0 x→0
>  ∞ A. 0 B. 35 C. 36 D. ·第 页，共 页· 66 402
>
> 题源：26 版 660 数一二三第 147 题　|　题源类型：660　|　页码：p.77　|　模块：2.4 已知极限相关
