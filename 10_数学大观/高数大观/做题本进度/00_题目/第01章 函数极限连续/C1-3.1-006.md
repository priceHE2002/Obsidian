...
> |f(x)| 在 点连续” 是 在 点连续的 ”f(x) x x 0 0 充分条件，但不是必要条件 必要条件
> ，但不是充分条件 A. B. 充分必要条件 既不是充分条件，也不是必要条件 C. D.
>
> 题源：26 版 660 数一二三第 120 题　|　题源类型：660　|　页码：p.111　|　模块：3.1 判断或讨论连续性
