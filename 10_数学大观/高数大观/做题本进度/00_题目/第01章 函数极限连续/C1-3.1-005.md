...
> 8 1 < x̸=±1, (x+1)arctan , x2−1 则 f(x)（ ）. 【6】设 f(x)= 
> : x=±1, 0, x=1,x=−1 x=1,x=−1 在 处都连续 在 处都间断 A. B. x=−1 
> x=−1 在 处间断，x=1 处连续 在 处连续，x=1 处间断 C. D.
>
> 题源：880 第一章综合选择 6　|　题源类型：880　|　页码：p.111　|　模块：3.1 判断或讨论连续性
...
→ 所属模块：[[C1-3.1 判断或讨论连续性|3.1 判断或讨论连续性]]