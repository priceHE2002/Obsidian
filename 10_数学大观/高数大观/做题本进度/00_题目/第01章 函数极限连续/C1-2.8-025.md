...
> 1 +ex ex arctanx 【例 2.12】曲线 有【 】 y = 1 −ex x ex 三条渐近线和
> 一个第一类间断点 三条渐近线和两个第一类间断点 A. B. 两条渐近线和两个第一类间断点 两条渐近线和一个第
> 一类间断点 C. D. ·第 页，共 页· 94 402
>
> 题源：姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.105　|　模块：2.8 渐近线
