...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.3-002"
源题号: "2.2.2.2.1.2.3-002"
序: 117
题源: "26 版 1000 第八章基础 1"
题源大类: "1000"
重点: false
页码: 56
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.3-002 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设函数 在区间 上连续，则 f(x) [0,1] Xn 3k−1 1 A. lim f 3n 3n n→∞ 
> k=1 X3n k−1 1 f C. lim 3n n n→∞ k=1
>
> 题源：26 版 1000 第八章基础 1　|　题源类型：1000　|　页码：p.56　|　模块：2.2 极限计算
