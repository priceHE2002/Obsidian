...
> 1<a⩽e1 =ax1，···，x =axn−1，···，则 设 ，x =a，x e 1 2 n {x } 
> {x } 数列 单调增，但是没有极限。 数列 单调增，且有极限。 A. B. n n {x } {x } 数
> 列 单调减，但是没有极限。 数列 单调减，且有极限。 C. D. n n
>
> 题源：25 版 660 数一二三第 123 题　|　题源类型：660　|　页码：p.64　|　模块：2.2 极限计算
