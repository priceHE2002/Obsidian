...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.1-001"
源题号: "2.2.2.2.1.1-001"
序: 78
题源: "1995 数二; 26 版 660 数一二三第 132 题; 880 第一章基础解答 6-1"
题源大类: "真题"
重点: false
页码: 53
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.1-001 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 2 n +···+ 137 lim + = n2+n+1 n2+n+2 n2+n+n n→∞ 2 1 A
> . 3 B. 2 C. D. 3 2
>
> 题源：1995 数二; 26 版 660 数一二三第 132 题; 880 第一章基础解答 6-1　|　题源类型：真题　|　页码：p.53　|　模块：2.2 极限计算
