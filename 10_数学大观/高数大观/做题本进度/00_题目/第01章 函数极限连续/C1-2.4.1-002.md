...
> Z x t2 1 √ c̸=0，则（ dt=c，且 ）。 设 (6) lim x→0sinx−ax 1+t2
>  b a=1,b=0,c=−2 a=1,b=−2,c=−2 A. B. a=0,b=1,c=−2 C. D.
>  a=1,b=1,c=1 ·第 页，共 页· 61 402
>
> 题源：880 第三章基础选择 10　|　题源类型：880　|　页码：p.72　|　模块：2.4 已知极限相关
