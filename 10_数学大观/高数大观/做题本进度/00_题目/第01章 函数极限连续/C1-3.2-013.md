...
> ( ( x, x<1 b, x<0 设 ，g(x)= ，且 为连续函数，则 f(x)= f(x)+g(x) 
> x⩾1 x⩾0 a, x+2, a=−2,b=−1 A. a=0,b=0 B. a=2,b=1 C. a=1
> ,b=2 D.
>
> 题源：26 版 660 数二第 506 题　|　题源类型：660　|　页码：p.113　|　模块：3.2 已知连续确定参数
