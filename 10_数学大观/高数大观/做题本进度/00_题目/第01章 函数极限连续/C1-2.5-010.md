...
> Z x narctan(nx) √ x∈[−1,1] 在 上是（ ）. 【9】设 ，则 f(t)dt f(x
> )= lim F(x)= n→∞ n2+nx −1 连续但不可导的奇函数 连续但不可导的偶函数 A. B. 
> 可导的偶函数 可导的奇函数 C. D. ·第 页，共 页· 77 402
>
> 题源：880 第二章综合选择 9　|　题源类型：880　|　页码：p.88　|　模块：2.5 以极限形式给出的函数
