...
> n 1 ，n=1,2,···，则下列命题中，正确的是（ 设 ） a = 1+sin n n {a } {a 
> } 数列 单调增加且收敛于 数列 单调减少且收敛于 A. e B. e n n {a } {a } esin
> 1 esin1 数列 单调增加且收敛于 数列 单调减少且收敛于 C. D. n n
>
> 题源：900 数二第一章 A 类 6　|　题源类型：900　|　页码：p.70　|　模块：2.3 数列极限
