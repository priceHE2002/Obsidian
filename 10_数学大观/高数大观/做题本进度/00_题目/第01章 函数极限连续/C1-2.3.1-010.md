...
> {a } 已知 =a，则下列关于数列 的说法中，正确的是（ ） lim a n n n→∞ a⩾0，则 {a
>  } 若 a>0，则当 充分大时，a >0。 若 中只存在有限个负项。 A. n B. n n 1 1 ⩾−
>  ⩽ 若 a=0，则当 充分大时，a 若 a=0，则当 充分大时，a C. n D. n n n n n
>
> 题源：900 数二第一章 A 类 10　|　题源类型：900　|　页码：p.67　|　模块：2.3 数列极限
