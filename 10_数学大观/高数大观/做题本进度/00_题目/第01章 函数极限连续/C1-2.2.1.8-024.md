...
> (cid:19)(cid:21) 1 1 − n2 设函数f(x)具有二阶导数，且在点(0,0)处的曲率圆为
> (x+1)2+(y+2)2 =5，则 lim f +f = n n n→∞
>
> 题源：900 数二第二章 B 类 32（重点）　|　题源类型：900　|　页码：p.38　|　模块：2.2 极限计算
