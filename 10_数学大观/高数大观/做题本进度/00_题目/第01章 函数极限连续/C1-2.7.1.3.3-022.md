...
> Z 1 x2 x et2x x→0+ dt− Axk 已知当 时 与 是等价无穷小，则 g(x)= 1+ +
>  3 10 0 1 1 1 1 =3,A=− =2,A=− A. k =3,A= B. k C. k =2,
> A= D. k 42 42 42 42
>
> 题源：26 版 660 数一二三第 195 题　|　题源类型：660　|　页码：p.102　|　模块：2.7 无穷小阶数
