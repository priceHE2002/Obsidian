...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.6-001"
源题号: "2.2.2.2.1.6-001"
序: 87
题源: "900 数二第一章 B 类 28（选做）"
题源大类: "900"
重点: false
页码: 59
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.6-001 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 2 lim arctan +arctan 1+0+02 1+2+12 n→∞ ▶2.2.2.2.1.7 等比
> 数列求和
>
> 题源：900 数二第一章 B 类 28（选做）　|　题源类型：900　|　页码：p.59　|　模块：2.2 极限计算
