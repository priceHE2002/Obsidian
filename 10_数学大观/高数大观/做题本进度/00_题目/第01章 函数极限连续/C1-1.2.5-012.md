...
> Z x (−∞,+∞) sin(x−t)f(t)dt，则 设 是以 为周期的偶函数，且 在 内连续，令 f(
> x) 2π f(x) F(x)= F(x) 0 一定为（）. 偶函数 奇函数 A. B. ·第 页，共 页·
>  9 402
>
> 题源：26 版 1000 第八章强化 6　|　题源类型：1000　|　页码：p.20　|　模块：1.2 函数性质考察
