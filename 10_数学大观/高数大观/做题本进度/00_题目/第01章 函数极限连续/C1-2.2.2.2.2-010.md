...
> 【17】求下列极限： (1+x)(1+x2)(1+x4)···(1+x2n |x|<1 （I）当 时，求 l
> im n→∞ x |x|̸=0 （II）当 时，求 lim cos 2 n→∞√ √ (1− sinx)(1
> − 3sinx)···(1− （III）lim (1−sinx)n−1 x→π 2
>
> 题源：880 第一章综合解答 17　|　题源类型：880　|　页码：p.61　|　模块：2.2 极限计算
