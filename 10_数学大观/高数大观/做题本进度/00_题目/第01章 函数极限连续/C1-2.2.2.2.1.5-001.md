...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.5-001"
源题号: "2.2.2.2.1.5-001"
序: 86
题源: "880 第三章综合选择 12（选做）"
题源大类: "880"
重点: false
页码: 59
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.5-001 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> =θ(0⩽θ ⩽2π) 【12】设螺线 与极轴所围区域的面积为 r Xn Xn 4π3i2 A. lim B
> . lim n3 n→∞ n→∞ i=1 i=1 ▶2.2.2.2.1.6 差分法
>
> 题源：880 第三章综合选择 12（选做）　|　题源类型：880　|　页码：p.59　|　模块：2.2 极限计算
