...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.1-005"
源题号: "2.2.2.2.1.1-005"
序: 200
题源: "26 版 1000 第二章基础 3"
题源大类: "1000"
重点: false
页码: 53
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.1-005 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> Xn k 1 {a } 设 非负有界，b ，则 = lim . = n n +n2 a n→∞b n n k
> =1 ▶2.2.2.2.1.2 定积分定义求 项和极限 n ▶2.2.2.2.1.2.1 到 1，n 等分，
> 取端点 0
>
> 题源：26 版 1000 第二章基础 3　|　题源类型：1000　|　页码：p.53　|　模块：2.2 极限计算
