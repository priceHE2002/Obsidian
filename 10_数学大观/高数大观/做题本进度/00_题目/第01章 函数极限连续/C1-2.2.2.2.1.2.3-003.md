...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.3-003"
源题号: "2.2.2.2.1.2.3-003"
序: 148
题源: "900 第三章数二 A 类 3"
题源大类: "900"
重点: false
...
备注:
---
# 2.2.2.2.1.2.3-003 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设函数 在区间 上连续，则 f(x) [0,a] (a>0) Xn 2ka−a a A. lim f n→∞
> 2n 2n k=1 Xn 4ka−a a C. lim f n→∞4n 4n k=1 ▶2.2.2.2.1.
> 2.4 到 1，n 等分，任意取点 0
>
> 题源：900 第三章数二 A 类 3　|　题源类型：900　|　页码：p.56　|　模块：2.2 极限计算
