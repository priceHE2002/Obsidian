...
源题号: "2.7.1.2.1-009"
序: 732
题源: "26 版 660 数三第 629 题; 26 版 660 数二第 569 题"
题源大类: "660"
重点: false
页码: 93
状态: "未开始"
...
> x→0 x3 当 时，下述一些无穷小与 为同阶无穷小的是 1−cosx α(x)=x3+x2 A. B. β
> (x)= x Z ln(1+x) (et2 −1)dt δ(x)=(1+sinx)ln(1+x)−1 C. 
> γ(x)= D. 0
>
> 题源：26 版 660 数三第 629 题; 26 版 660 数二第 569 题　|　题源类型：660　|　页码：p.93　|　模块：2.7 无穷小阶数
