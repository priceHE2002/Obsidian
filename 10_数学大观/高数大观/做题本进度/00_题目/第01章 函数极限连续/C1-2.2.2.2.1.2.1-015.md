...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.1-015"
源题号: "2.2.2.2.1.2.1-015"
序: 345
题源: "900 第三章数二 B 类 41（重点）"
题源大类: "900"
重点: true
页码: 55
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.1-015 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> (cid:17)(cid:18) (cid:16)√ √ √ 1 1 1 1 √ √ √ 42+···+ +
> ···+ 41+ 求 (I) lim 4n + ; n→∞n(cid:18)2 4n 4 (cid:19)4
>  1 2 (cid:17)(cid:18) √ √ √ 1 2 n 1 1 1 √ √ √ +···+ 42
> +···+ +···+ 41+ 求 (II) lim + 4n + . n4+1 n4+2 n4+n 4n 
> n→∞ 41 42
>
> 题源：900 第三章数二 B 类 41（重点）　|　题源类型：900　|　页码：p.55　|　模块：2.2 极限计算
