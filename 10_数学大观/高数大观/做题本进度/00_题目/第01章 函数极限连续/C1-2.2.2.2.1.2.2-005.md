...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.2-005"
源题号: "2.2.2.2.1.2.2-005"
序: 202
题源: "24 版 1000 第八章 B 组 7"
题源大类: "1000"
重点: false
页码: 56
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.2-005 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 1 2 3n +···+ lim + n→∞n n+1 n+2 4n ▶2.2.2.2.1.2.3 到 
> 1，非 等分，任意取点 0 n
>
> 题源：24 版 1000 第八章 B 组 7　|　题源类型：1000　|　页码：p.56　|　模块：2.2 极限计算
