...
> ( |x|⩽1, 1, f{f[f(x)]}= f[f(x)]= 设 则 f(x)= |x|>1, 0, 1
> 19 f(−x)= 则 ( ( −x2−x, x⩽0, x2−x, x2, x<0, x<0, C. D. 
> −x2, x⩾0. x2−x, x⩾0. x2, x>0. ( x2, x<0, 则 f(x)= g[f(x
> )]=( ) −x, x⩾0, ( 2−x2, x<0, B. x⩾0. 2+x, ( 2+x2, x<0 
> D. , x⩾0 2+x, ·第 页，共 页· 1 402
>
> 题源：2001 数二; 880 第一章基础填空 1　|　题源类型：真题　|　页码：p.12　|　模块：1.1 求函数表达式
