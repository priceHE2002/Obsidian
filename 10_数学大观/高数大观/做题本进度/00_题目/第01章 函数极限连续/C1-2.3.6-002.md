...
> 1 1 1 成立； 证明对任意的正整数 n，都有 <ln 1+ < (I) n+1 n n 1 1 +···
> + −lnn (n=1,2,···)，证明数列 {a } 设 收敛。 (II) a =1+ n n 2 n
>
> 题源：2011 数一二; 880 综合解答 15　|　题源类型：真题　|　页码：p.72　|　模块：2.3 数列极限
