...
> n 1 c n→∞ 时，e− 当 与 为等价无穷小，则（）. 1+ nk n e e A. c= ,k =2
>  B. c= ,k =2 3 2 e e C. c= ,k =1 D. c= ,k =1 3 2
>
> 题源：26 版 1000 第一章强化 23　|　题源类型：1000　|　页码：p.100　|　模块：2.7 无穷小阶数
