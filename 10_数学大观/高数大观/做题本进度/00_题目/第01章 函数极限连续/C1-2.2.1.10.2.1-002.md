...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.1.10.2.1-002"
源题号: "2.2.1.10.2.1-002"
序: 106
题源: "姜晓千真题同源 150（重点）"
题源大类: "真题同源"
重点: true
...
备注:
---
# 2.2.1.10.2.1-002 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 【例 3.23】 设 为以 为周期的非负可积函数，且 (1) f(x) T (2)(上海市1991年竞赛题)
> 设f(x)=x−[x]，其中[x]表示不超过x的最大整数，求极限
>
> 题源：姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.44　|　模块：2.2 极限计算
