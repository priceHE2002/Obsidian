...
> ax2+bx+1−ex2−2x 已知 =2，则 I = lim x2 x→0 a=5,b=−2 a=−2,b
> =5 A. B. a=3,b=−3 C. a=2,b=0 D.
>
> 题源：26 版 660 数一二三第 131 题　|　题源类型：660　|　页码：p.75　|　模块：2.4 已知极限相关
