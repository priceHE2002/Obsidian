...
> 设 在点 的某邻域内有定义，且 在 间断，则在点 处必定间断的函数是 f(x) x f(x) x x 0 0
>  0 |f(x)| f2(x) A. f(x)sinx B. f(x)+sinx C. D.
>
> 题源：25 版 660 数一二三第 143 题　|　题源类型：660　|　页码：p.120　|　模块：3.3 间断点
