...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.1-006"
源题号: "2.2.2.2.1.2.1-006"
序: 223
题源: "26 版 660 数一二三第 180 题"
题源大类: "660"
重点: false
页码: 54
状态: "未开始"
...
备注:
---
# 2.2.2.2.1.2.1-006 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> n n 数列极限 lim + n2+12 n2+22 n→∞ π π A. B. 2 4
>
> 题源：26 版 660 数一二三第 180 题　|　题源类型：660　|　页码：p.54　|　模块：2.2 极限计算
