...
> 【14】设 <π，x 0<x =sinx 1 n+1 n 证明： 存在，并求值； (I) lim x n n
> →(cid:18)∞ 1 x x2 n+1 n。 求 (II) lim x n→∞ n
>
> 题源：2006 数一二; 880 第一章综合解答 14　|　题源类型：真题　|　页码：p.62　|　模块：2.2 极限计算
