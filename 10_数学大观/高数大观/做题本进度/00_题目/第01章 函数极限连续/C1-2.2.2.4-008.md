...
> (x)=1−(1−cosx)n (n=1,2,···). 【6】设 f n 1 π 证明：方程 在 内有且仅
> 有一个实根 ； (I) f (x)= 0, x n n 2 2 π 1 1 π π ∈ 设 ，满足 ，证明：
> arccos ，且 (II) x 0, f (x )= <x < lim x = . n n n n n 2
>  2 n 2 2 n→∞
>
> 题源：880 第一章综合解答 6　|　题源类型：880　|　页码：p.65　|　模块：2.2 极限计算
