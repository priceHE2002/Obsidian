...
> 1 1 =x2+ 设 ，则 li m f(x)= f x+ . 2 x x → x 3 (cid:17)i 
> h 1 f(1)=1，则 = lim ln 2+f xx x→+∞ ·第 页，共 页· 37 402
>
> 题源：26 版 660 数一二三第 3 题　|　题源类型：660　|　页码：p.48　|　模块：2.2 极限计算
