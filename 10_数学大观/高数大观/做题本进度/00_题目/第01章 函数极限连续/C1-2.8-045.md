...
> x ln(1−t) si nt 1− 设函数 ，则下列关于曲线 的渐近线的说法中，正确的是（ ） y(x)=
>  lim y =y(x) x2 t→0 ⃝ 该曲线无渐近线．⃝ 该曲线有铅直渐近线．⃝ 该曲线有水平渐近线．
> ⃝ 该曲线有斜渐近线． 1 2 3 4 ⃝ ⃝ ⃝ ⃝ ⃝ ⃝ A. B. C. D. 2 3 2 3 2 
> 4
>
> 题源：900 第二章数二 A 类 24　|　题源类型：900　|　页码：p.108　|　模块：2.8 渐近线
