...
> p (n+1)(n+2)···(n+n) n n 2 lim = 1+ = n n→∞ n 1 x2 <ln
> (1+x)<x； 2 2 n ··· 1+ . n2 n2 1 （n 为正整数）； 2n(cid:19)2 
> 2 n ··· 1+ . n2 n2 1 时，x− x3 <sinx<x； 6 i n2 ·第 页，共 页·
>  49 402
>
> 题源：24 版 1000 第八章 B 组 6　|　题源类型：1000　|　页码：p.60　|　模块：2.2 极限计算
