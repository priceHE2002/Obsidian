...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.5-001"
源题号: "2.2.2.2.1.2.5-001"
序: 83
题源: "江苏省 1996 年竞赛题（重点）"
题源大类: "其他"
重点: true
...
备注:
---
# 2.2.2.2.1.2.5-001 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 【例 2.4】（江苏省 年竞赛题）设 1996 8 >>>>>><n 1 l im ∞"n → f(x)= 
> l im 1+ >>>>>>: → ∞ n f(−x), 讨论 在 处的可导性； (I) f(x) x=0 
> [−π,π] 求 在 上的最大值。 (II) f(x)
>
> 题源：江苏省 1996 年竞赛题（重点）　|　题源类型：其他　|　页码：p.57　|　模块：2.2 极限计算
