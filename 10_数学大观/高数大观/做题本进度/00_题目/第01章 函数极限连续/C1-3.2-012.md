...
> 8 >><2+ax2, ( x⩽−1, −1, x<0, −1<x<0, 设函数 若 在 上连续，则（ ） 
> x2, f(x)= g(x)= f(x)+g(x) R >>: x⩾0, 1, x2−b, x⩾0, a=−
> 1,b=1 a=−1,b=2 A. a=1,b=1 B. a=1,b=2 C. D.
>
> 题源：900 数二第一章 A 类 26　|　题源类型：900　|　页码：p.113　|　模块：3.2 已知连续确定参数
