...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.4-001"
源题号: "2.2.2.2.1.2.4-001"
序: 82
题源: "姜晓千真题同源 150（重点）"
题源大类: "真题同源"
重点: true
...
备注:
---
# 2.2.2.2.1.2.4-001 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> Xn (2i−1)π 1 (1) lim cos ; 4n n n→∞ i=1 Xn (3i−1)π 1 (
> 2) lim cos . 6n n n→∞ i=1
>
> 题源：姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.56　|　模块：2.2 极限计算
