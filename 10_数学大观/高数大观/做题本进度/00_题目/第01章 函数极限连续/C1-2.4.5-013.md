...
> h i f(x+2)+ex2 ln 设函数 在 的某邻域内连续，且有 =4，则 是 的（ ）。 f(x) x
> =2 lim x=2 f(x) 1−cosx x→0 不可导点 驻点且是极大值点 A. B. 驻点且是极小值
> 点 可导点但不是驻点 C. D.
>
> 题源：26 版 1000 第五章强化 38　|　题源类型：1000　|　页码：p.83　|　模块：2.4 已知极限相关
