...
> x2n−1 函数 的间断点及类型是 f(x)= lim n→∞x2n+1 为第一类间断点，x=−1 x=±1
>  为第二类间断点 均为第一类间断点 A. x=1 B. 为第二类间断点，x=−1 x=±1 为第一类间断点 
> 均为第二类间断点 C. x=1 D.
>
> 题源：26 版 660 数二第 521 题　|　题源类型：660　|　页码：p.89　|　模块：2.5 以极限形式给出的函数
