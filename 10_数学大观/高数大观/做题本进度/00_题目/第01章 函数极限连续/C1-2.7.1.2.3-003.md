...
> √ √ √ √ x−1)，α 3x+1−1。当 x→0+ （1）设 3x)，α 时，以上 个无穷小量按照 α
>  =x(cos = xln(1+ = 3 1 2 3 从低阶到高阶的排序是（ ） A. α ,α ,α B.
>  α ,α ,α C. α ,α ,α D. α ,α ,α 1 2 3 2 3 1 2 1 3 3 2 1
>
> 题源：2016 数二　|　题源类型：真题　|　页码：p.95　|　模块：2.7 无穷小阶数
