...
> f(0)=0，f′(0)=0，f′′(x)>0。 【例 2.11】(全国大学生 年竞赛题) 设 二阶可导，且
>  2012 f(x) x3f(u) 若曲线 在点 处的切线在 轴上的截距为 u，求极限 y =f(x) P(
> x,f(x)) x lim x→0f(x)sin3u
>
> 题源：全国大学生 2012 年竞赛题（重点）　|　题源类型：其他　|　页码：p.38　|　模块：2.2 极限计算
