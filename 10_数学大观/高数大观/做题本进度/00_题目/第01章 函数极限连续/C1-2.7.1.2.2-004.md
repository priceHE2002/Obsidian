...
> x→0 当 时下列无穷小中阶数最高的是 (1+x)x2 ex4−2x−1 −1 A. B. Z x2 √ √
>  1+2x− sint2dt 31+3x C. D. 0 ▶2.7.1.2.3 三者排序
>
> 题源：26 版 660 数一二三第 176 题　|　题源类型：660　|　页码：p.95　|　模块：2.7 无穷小阶数
