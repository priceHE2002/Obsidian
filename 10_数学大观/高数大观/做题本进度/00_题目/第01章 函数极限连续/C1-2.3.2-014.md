...
> {a },{b } =∞， =∞，则下列结论中，正确的是（ 设数列 满足 ） lim a lim b n n
>  n n n→∞ n→∞ a n =∞ )=∞ =∞ ean A. lim B. lim (a +b C. 
> lim =1 D. lim a b n n n n b n→∞ n→∞ n→∞ n→∞ n
>
> 题源：900 数二第一章 A 类 9　|　题源类型：900　|　页码：p.70　|　模块：2.3 数列极限
