...
模块: "2.2"
模块名: "极限计算"
题号: "C1-2.2.2.2.1.2.1-012"
源题号: "2.2.2.2.1.2.1-012"
序: 315
题源: "900 第三章数二 A 类 37"
题源大类: "900"
重点: false
...
备注:
---
# 2.2.2.2.1.2.1-012 · 极限计算

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 1 2 +···+narcsin arcsin lim +2arcsin n→∞n2 n n
>
> 题源：900 第三章数二 A 类 37　|　题源类型：900　|　页码：p.54　|　模块：2.2 极限计算
