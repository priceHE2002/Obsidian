...
> ln(1−x)+f(x)sinx f′(0)= =0，则 设函数 在 处有定义，且 f(0)=1，lim f
> (x) x=0 −1 ex2 x→0 1 1 − −2 A. B. C. 2 D. 2 2 ·第 页，共 页
> · 69 402
>
> 题源：26 版 660 数一二三第 167 题　|　题源类型：660　|　页码：p.80　|　模块：2.4 已知极限相关
