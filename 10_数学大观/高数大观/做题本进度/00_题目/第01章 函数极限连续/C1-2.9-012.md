...
> π π π π 2 3 x− x− x− 设函数f(x)=cot2x在x= 处的3次泰勒多项式为a+b ，则
> ac+bd= +d +c 4 4 4 4 （ ） 8 8 16 16 − − A. B. C. D. 3 3
>  3 3 连续 3 判断或讨论连续性
>
> 题源：900 第二章数二 A 类 36（选做）　|　题源类型：900　|　页码：p.110　|　模块：2.9 泰勒多项式
