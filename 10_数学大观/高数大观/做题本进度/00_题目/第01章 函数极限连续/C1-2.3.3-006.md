...
> 下列数列中，无界的是（ ） x n +1)e−x2 −2x =(3x2 为任意实数，x 为任意实数，x A.
>  x = B. x n 1 n+1 1 n+1 n n x2 1+ n 1 为任意正实数，x 为任意大于 的
> 实数，x x +1 D. x =x (x +1) C. x 2 = n 1 n+1 n n 1 n+1 2
>
> 题源：900 数二第一章 B 类 5　|　题源类型：900　|　页码：p.71　|　模块：2.3 数列极限
