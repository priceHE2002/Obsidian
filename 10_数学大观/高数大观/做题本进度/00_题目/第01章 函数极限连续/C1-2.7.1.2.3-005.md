...
> Z Z x4 x2 √ √ 1 √ 1+tanx− x→0 sint2dt。当 设 1+sinx，α dt，
> α 时，以上三个无穷小 α = = = 1 2 3 1−t2 0 0 量按照从低阶到高阶的排序是（） A. 
> α ,α ,α B. α ,α ,α C. α ,α ,α D. α ,α ,α 1 2 3 1 3 2 2
>  1 3 3 1 2
>
> 题源：900 数二第一章 A 类 12　|　题源类型：900　|　页码：p.96　|　模块：2.7 无穷小阶数
