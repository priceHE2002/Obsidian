...
> [!note]- 题干预览（自动提取，仅供参考）
> 5+f(x) 已知 lim x→0 sin5x+xf(x) A. lim x3 x→0 sin5x+xf(x) B. lim x3 x→0 sin5x+xf(x) C. lim x3 x→0 sin5x+xf(x) D. lim x3 x→0 5x−sin5x a− lim x→0
>
> 题源：26 版 660 数一二三第 133 题　|　页码：p.46　|　模块：2.2 极限计算
