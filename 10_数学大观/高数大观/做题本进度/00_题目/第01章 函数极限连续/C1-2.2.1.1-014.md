...
> √ √ 3−x− 1+x lim = x2+x−2 x→1 y′′ +py′ y′(0) e3x 满足初始条
> 件 的特解，则当 +qy = y(0) = = 0 ）． 等于 等于 C. 2 1 D. 3 y(0)=y′
> (0)=0，则当 x→0 =e3x 的解，且满足 时，与 为等价 y(x) √ ln(1+x2) 1+x2 
> C. D. ln ·第 页，共 页· 11 402
>
> 题源：2001 数二　|　题源类型：真题　|　页码：p.22　|　模块：2.2 极限计算
