...
> ( lnx−x, x⩾1 设函数 ，则 f(x)= x2−2x, x<1 是 的极小值点. 是 的极大值点.
>  A. x=1 f(x) B. x=1 f(x) 是 拐点. 不是 拐点. C. (1,f(1)) y =f
> (x) D. (1,f(1)) y =f(x) ▶3.4.3.5 高次幂乘积拐点
>
> 题源：26 版 660 数二第 539 题　|　题源类型：660　|　页码：p.186　|　模块：3.4 极最拐
