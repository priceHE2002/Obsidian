...
> 1+|ln(1+x)| 设 具有一阶连续导数，f(x)=φ(x) ，则 是 在 处可导的（ ）。 φ(x) 
> φ(0)=0 f(x) x=0 充分必要条件 充分非必要条件 A. B. 必要非充分条件 既非充分又非必要条
> 件 C. D.
>
> 题源：26 版 1000 第三章基础 11　|　题源类型：1000　|　页码：p.132　|　模块：1.4 某点的可导问题
