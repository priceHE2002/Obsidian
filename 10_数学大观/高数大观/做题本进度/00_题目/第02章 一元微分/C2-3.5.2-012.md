...
> π xcos2α α∈ =k+xcos2α 设对于任意 ，方程 有两个不同的实根，则 的取值范围是（） 0,
>  (x>0) k 2 [0,sin2α) (0,sin2α) [0,cos2α) (0,cos2α) A. 
> B. C. D. ·第 页，共 页· 181 402
>
> 题源：900 第二章数二 A 类 35　|　题源类型：900　|　页码：p.192　|　模块：3.5 3.5
