...
> f′′(x) (−∞,+∞) 设函数 在 内连续，其 阶导函数 的图形如右图所示，则曲线 的拐点个 (2) 
> f(x) 2 y =f(x) 数为（ ） A. 0 B. 1 C. 2 D. 3
>
> 题源：2015 数一二三; 880 第二章基础填空 5　|　题源类型：真题　|　页码：p.183　|　模块：3.4 极最拐
