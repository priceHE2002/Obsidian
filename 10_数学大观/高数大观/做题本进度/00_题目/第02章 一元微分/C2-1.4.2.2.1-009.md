...
备注:
---
# 1.4.2.2.1-009 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 <ex−1 x̸=0, , x 函数 在 处 (2) f(x)= x=0 ( ). : 1, x=0 连
> 续且取极大值 连续且取极小值 A. B. 可导且导数为零 可导且导数不为零 C. D. ·第 页，共 页· 
> 124 402
>
> 题源：2021 数一二三　|　题源类型：真题　|　页码：p.135　|　模块：1.4 某点的可导问题
