...
> √ B √ ⩽lnx⩽A x，x∈(0,+∞) 设常数 使得不等式 恒成立，则 A,B x 1 1 2 2 
> − − 的最小值为 ，B 的最大值为 的最小值为 ，B 的最大值为 A. A B. A e e e e −1
>  −2 的最小值为 1，B 的最大值为 的最小值为 2，B 的最大值为 C. A D. A 证明具体不等式
>
> 题源：26 版 660 数二第 559 题　|　题源类型：660　|　页码：p.199　|　模块：3.6 不等式
