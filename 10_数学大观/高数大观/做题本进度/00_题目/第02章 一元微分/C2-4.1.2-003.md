...
> f(x)+f′(x) [0,+∞) <···<x [0,+∞) 设 在 上可导且有 个不同的零点：0<x ，
> 则 在 上正 f(x) n <x 1 2 n 确的性质是 n−1 至少有 个零点 至少有 个零点 A. n 
> B. 恰有 个零点 至多有 个零点 C. n D. n
>
> 题源：26 版 660 数二第 565 题　|　题源类型：660　|　页码：p.206　|　模块：4.1 小题
