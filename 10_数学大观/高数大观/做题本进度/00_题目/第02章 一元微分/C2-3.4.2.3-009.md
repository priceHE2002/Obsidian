...
> f′(x) =f′(x) 【19】设 在 上连续，曲线 与 x=0，y =0，x=4 围成如图 所示的三个区
> 域，其面 [0,4] y 2-2 积 ，S ，S 满足 ，则下列选项中正确的是（ ）。 S S >S >S 
> 1 2 3 2 1 3 A. f(1)>f(3)>f(4) B. f(4)>f(3)>f(1) C. f(3
> )>f(4)>f(1) D. f(4)>f(1)>f(3) ·第 页，共 页· 170 402
>
> 题源：880 第二章综合选择 19　|　题源类型：880　|　页码：p.181　|　模块：3.4 极最拐
