...
> (−∞,+∞) 设函数 在 内连续，其导函数的图形如图所示，则（） (1) f(x) 函数 有 个极值点，曲
> 线 有 个拐点。 A. f(x) 2 y =f(x) 2 函数 有 个极值点，曲线 有 个拐点。 B. f(
> x) 2 y =f(x) 3 函数 有 个极值点，曲线 有 个拐点。 C. f(x) 3 y =f(x) 1
>  函数 有 个极值点，曲线 有 个拐点。 D. f(x) 3 y =f(x) 2
>
> 题源：2016 数二三　|　题源类型：真题　|　页码：p.183　|　模块：3.4 极最拐
