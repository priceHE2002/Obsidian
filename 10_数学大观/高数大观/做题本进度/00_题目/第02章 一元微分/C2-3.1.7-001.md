...
> y′′ 如图，设曲线 的方程 f(x)，且 0，又 分别为该曲线在点 处的切线和法线。 L y = > MT
> ,MP M(x ,y ) 0 0 ′2)3 (1+y 2 y′ =y′(x ),y′′ =y′′(x 0 已
> 知线段 的长度为 （其中 )），试推导出点 的坐标表达式。 P(ξ,η) MP 0 0 y′′ 0 0 0 
> ·第 页，共 页· 149 402
>
> 题源：1995 数二　|　题源类型：真题　|　页码：p.160　|　模块：3.1 切法线
