...
源题号: "1.4.2.2.2-002"
序: 980
题源: "2020 数二; 26 版 660 数一二三第 52 题"
题源大类: "真题"
重点: false
页码: 138
状态: "未开始"
...
备注:
---
# 1.4.2.2.2-002 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z 1 f(x) g′(x) g′(x) 已知函数 连续且 =1，g(x)= f(xt)dt，求 并证明 在
>  处连续。 f(x) lim x=0 x x→0 0
>
> 题源：2020 数二; 26 版 660 数一二三第 52 题　|　题源类型：真题　|　页码：p.138　|　模块：1.4 某点的可导问题
