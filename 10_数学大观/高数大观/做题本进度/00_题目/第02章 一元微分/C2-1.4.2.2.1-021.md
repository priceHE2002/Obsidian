...
备注:
---
# 1.4.2.2.1-021 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> ( 1 |x|<1 ex2 −1, 设 可导，则 f(x)= (b,c)= x4−bx2+c, |x|⩾1 
> 1 1 ,− A. (2,1) B. (1,0) C. D. (3,2) 2 2
>
> 题源：25 版 660 数一二三第 147 题　|　题源类型：660　|　页码：p.137　|　模块：1.4 某点的可导问题
