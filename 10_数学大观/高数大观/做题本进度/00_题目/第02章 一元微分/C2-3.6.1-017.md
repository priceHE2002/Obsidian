...
> 设函数 在 上二阶可导，且 f(0)+f(2)=0，则（ ） f(x) [0,2] Z Z 2 2 f′′(
> x)>0，则 f′′(x)>0，则 若 若 A. f(x)dx>0 B. f(x)dx<0 Z0 Z0 2 
> 2 f′(x)>0，则 f′(x)>0，则 若 若 C. f(x)dx>0 D. f(x)dx<0 0 0
>
> 题源：900 第二章数二 B 类 13　|　题源类型：900　|　页码：p.197　|　模块：3.6 不等式
