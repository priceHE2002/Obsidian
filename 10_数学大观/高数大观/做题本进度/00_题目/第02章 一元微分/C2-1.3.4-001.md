...
> 设 处处可导，则 (3) f(x) ( ) ′ f(x)=−∞ (x)=−∞ 当 时，必有 当 时，必有 A
> . lim B. lim f x→−∞ x→−∞ ′ (x)=−∞。 f(x)=−∞。 lim f lim 
> x→−∞ x→−∞ ′ f(x)=+∞ (x)=+∞ 当 时，必有 当 时，必有 C. lim D. lim
>  f x→+∞ x→+∞ ′ (x)=+∞。 f(x)=+∞。 lim f lim x→+∞ x→+∞
>
> 题源：1996 数二; 880 第二章综合选择 13　|　题源类型：真题　|　页码：p.128　|　模块：1.3 极限与导数
