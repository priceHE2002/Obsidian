...
> f(1)−f(1−x) −1，则曲线 设 为可导函数，且满足条件 在点 处的切线 (1) f(x) lim 
> = y = f(x) (1,f(1)) 2x x→0 斜率为（ ） 1 −1 −2 A. 2 B. C. D
> . 2
>
> 题源：1995 数三; 880 第二章基础填空 16　|　题源类型：真题　|　页码：p.123　|　模块：1.3 极限与导数
