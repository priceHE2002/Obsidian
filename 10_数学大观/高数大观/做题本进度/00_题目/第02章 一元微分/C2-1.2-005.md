...
> ∆f(1)−df(1) 设函数 在 处可导，且 是 在增量为 时的函数值增量，则 f(x) x=1 ∆f(1
> ) f(x) ∆x lim = ∆x ∆x→0 f′(1) ∞ A. B. 1 C. D. 0
>
> 题源：26 版 1000 第三章基础 9　|　题源类型：1000　|　页码：p.122　|　模块：1.2 微分概念
