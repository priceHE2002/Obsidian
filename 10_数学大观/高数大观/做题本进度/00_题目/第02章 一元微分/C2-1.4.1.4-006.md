...
> f(x)=|x3−1|φ(x)，其中 设函数 在 点处连续，则 是 在 点处可导的 φ(x) x=1 φ(1
> )=0 f(x) x=1 充分必要条件 必要但非充分条件 A. B. 充分但非必要条件 既非充分条件也非必要
> 条件 C. D.
>
> 题源：26 版 660 数二第 528 题　|　题源类型：660　|　页码：p.133　|　模块：1.4 某点的可导问题
