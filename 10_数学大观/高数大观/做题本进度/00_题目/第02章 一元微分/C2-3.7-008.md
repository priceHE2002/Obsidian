...
> 如图所示，在距离海岸边点 的点 处有一灯塔，灯塔上的探照灯光以每秒 弧度（rad）的速率匀 A 180m P
>  r 速转动，探照光线与 的所成夹角为 θ。若灯光经过岸边距离点 处的点 时，速率为 30m/s，则 PA 
> A 60m B r = ·第 页，共 页· 192 402
>
> 题源：900 第二章数二 A 类 60　|　题源类型：900　|　页码：p.203　|　模块：3.7 物理应用
