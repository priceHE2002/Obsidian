...
> f(a)=f(b)，f′(x) 连续，f′ (a)<0，则 设 在 上连续，在 二阶可导，又 在 f(x) 
> [a,b] (a,b) [a,b) + ∈(a,b)，f′′(ξ)<0 ∈(a,b)，f′′(ξ)=0 ∃ξ
>  ∃ξ A. B. ∈(a,b)，f′′(ξ)>0 ∃ξ ∀x∈(a,b)，f(x)>f(a) C. D.
>
> 题源：26 版 660 数二第 564 题　|　题源类型：660　|　页码：p.206　|　模块：4.1 小题
