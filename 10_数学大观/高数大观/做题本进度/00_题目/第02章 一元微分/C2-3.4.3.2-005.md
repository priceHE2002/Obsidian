...
源题号: "3.4.3.2-005"
序: 1383
题源: "880 第二章基础选择 13; 26 版 660 数二第 554 题"
题源大类: "880"
重点: false
页码: 184
状态: "未开始"
...
> f′(x )=f′′(x )=0，f′′′(x 【13】设 )>0，则下列选项正确的是（ ）. 0 0 0 
> 是 的极值点 是 的极大值 A. x f(x) B. f(x ) f(x) 0 0 是 的极小值 是 的拐点
>  C. f(x ) f(x) D. (x ,f(x )) y =f(x) 0 0 0
>
> 题源：880 第二章基础选择 13; 26 版 660 数二第 554 题　|　题源类型：880　|　页码：p.184　|　模块：3.4 极最拐
