...
> 3 b ln|x|+ −bx2 已知函数 有 个不同的零点，则 的取值范围是（ ）。 f(x)=a 4 2 
> a e e ,+∞ A. 0, B. 2 (cid:18)2 e2 e2 ,+∞ C. 0, D. 2 2
>
> 题源：26 版 1000 第六章强化 1　|　题源类型：1000　|　页码：p.193　|　模块：3.5 3.5
