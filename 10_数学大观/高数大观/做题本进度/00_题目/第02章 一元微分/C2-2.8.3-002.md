...
> 1−2x f′′′(0)= 设 ，则 f(x)=ln 1+3x f(100)(0)= ). 1 1 (n−1
> )! B. + (1−x)n (1+x)n (−1)n−1 1 (n−1)! D. + (1−x)n (1+
> x)n 时，f(n)(0)= n⩾3 f(n)(0)= 当 时, ( ) (n−2)! (n−2)! n! 
> − C. D. n n x2 n⩾3，则 f(n)(x)= =0，且 f(1)=ln2。若 1+x f(n)
> (0)= 阶导数 n xn 项的系数是 f(5)(1)= ·第 页，共 页· 142 402
>
> 题源：26 版 660 数一二三第 26 题　|　题源类型：660　|　页码：p.153　|　模块：2.8 高阶导
