...
源题号: "1.4.2.2.2-007"
序: 1009
题源: "26 版 660 数二第 544 题; 880 第二章综合解答 5"
题源大类: "660"
重点: false
页码: 139
状态: "未开始"
...
备注:
---
# 1.4.2.2.2-007 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 1 < |x|asin x̸=0, , x 设 若 f(x)= : 0, x=0, 为连续函数； (I)
> f(x) 为可导函数； ()f(x) 为连续可导函数， (III)f(x) 则参数 必须分别满足 a (I)
> a>0；(II)a>1；(III)a>2 (I)a>1；(II)a>2；()a>3 A. B. (I)a>0
> ；(II)a⩾1；(III)a⩾2 (I)a>0；(II)a⩾2；(III)a⩾3 C. D.
>
> 题源：26 版 660 数二第 544 题; 880 第二章综合解答 5　|　题源类型：660　|　页码：p.139　|　模块：1.4 某点的可导问题
