...
> (x2−1)(x+3) f′(x)= √ 【21】设 ，则 f(x)（ ）。 1+x2 x=1，x=−3 x
> =−1 在 处取得极大值，在 处取得极小值 A. x=−1 x=1，x=−3 在 处取得极大值，在 处取得极
> 小值 B. x=−1，x=1，x=−3 在 处都取得极小值 C. x=−1，x=−3，x=1 在 处都取得极
> 大值 D.
>
> 题源：880 第二章基础选择 21　|　题源类型：880　|　页码：p.175　|　模块：3.4 极最拐
