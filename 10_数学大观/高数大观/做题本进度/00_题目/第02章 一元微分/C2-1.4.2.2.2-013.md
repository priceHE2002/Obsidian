...
备注:
---
# 1.4.2.2.2-013 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 1 >>><xαln , x>0, x f′(x) 设函数 若 在 处连续，则（） f(x)= x=0 
> 0 , x=0, >>>: − 1 e x2, x<0. A. 0<α<1 B. α>1 C. 0<α<2 
> D. α>2
>
> 题源：900 第二章数二 A 类 28　|　题源类型：900　|　页码：p.140　|　模块：1.4 某点的可导问题
