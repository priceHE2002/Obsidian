...
> f′(x) (−∞,+∞) 设函数 在 上连续，其导函数 的图形如右图所示，则下列说法中，正确的是（ ） f
> (x) 函数 有 个极值点，曲线 有 个拐点 A. f(x) 1 y =f(x) 1 函数 有 个极值点，曲
> 线 有 个拐点 B. f(x) 2 y =f(x) 2 函数 有 个极值点，曲线 有 个拐点 C. f(x)
>  3 y =f(x) 2 函数 有 个极值点，曲线 有 个拐点 D. f(x) 3 y =f(x) 1 ·第
>  页，共 页· 172 402
>
> 题源：900 第二章数二 A 类 17　|　题源类型：900　|　页码：p.183　|　模块：3.4 极最拐
