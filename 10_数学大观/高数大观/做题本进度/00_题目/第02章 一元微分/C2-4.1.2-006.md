...
> f(a)=f(b)，f′′(x)̸=0 (x∈(a,b))，则下列结论成立的是 设 在 上连续，在 二阶可导
> ，又 f(x) [a,b] (a,b) f′(x)̸=0 ∈(a,b)，f′(ξ )=f′(ξ 在 内 存在
>  A. (a,b) B. ξ ,ξ )=0 1 2 1 2 ∈(a,b)，f′(ξ)=0 ∈(a,b)，f(
> ξ)=0 存在唯一 至少存在一点 C. ξ D. ξ ·第 页，共 页· 195 402
>
> 题源：26 版 660 数二第 568 题　|　题源类型：660　|　页码：p.206　|　模块：4.1 小题
