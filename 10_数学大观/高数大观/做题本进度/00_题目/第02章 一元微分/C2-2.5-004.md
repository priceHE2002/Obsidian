...
> ( d2y x=tcost, 设 ，求 dx2 y =tsint dy f′(0)̸=0，则 可导，且 f 
> = dx t=0 r d2y dy π 求 在 的值。 , t= dx2 dx 2 ( x=t−ln(1+t
> ), d2y 所确定，则 = dx2 =t3+t2 y d2y f(u)̸=0，求 具有二阶导数，且 f(u
> ) dx2 dy 所确定，求 dx =5 8 ><x= 1+2t2, d2y Z 所确定，求 (t>1) 1
> +2lnt eu >:y dx2 = du x=9 u 1 ·第 页，共 页· 138 402
>
> 题源：1991 数二　|　题源类型：真题　|　页码：p.149　|　模块：2.5 参数方程求导
