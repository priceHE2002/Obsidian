...
> ( x=t2+2t, 设函数 由参数方程 确定，则曲线 在 处的法线与 轴交点的 (9) y = y(x) 
> y = y(x) x = 3 x y =ln(1+t) 横坐标是 ( ). 1 1 − −8ln2+3 A.
>  ln2+3 B. ln2+3 C. D. 8ln2+3 8 8 ·第 页，共 页· 147 402
>
> 题源：2005 数二　|　题源类型：真题　|　页码：p.158　|　模块：3.1 切法线
