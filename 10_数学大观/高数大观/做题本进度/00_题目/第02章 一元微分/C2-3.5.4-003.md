...
> (x(cid:16))=c(cid:17)osx+cos2x+···+cosnx(n=2,3,···). (
> 浙江大学,2002 年) 设 f n π 证明方程 在 内有 个实根 (I) f (x)=1 0, 1 x 
> ; n n 3 证明 存在, 并求此极限. (II) lim x n n→∞ 其他
>
> 题源：浙江大学 2002（重点）　|　题源类型：其他　|　页码：p.194　|　模块：3.5 3.5
