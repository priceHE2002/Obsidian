...
> (cid:0)√ 1+x2−x f(5)(0)= 设 ，则 f(x)=ln ； f(4)(0)= . x⩽0
> , f(n)(0) 若 存在，则 的最大值为 n 1 x3, x>0. 2 f(n)(0)。 Z x f(t
> )dt，则当n⩾2时，f(n)(0)= 0 Z x (x−t)f(t)dt，则对任意正整数n，f(2n)(0
> )= 0 Z x −f(t)dt，若 g(n)(0)(n 1)，则 = e g(x) = xf(x + > 
> 0 ·第 页，共 页· 144 402
>
> 题源：880 第二章基础填空 15　|　题源类型：880　|　页码：p.155　|　模块：2.8 高阶导
