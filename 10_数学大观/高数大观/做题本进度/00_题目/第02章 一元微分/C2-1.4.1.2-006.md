...
> 1 3 f(x)=(x2+x−2)|sin2πx| − 函数 在 区间上不可导点的个数是 , 2 2 A. 
> 3 B. 2 C. 1 D. 0 ▶1.4.1.3 求可导的最高阶数
>
> 题源：26 版 660 数二第 548 题（重点）　|　题源类型：660　|　页码：p.132　|　模块：1.4 某点的可导问题
