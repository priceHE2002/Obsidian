...
> [!note]- 题干预览（自动提取，仅供参考）
> 设函数 f(x) |f(x)|−f(0) ⃝ lim 1 x→0 f(x)−|f(0)| ⃝ lim 2 x→0 |f(x)| ⃝ lim 3 x→0 |f(x)|−|f(0)| ⃝ lim 4 x→0 其中可得到“f(x) A. 1 其他重要概念题 1.3.4
>
> 题源：2025 数二; 26 版 1000 第三章强化 24　|　页码：p.128　|　模块：1.3 极限与导数
