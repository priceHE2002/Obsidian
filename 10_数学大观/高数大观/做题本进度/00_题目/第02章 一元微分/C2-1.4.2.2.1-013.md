...
备注:
---
# 1.4.2.2.1-013 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 x + 1 >>>< arctan +a, x>1, − x 1 f′(1)=( 设函数 可导，则 f(
> x)= ) c, x=1, >>>: x+1 arctan +b, x<1 x−1 1 1 − A. B. 
> 2 2 与 的值有关 C. 1 D. a,b
>
> 题源：900 第二章数二 A 类 3　|　题源类型：900　|　页码：p.136　|　模块：1.4 某点的可导问题
