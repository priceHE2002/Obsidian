...
> 下列函数中，在 处不可导的是 (2) x=0 ( ) p f(x)=|x|sin|x| f(x)=|x|si
> n |x| A. B. p f(x)=cos|x| |x| C. D. f(x)=cos ·第 页，共 页·
>  122 402
>
> 题源：2018 数一二三; 880 第二章基础选择 7　|　题源类型：真题　|　页码：p.133　|　模块：1.4 某点的可导问题
