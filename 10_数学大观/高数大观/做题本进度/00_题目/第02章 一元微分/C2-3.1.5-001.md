...
源题号: "3.1.5-001"
序: 1192
题源: "2000 数二; 26 版 660 数二第 459 题; 880 第二章综合解答 3"
题源大类: "真题"
重点: false
页码: 160
状态: "未开始"
...
> 已知f(x)是周期为5的连续函数，它在x=0的某个领域内满足关系式f(1+sinx)−3f(1−sinx)=
> 8x+α(x)， x→0 其中 是当 时比 高阶的无穷小，且 在 处可导，求曲线 在点 处的 α(x) x 
> f(x) x=1 y =f(x) (6,f(6)) 切线方程。
>
> 题源：2000 数二; 26 版 660 数二第 459 题; 880 第二章综合解答 3　|　题源类型：真题　|　页码：p.160　|　模块：3.1 切法线
