...
> f′(x) =f′(x) 设 在区间 上连续，曲线 与直线 围成如图所示的三个区域，其面积 [0,4] y 
> x=0,x=4,y =0 分别为 =2，且 f(0)=1，则 在 上的最大值与最小值分别为（）. S =3,
> S =4,S f(x) [0,4] 1 2 3 2,−3 4,−3 2,−2 4,−2 A. B. C. D
> .
>
> 题源：26 版 1000 第五章强化 24（重点）　|　题源类型：1000　|　页码：p.181　|　模块：3.4 极最拐
