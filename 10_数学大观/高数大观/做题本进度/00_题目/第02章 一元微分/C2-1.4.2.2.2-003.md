...
源题号: "1.4.2.2.2-003"
序: 988
题源: "1996 数三; 25 版 660 数一二三第 148 题"
题源大类: "真题"
重点: false
页码: 138
状态: "未开始"
...
备注:
---
# 1.4.2.2.2-003 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 <g(x)−e−x x̸=0, , g(0)=1，g′(0)=−1。 设 其中 有二阶连续导数，且 f(
> x)= g(x) x : 0, x=0, f′(x)； 求 (1) f′(x) (−∞,+∞) 讨论 在 上
> 的连续性。 (2)
>
> 题源：1996 数三; 25 版 660 数一二三第 148 题　|　题源类型：真题　|　页码：p.138　|　模块：1.4 某点的可导问题
