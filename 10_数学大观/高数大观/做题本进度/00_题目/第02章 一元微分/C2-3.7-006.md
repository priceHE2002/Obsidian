...
> cm/s，−3 已知某圆柱体底面半径与高随时间变化的速率分别为 cm/s，且圆柱体的体积与表面积随时间变 2
>  −100π cm3/s，40π cm2/s，则圆柱体的底面半径与高分别为 化的速率分别为 ( ). cm，
> 5 cm，5 A. 5 cm B. 10 cm cm，10 cm，10 C. 5 cm D. 10 cm
>
> 题源：26 版 1000 第七章基础 4　|　题源类型：1000　|　页码：p.203　|　模块：3.7 物理应用
