...
> f(x2) 设 f(0)=0，则 存在是 在 可导的 lim f(x) x=0 x2 x→0 充分非必要条件
>  必要非充分条件 A. B. 充分必要条件 既非充分又非必要条件 C. D. ·第 页，共 页· 118 4
> 02
>
> 题源：26 版 660 数一二三第 149 题　|　题源类型：660　|　页码：p.129　|　模块：1.3 极限与导数
