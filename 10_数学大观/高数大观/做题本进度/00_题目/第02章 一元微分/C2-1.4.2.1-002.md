...
> f(x)=cosx2 f(x)=sinx2 2; 1, ⃝ ⃝ ⃝ f(x)=(1−cosx)3 ⃝ f(x
> )=(sinx2)3 设有以下函数 则其 3; 3; 1 2 3 4 中在 处可导的共有多少个 x=0 A.
>  1 B. 2 C. 3 D. 4
>
> 题源：26 版 660 数二第 531 题（重点）　|　题源类型：660　|　页码：p.134　|　模块：1.4 某点的可导问题
