...
> 设 f(x)=xsinx+cosx，下列命题中正确的是（ ） π π 是极大值，f 是极小值 是极小值，f 
> 是极大值 A. f(0) B. f(0) (cid:16)2(cid:17) (cid:16)2(cid:1
> 7) π π 是极大值，f 也是极大值 是极小值，f 也是极小值 C. f(0) D. f(0) 2 2
>
> 题源：2005 数三; 26 版 660 数二第 540 题　|　题源类型：真题　|　页码：p.175　|　模块：3.4 极最拐
