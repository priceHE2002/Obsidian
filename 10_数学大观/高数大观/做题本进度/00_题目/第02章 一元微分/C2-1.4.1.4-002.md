...
> 可导，F(x)=f(x)(1+|sinx|)，则 在 设 是 处可导的（） f(x) f(0)=0 F(x)
>  x=0 充分必要条件 充分条件但非必要条件 A. B. 必要条件但非充分条件 既非充分条件又非必要条件 C
> . D.
>
> 题源：1995 数一二; 880 第二章基础选择 14　|　题源类型：真题　|　页码：p.132　|　模块：1.4 某点的可导问题
