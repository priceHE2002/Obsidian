...
> x=y2(y 质点 沿抛物线 移动，P 的横坐标 的变化速度为 cm/s。当 时，点 到原点 的 P >0)
>  x 5 x=9 P O 距离变化速度为 微分中值定理 4 小题
>
> 题源：26 版 1000 第七章强化 1　|　题源类型：1000　|　页码：p.204　|　模块：3.7 物理应用
