...
> =x3 已知动点 在曲线 上运动，过点 作 轴的垂线，交 轴于点 A，过点 作 轴的垂线，交 P(x,y) 
> y P x x P y 轴于点 B。记矩形 的面积为 S。若动点 的横坐标对时间的变化率为常数 ，则当点 运
> 动到 y OAPB P v P 0 点 时，S 对时间的变化率为 (1,1)
>
> 题源：900 第二章数二 A 类 59　|　题源类型：900　|　页码：p.203　|　模块：3.7 物理应用
