...
> √ x2 y2 2b (x−1)2 设椭圆 与抛物线 相切于一点，记该切点的横坐标为 ，则（ ） + =1 
> y = x 0 a2(cid:19) b2 a 1 1 2 ∈ ∈ A. x 0, B. x , 0 0 3
>  3 3 2 ∈ 由已知条件不能确定 的范围 C. x ,1 D. x 0 0 3
>
> 题源：900 第二章数二 B 类 7　|　题源类型：900　|　页码：p.194　|　模块：3.5 3.5
