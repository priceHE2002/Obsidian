...
> tanx π 设方程 在 内有实根，则常数 的取值范围为（）. =k 0, k x 4 4 4 4 −1 −
> 1<k A. 0<k < B. < π π π 4 4 −1<k C. 1<k < D. <1 π π
>
> 题源：26 版 1000 第六章强化 17　|　题源类型：1000　|　页码：p.192　|　模块：3.5 3.5
