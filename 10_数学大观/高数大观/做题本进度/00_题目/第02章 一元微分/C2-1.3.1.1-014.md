...
源题号: "1.3.1.1-014"
序: 959
题源: "880 第二章基础填空 17; 880 第二章基础选择 3（重点）"
题源大类: "880"
重点: true
页码: 124
状态: "未开始"
...
> −f(1+sint) f(2x−1) (1+sint)2 f 设 是连续函数，且 =1，则 f(x) lim
>  lim = x−1 t x→1 t→0 ·第 页，共 页· 113 402
>
> 题源：880 第二章基础填空 17; 880 第二章基础选择 3（重点）　|　题源类型：880　|　页码：p.124　|　模块：1.3 极限与导数
