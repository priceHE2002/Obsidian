...
> ex[1+x+f(x)] 【24】设 为连续函数，且 存在，则曲线 有斜渐近线（ ）。 f(x) lim y
>  =f(x) x→+∞ =−x =−x−1 A. y =x B. y C. y =x+1 D. y ·第 页
> ，共 页· 155 402
>
> 题源：880 第二章基础选择 24（重点）　|　题源类型：880　|　页码：p.166　|　模块：3.2 渐近线
