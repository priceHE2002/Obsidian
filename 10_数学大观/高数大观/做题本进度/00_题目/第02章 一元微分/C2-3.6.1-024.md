...
> 设 b>0>a，则（）。 aea(eb−1)>beb(ea−1) aea(eb−1)<beb(ea−1) A
> . B. bea(eb−1)>aeb(ea−1) bea(eb−1)<aeb(ea−1) C. D.
>
> 题源：26 版 1000 第六章强化 24　|　题源类型：1000　|　页码：p.198　|　模块：3.6 不等式
