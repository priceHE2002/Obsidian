...
备注:
---
# 1.4.2.2.1-020 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> √ 8 <1− 1−x , x<0 设 处处可导，则 等于 f(x)= (a,b) x : x⩾0 a+bx
> , 1 1 1 1 1 1 1 任意，b= A. a B. , C. , D. , 4 2 8 4 8 2 
> 4
>
> 题源：26 版 660 数二第 534 题　|　题源类型：660　|　页码：p.137　|　模块：1.4 某点的可导问题
