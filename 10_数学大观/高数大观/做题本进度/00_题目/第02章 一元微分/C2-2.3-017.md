...
> 二阶导数，且f′(0)=1，函数y =y(x)由方程y−xey−1 =f(lny−sinx)， 已知函(ci
> d:12)数f(u)具有(cid:12) =1所确定，设z d2z dz 求 ， dx2 dx x=0 x=
> 0
>
> 题源：2007 数二　|　题源类型：真题　|　页码：p.147　|　模块：2.3 隐函数求导
