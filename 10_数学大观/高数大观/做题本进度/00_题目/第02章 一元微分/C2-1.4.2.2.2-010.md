...
备注:
---
# 1.4.2.2.2-010 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> 如下四个函数中，在 处可导的函数是 x=0 f(x)=e|x| f(x)=arctan|x| A. B. 8
>  1 < p x4 x̸=0 sin , 3 |x| x C. f(x)= D. f(x)=arcsin :
>  0, x=0
>
> 题源：26 版 660 数二第 532 题　|　题源类型：660　|　页码：p.139　|　模块：1.4 某点的可导问题
