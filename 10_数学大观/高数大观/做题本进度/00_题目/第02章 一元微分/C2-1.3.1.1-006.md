...
源题号: "1.3.1.1-006"
序: 934
题源: "26 版 1000 第五章强化 2; 26 版 660 数一二三第 40 题"
题源大类: "1000"
重点: false
页码: 124
状态: "未开始"
...
> [f(x)+1]x2 设 在 处连续，且 =2，则曲线 在点 处的切线方程为 f(x) x=0 lim y 
> =f(x) (0,f(0)) x−sinx x→0
>
> 题源：26 版 1000 第五章强化 2; 26 版 660 数一二三第 40 题　|　题源类型：1000　|　页码：p.124　|　模块：1.3 极限与导数
