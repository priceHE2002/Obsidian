...
> tanx ax+bx2+cx3，则（ 设函数 在 处的 次泰勒多项式为 ） x=0 3 f(x)= 1−x2
>  2 2 a=1,b=0,c=− A. B. a=1,b=0,c= 3 3 4 4 a=1,b=0,c=− 
> C. D. a=1,b=0,c= 3 3 ·第 页，共 页· 193 402
>
> 题源：900 第二章数二 A 类 37　|　题源类型：900　|　页码：p.204　|　模块：4.1 小题
