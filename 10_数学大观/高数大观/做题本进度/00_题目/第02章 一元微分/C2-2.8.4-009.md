...
> f(x)=x2cos2x，则 f(10)(0)= 设函数 . n，f(n)(1)= n (a̸=0)。若 f
> (n)(2)=2nn!，则 a= x2，则 f(n)(2)= ; f′′′(0)=1，则 ，且 a= n⩾0
> ，则 f(2n+1)(0)= . ，f(100)(0)= ·第 页，共 页· 143 402
>
> 题源：900 第二章数二 A 类 50　|　题源类型：900　|　页码：p.154　|　模块：2.8 高阶导
