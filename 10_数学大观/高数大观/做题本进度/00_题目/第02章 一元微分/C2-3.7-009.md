...
> v2 已知质点以恒定速率沿曲线运动时，向心加速度大小为 ，其中 为质点的运动速率，ρ 为曲率半径。设 v ρ
>  =x2 单位质点以恒定的速率 沿着一个形状满足 的光滑轨道移动，则其在点 处受到的向心力大小 v y (0
> ,0) 0 为
>
> 题源：900 第二章数二 B 类 30　|　题源类型：900　|　页码：p.204　|　模块：3.7 物理应用
