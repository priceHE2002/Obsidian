...
备注:
---
# 1.4.2.2.2-009 · 某点的可导问题

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 1 < x3sin , x>0, x 则 在 处（ ）. 设 f(x) x=0 f(x)= : x⩽0,
>  x2, 不连续 连续，但不可导 A. B. 可导，但导函数不连续 可导，且导函数连续 C. D.
>
> 题源：26 版 1000 第三章基础 10　|　题源类型：1000　|　页码：p.139　|　模块：1.4 某点的可导问题
