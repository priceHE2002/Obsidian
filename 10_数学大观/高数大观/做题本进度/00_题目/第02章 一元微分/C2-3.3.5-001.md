...
> √ x上任一点M(x,y)(x⩾1)处的曲率半径，s=s(x)是该抛物线上介于点A(1,1) 设ρ=ρ(x)
> 是抛物线y = 2 |y′′| d2ρ dρ − 的值．（在直角坐标系下曲率公式为 与 之间的弧长，计算 ．
> ） K = M 3ρ 3 ds2 ds (1+y′2)2 极最拐
>
> 题源：2001 数二; 880 第二章综合解答 24　|　题源类型：真题　|　页码：p.169　|　模块：3.3 曲率
