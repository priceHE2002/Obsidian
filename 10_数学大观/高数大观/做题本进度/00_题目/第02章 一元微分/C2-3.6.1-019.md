...
> xf′(x)<f(x)，则（ 设 是连续可导函数，当 时，恒有 ） f(x) 0<a<x<b A. af(x
> )>xf(a) B. bf(x)>xf(b) C. xf(x)>bf(b) D. xf(x)<af(a) ·
> 第 页，共 页· 186 402
>
> 题源：26 版 1000 第六章基础 14　|　题源类型：1000　|　页码：p.197　|　模块：3.6 不等式
