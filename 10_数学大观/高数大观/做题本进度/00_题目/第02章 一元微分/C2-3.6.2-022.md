...
> lna π(π+2) <b2。 e<a<b，证明：a2 设 <ab dx⩽ lnb 8 Z x 1 f′(x
> )+f(x)− f(t)dt=0。 x+1 0 e−x ⩽f(x)⩽1 成立。 上具有二阶导数，f(a)=0
> ，f′(x)>0，f′′(x)>0。设 b>a，曲线 y =f(x) ,0)，证明 <b。 (x a<x 0
>  0 ·第 页，共 页· 190 402
>
> 题源：26 版 1000 第六章强化 25　|　题源类型：1000　|　页码：p.201　|　模块：3.6 不等式
