...
> f′′(x)+[f′(x)]2 f′(0)=0，则 设函数 满足关系式 =x，且 (2) f(x) ( ) 
> 是 的极大值. A. f(0) f(x) 是 的极小值. B. f(0) f(x) 点 是曲线 的拐点. C
> . (0,f(0)) y =f(x) 不是 的极值，点 也不是曲线 的拐点. D. f(0) f(x) (0
> ,f(0)) y =f(x) ·第 页，共 页· 175 402
>
> 题源：2000 数二　|　题源类型：真题　|　页码：p.186　|　模块：3.4 极最拐
