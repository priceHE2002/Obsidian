...
> F′′(x) 上有二阶导数，f(2)=0，F(x)=(x−1)2f(x)，则 函数 在 在 上 f(x) [
> 1,2] (1,2) 没有零点 必有零点 A. B. 若有零点，必不止一个 若有零点必唯一 C. D.
>
> 题源：26 版 660 数二第 563 题　|　题源类型：660　|　页码：p.206　|　模块：4.1 小题
