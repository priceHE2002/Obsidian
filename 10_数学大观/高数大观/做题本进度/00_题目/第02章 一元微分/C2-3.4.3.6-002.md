...
> xy′′+y′2 =arctan2x，则 设 在 邻域二阶连续可导且满足 y =y(x) x=0 是 的极小
> 值点 是 的极大值点 A. x=0 y(x) B. x=0 y(x) 点是 的拐点 以上均不对 C. (0,
> y(0)) y =y(x) D.
>
> 题源：26 版 660 数二第 555 题（重点）　|　题源类型：660　|　页码：p.187　|　模块：3.4 极最拐
