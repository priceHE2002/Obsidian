...
源题号: "3.4.2.1-009"
序: 1420
题源: "880 第二章综合解答 4; 26 版 1000 第五章基础 17（重点）"
题源大类: "880"
重点: true
页码: 179
状态: "未开始"
...
> f(x)=nx(1−x)n（n 设 为正整数），求 在 上的最大值 及 M(n)。 f(x) [0,1] M
> (n) lim n→∞
>
> 题源：880 第二章综合解答 4; 26 版 1000 第五章基础 17（重点）　|　题源类型：880　|　页码：p.179　|　模块：3.4 极最拐
