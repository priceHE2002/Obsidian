...
> |f(x)| 设函数 在点 处可导，则函数 在点 处不可导的充分条件是（） (2) f(x) x=a x=a
>  f′(a)=0 f′(a)̸=0 且 且 A. f(a)=0 B. f(a)=0 f′(a)>0 f′(a
> )<0 且 且 C. f(a)>0 D. f(a)<0
>
> 题源：2000 数三　|　题源类型：真题　|　页码：p.131　|　模块：1.4 某点的可导问题
