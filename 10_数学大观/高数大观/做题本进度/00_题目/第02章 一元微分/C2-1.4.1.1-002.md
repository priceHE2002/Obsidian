...
> 可导，|f(x)| 设函数 在 处不可导，则（ ）。 f(x) x=0 f(0)=0,f′(0)=0 f(0
> )=0,f′(0)̸=0 A. B. f(0)̸=0,f′(0)=0 f(0)̸=0,f′(0)̸=0 C.
>  D. ▶1.4.1.2 判断不可导点的个数
>
> 题源：26 版 1000 第三章基础 7　|　题源类型：1000　|　页码：p.131　|　模块：1.4 某点的可导问题
