...
> y′′+y′−esinx f′(x 设 是满足微分方程 的解，且 )=0，则 在（ ） y =f(x) =0
>  f(x) 0 某邻域内单调增加 某邻域内单调减少 A. x B. x 0 0 处取得极小值 处取得极大值 
> C. x D. x 0 0 ·第 页，共 页· 165 402
>
> 题源：1994 数二　|　题源类型：真题　|　页码：p.176　|　模块：3.4 极最拐
