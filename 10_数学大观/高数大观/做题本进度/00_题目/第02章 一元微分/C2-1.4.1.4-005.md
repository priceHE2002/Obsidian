...
> 点处连续，f(x)=|x−a|g(x) 设函数 在 在 点处可导，则 满足 g(x) x=a x=a g(a
> ) g(a)̸=a g(a)̸=0 A. g(a)=a B. C. g(a)=0 D.
>
> 题源：26 版 660 数一二三第 162 题　|　题源类型：660　|　页码：p.133　|　模块：1.4 某点的可导问题
