...
> 2cm/s，−3cm/s，当底面半径为 有一圆柱体，底面半径与高随时间变化的速率分别为 10cm，高为 (3
> ) 5cm 时，圆柱体的体积与表面积随时间变化的速率分别为（ ）． 125πcm3/s，−40πcm2/s 
> 125πcm3/s，40πcm2/s A. B. −100πcm3/s，40πcm2/s −100πcm3/
> s，−40πcm2/s C. D.
>
> 题源：2021 数二　|　题源类型：真题　|　页码：p.203　|　模块：3.7 物理应用
