...
> 设 F(x)=g(x)φ(x)，φ(x) 在 处连续但不可导，g(x) 在 处可导，F(x) 在 处可导，则
> 一 x=a x=a x=a 定有（ ）. g(a)̸=0 A. g(a)=0 B. g′(a)=0 可以为任
> 意实数 C. D. g(a)
>
> 题源：26 版 1000 第三章基础 2　|　题源类型：1000　|　页码：p.132　|　模块：1.4 某点的可导问题
