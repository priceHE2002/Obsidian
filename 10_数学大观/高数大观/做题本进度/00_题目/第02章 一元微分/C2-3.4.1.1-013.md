...
> 设函数 在 的某邻域内有定义，则以下结论正确的是（）. f(x) x=0 f(0)=0,f′(0)=0，则 
> 若 必不是极值点 A. x=0 f′(0)=0,f′′(0)=0，则 若 必是极值点 B. x=0 f(0)
> =0,f′(0)>0，则存在 若 >0，使得 在 内单调递增 C. δ f(x) (0,δ) ·第 页，共 
> 页· 160 402
>
> 题源：26 版 1000 第五章强化 9　|　题源类型：1000　|　页码：p.171　|　模块：3.4 极最拐
