...
> f′(x)<2f(x)，则当 若可导函数 满足 时，有（）. f(x) b>a>0 b2f(a)>a2f(b
> ) b2f(lna)>a2f(lnb) A. B. b2f(a)<a2f(b) b2f(lna)<a2f(l
> nb) C. D.
>
> 题源：26 版 1000 第六章强化 9　|　题源类型：1000　|　页码：p.198　|　模块：3.6 不等式
