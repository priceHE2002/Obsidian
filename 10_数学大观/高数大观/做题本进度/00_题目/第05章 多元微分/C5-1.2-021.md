...
备注:
---
# 1.2-021 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 设函数 8(cid:16) p 1 < xy+a|x|+b |y| (x,y)̸=(0,0), arctan
>  , |x|+y2 f(x,y)= : 0, (x,y)=(0,0), 则下列说法中，错误的是（ ） 函数 
> 在点 处的连续性与 的取值无关。 A. f(x,y) (0,0) a,b 函数 在点 处的偏导数是否存在与 
> 的取值无关。 B. f(x,y) (0,0) a,b 函数 在点 处的可微性与 的取值有关。 C. f(x,
> y) (0,0) a,b 若函数 在点 处的偏导数存在，则 在点 处可微。 D. f(x,y) (0,0) 
> f(x,y) (0,0)
>
> 题源：900 第四章数二 B 类 7　|　题源类型：900　|　页码：p.337　|　模块：1.2 已知具体多元函数判断其他
