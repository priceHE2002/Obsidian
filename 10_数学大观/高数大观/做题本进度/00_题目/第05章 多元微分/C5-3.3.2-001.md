...
备注:
---
# 3.3.2-001 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2u ∂2u ∂u ∂u −2 u(x,y)=v(x,y)eax+by 已知函数 满足 =0，求 的值使得
> 在变换 之下， u(x,y) 2 +3 +3 a,b ∂x2 ∂y2 ∂x ∂y 上述等式可化为函数 的不含
> 一阶偏导数的等式。 v(x,y)
>
> 题源：2019 数二　|　题源类型：真题　|　页码：p.355　|　模块：3.3 利用变量代换化简偏微分方程
