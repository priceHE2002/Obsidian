...
备注:
---
# 3.3.1-007 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> 【10】设 有二阶连续偏导数，利用变换 =x+ay，η =x+by，将方程 u(x,y) ξ ∂2u ∂2u
>  ∂2u +4 +3 =0 ∂x2 ∂y2 ∂x∂y ∂2u 化为 =0，求 的值。 a,b ∂ξ∂η 非线
> 性变换
>
> 题源：880 第四章基础解答 10　|　题源类型：880　|　页码：p.355　|　模块：3.3 利用变量代换化简偏微分方程
