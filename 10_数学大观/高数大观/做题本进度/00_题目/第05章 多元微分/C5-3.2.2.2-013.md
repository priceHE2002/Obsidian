...
备注:
---
# 3.2.2.2-013 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> d2y dy =f(ex,cosx)，求 设函数 具有二阶连续偏导数，y ， f(u,v) dx2 dx x
> =0 x=0
>
> 题源：2017 数一二; 880 第四章基础填空 10　|　题源类型：真题　|　页码：p.351　|　模块：3.2 多元复合函数求偏导
