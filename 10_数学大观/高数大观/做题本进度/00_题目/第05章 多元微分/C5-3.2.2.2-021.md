...
备注:
---
# 3.2.2.2-021 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2f ∂2g ∂2f − − f(x2 y2,xy)，则 1，又 设函数 具有二阶连续偏导数，且满足 = 
> g(x,y) = + f(u,v) 4 ∂u2 ∂v2 ∂x2 ∂2g = ∂y2
>
> 题源：25 版 660 数一二三第 93 题　|　题源类型：660　|　页码：p.352　|　模块：3.2 多元复合函数求偏导
