...
> ∂f e−2x =4y+2y2+2x+1，且 f(0,y)=2y+y2。求： 已知 满足 f(x,y) ∂x
>  的表达式； (1) f(x,y) 的极值。 (2) f(x,y) ▶4.2.3.2 已知全微分
>
> 题源：26 版 1000 第十三章强化 33　|　题源类型：1000　|　页码：p.373　|　模块：4.2 无条件极值
