...
备注:
---
# 3.6.3-005 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂f(u,v) ∂f(u,v) − v)ev，且 2)ev。则 已知可微函数 满足 f(u,v) + = (
> u + f(0,v) = (v f(x,x + ∂u ∂v y)=
>
> 题源：25 版 660 数一二三第 90 题　|　题源类型：660　|　页码：p.367　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
