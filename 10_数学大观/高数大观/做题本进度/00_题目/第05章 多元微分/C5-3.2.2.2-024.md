...
备注:
---
# 3.2.2.2-024 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2g ∂2g ∂2g x y g(x,y)=xy−f x2 +y2 ，求 设函数 具有二阶连续偏导数，函数
>  , +2xy f(u,v) ∂x2 ∂y2 x y ∂x∂y
>
> 题源：26 版 1000 第十三章基础 13　|　题源类型：1000　|　页码：p.352　|　模块：3.2 多元复合函数求偏导
