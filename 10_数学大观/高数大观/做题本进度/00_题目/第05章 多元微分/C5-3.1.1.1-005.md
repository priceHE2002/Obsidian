...
> f(x,y)=e|sinx|−cosy，则（ 已知函数 ） ∂f(cid:12) ∂f(cid:12) ∂f
> (cid:12) ∂f(cid:12) 不存在， 存在 存在， 不存在 B. A. ∂x ∂y ∂x ∂y 
> (cid:12)(0,0) (cid:12)(0,0) (0,0) (0,0) ∂f(cid:12) ∂f(
> cid:12) ∂f(cid:12) ∂f(cid:12) ， 均存在 ， 均不存在 C. D. ∂x ∂y
>  ∂x ∂y (0,0) (0,0) (0,0) (0,0)
>
> 题源：900 第四章数二 A 类 3　|　题源类型：900　|　页码：p.343　|　模块：3.1 多元函数求偏导
