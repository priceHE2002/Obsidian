...
> x3 ex+y 求函数 的极值。 f(x,y)= y+ 3 的极值。 的极值点是（ ） (3,0) (1,1
> ) C. D. a a 处取极小值。 处取极大值。 当 时，f(x,y) 在点 , B. a>0 3 3 a
>  处取极大值。 在点 处不取得极值。 D. f(x,y) (0,0) 3
>
> 题源：2013 数一　|　题源类型：真题　|　页码：p.370　|　模块：4.2 无条件极值
