...
备注:
---
# 3.2.2.2-018 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2u ∂2u u(x,2x)=x2，u′(x,2x)=4x。求 u′′ =− 设有二阶连续偏导数的函数 满
> 足 以及 u=u(s,t) (x,2x) 1 11 ∂s2 ∂t2 u′′ 和 (x,2x)。 12
>
> 题源：900 第四章数二 B 类 27　|　题源类型：900　|　页码：p.352　|　模块：3.2 多元复合函数求偏导
