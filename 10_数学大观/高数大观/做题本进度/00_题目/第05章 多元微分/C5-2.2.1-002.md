...
> p f(x,y)− x2+y2 p 若 在 点的某个邻域内有定义，f(0,0)=0，且 =a，其中 为常 f
> (x,y) (0,0) lim a (x,y)→(0,0) x2+y2 数。 讨论函数 在 点的连续性； (
> 1) f(x,y) (0,0) 当 为何值时，函数 在 点可微？并求 (2) a f(x,y) (0,0) 
> df (0,0)
>
> 题源：26 版 1000 第十三章强化 4　|　题源类型：1000　|　页码：p.339　|　模块：2.2 已知重极限推导其他
