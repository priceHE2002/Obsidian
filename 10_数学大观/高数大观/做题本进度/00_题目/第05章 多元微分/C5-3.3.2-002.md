...
备注:
---
# 3.3.2-002 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2u ∂2u ∂u ∂u −2 −4 u(x,y)=v(x,y)eax+by 已知函数 满足 =0，求 的
> 值，使得在变换 下， u(x,y) +3 a,b ∂x2 ∂y2 ∂x ∂y 上述等式可化为不含 的一阶偏导
> 数的等式。 v(x,y) 多元隐函数求偏导
>
> 题源：900 第四章数二 A 类 37　|　题源类型：900　|　页码：p.355　|　模块：3.3 利用变量代换化简偏微分方程
