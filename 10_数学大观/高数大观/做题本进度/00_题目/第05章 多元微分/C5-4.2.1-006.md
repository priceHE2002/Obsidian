...
> 已知函数f(x,y)具有二阶连续偏导数，函数g(x)具有二阶导数且g(0)=0。对于函数z(x,y)=f(g
> (x),g(y))， 下列说法中，正确的是（ ） f′(0,0)=f′(0,0)=0，则点 若 是 的极值点
> 且 是 的极值点。 A. x=0 g(x) (0,0) z(x,y) 1 2 f′(0,0)=f′(0,0)
> =0，则 若点 是 的极值点且 是 的极值点。 B. (0,0) z(x,y) x=0 g(x) 1 2 f
> ′′(0,0)f′′(0,0)−[f′′(0,0)]2 ̸=0，g′(0)̸=0，则点 若点 是 的极值点且
>  是 的 C. (0,0) f(x,y) (0,0) z(x,y) 11 22 12 极值点。 z′′ (0
> ,0)z′′ (0,0)−[z′′ ̸=0，g′(0)=0，则点 (0,0)]2 若点 是 的极值点且 是 
> 的 D. (0,0) z(x,y) (0,0) f(x,y) 11 22 12 极值点。
>
> 题源：900 第四章数二 B 类 11　|　题源类型：900　|　页码：p.369　|　模块：4.2 无条件极值
