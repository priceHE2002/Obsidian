...
备注:
---
# 1.2-001 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 >><xy, ̸=0, xy 关于函数 给出以下结论： f(x,y)= x, y =0, >>: y, 
> x=0, ∂2f ∂f =1；⃝ =1；⃝ f(x,y)=0；⃝ ⃝ limf(x,y)=0。 lim li
> m 2 3 4 1 ∂x ∂x∂y y→0x→0 (x,y)→(0,0) (0,0) (0,0) 其中正确的
> 个数为（ ） A. 4 B. 3 C. 2 D. 1 ·第 页，共 页· 322 402
>
> 题源：2020 数二　|　题源类型：真题　|　页码：p.333　|　模块：1.2 已知具体多元函数判断其他
