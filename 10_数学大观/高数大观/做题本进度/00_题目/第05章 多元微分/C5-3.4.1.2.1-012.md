...
备注:
---
# 3.4.1.2.1-012 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z x2 2z−ez+1+ sin(t2)dt=0 已知方程 在 的某个邻域中确定了一个隐函数 =z(x,y
> )， (x ,y ,z )=(1,1,0) z 0 0 0 y ∂2z 求 ∂x∂y (1,1) ▶3.4.
> 1.2.2 抽象
>
> 题源：26 版 1000 第十三章强化 19　|　题源类型：1000　|　页码：p.360　|　模块：3.4 多元隐函数求偏导
