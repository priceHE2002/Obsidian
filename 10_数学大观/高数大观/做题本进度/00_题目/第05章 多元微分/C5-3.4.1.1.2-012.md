...
备注:
---
# 3.4.1.1.2-012 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> φ′ x2+y2−z ̸=−1 设 是由方程 所确定的函数，其中 具有 阶导数且 时。 z =z(x,y) 
> =φ(x+y+z) φ 2 （1）求 dz； 1 ∂z ∂z ∂u − （2）记 ，求 u(x,y)= x−
> y ∂x ∂y ∂x
>
> 题源：2008 数三　|　题源类型：真题　|　页码：p.358　|　模块：3.4 多元隐函数求偏导
