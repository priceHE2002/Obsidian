...
> 例 求下列重极限： 1 xαyβ (α≥0,β ≥0)； (1) lim x→0x2+y2 y→0 xy(x
> 2−y2) ； (2) lim x2+y2 x→0 y→0 x2y2 (3) lim 0(x2+y2)3 →
>  x 2 y→ 0
>
> 题源：姜晓千强化例题　|　题源类型：其他　|　页码：p.338　|　模块：2.1 求重极限
