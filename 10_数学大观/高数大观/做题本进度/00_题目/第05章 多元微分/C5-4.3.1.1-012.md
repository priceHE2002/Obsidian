...
> ⩽b，则 设有三个正数 满足 =a，其中 为常数，又 的最小取值是 x,y,z x+y+z a>0 xyz 
> b a3 a3 a3 a3 A. B. C. D. 21 18 9 27
>
> 题源：26 版 660 数一二三第 251 题　|　题源类型：660　|　页码：p.377　|　模块：4.3 条件极值
