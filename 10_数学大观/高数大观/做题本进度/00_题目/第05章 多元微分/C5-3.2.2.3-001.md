...
备注:
---
# 3.2.2.3-001 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂f(cid:12) ∂f(cid:12) 设函数 在点 处可微，且 f(1,1)=1， =2， =3，φ(
> x)=f[x,f(x,x)]。求 z =f(x,y) (1,1) ∂x ∂y (1,1) (1,1) d φ
> 3(x)(cid:12) dx x=1
>
> 题源：2001 数一　|　题源类型：真题　|　页码：p.353　|　模块：3.2 多元复合函数求偏导
