...
备注:
---
# 3.3.1-003 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z ∂2z ∂2z − 设函数 具有二阶连续偏导数，则下列各项中的变换能将方程 化简为 3 z(x,y)
>  2 + = 0 ∂x2 ∂y2 ∂x∂y ∂2z 的是（） =0 8∂u∂v 8 2 < < u=x− u
> =x+y, y, 3 B. A. 2 : : =− x+y. v v =x+y . 3 8 8 >< >< 
> 2 2 u=x− y, y, u=x+ 3 3 C. D. 3 3 >: >: =− v = x+y. v 
> x+y. 2 2
>
> 题源：900 第四章数二 B 类 9　|　题源类型：900　|　页码：p.354　|　模块：3.3 利用变量代换化简偏微分方程
