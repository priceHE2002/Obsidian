...
备注:
---
# 3.3.1-005 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> =y−x，将方程 设函数 具有二阶连续偏导数，作变量代换 u=f(x,y) ξ =x,η ∂2u ∂2u ∂
> 2u +2 + =0 ∂x2 ∂y2 ∂x∂y 化为以 为自变量的方程。 ξ,η
>
> 题源：26 版 1000 第十三章基础 16　|　题源类型：1000　|　页码：p.355　|　模块：3.3 利用变量代换化简偏微分方程
