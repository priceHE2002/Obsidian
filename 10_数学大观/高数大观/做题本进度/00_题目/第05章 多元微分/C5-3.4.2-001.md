...
> z′′(1) x2−xy+y2 =x2+2y2，其中 设 是由方程 确定的隐函数，且 y(1)=1，则 等于
>  z y =y(x) =1 −6 −18 A. 6 B. 18 C. D.
>
> 题源：26 版 660 数一二三第 245 题　|　题源类型：660　|　页码：p.360　|　模块：3.4 多元隐函数求偏导
