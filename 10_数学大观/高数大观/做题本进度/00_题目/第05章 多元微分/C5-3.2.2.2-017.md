...
备注:
---
# 3.2.2.2-017 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> (2)(江苏省高等数学竞赛题,1998年)设f(x,y)有二阶连续偏导数，满足f′′ (x,y)=f′′ (
> x,y)，f(x,2x)=x2， xx yy ，f′′ f′(x,2x)=x，则 f′′ (x,2x)= (
> x,2x)= xy x xx ·第 页，共 页· 340 402
>
> 题源：1998 年江苏省高等数学竞赛题（重点）　|　题源类型：真题　|　页码：p.351　|　模块：3.2 多元复合函数求偏导
