...
> 8 >< x2−y2 (x,y)̸=(0,0), , xy x2+y2 已知 则 f(x,y)= >: 0,
>  (x,y)=(0,0), f′′ f′′ A. (0,0)=1 B. (0,0)=0 xy xy f′′ 
> f′′ (0,0)=−1 C. (0,0)=1 D. yx yx ▶3.1.2.2 常规
>
> 题源：26 版 660 数一二三第 248 题　|　题源类型：660　|　页码：p.345　|　模块：3.1 多元函数求偏导
