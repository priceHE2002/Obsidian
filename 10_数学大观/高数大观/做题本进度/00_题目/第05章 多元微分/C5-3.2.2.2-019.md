...
备注:
---
# 3.2.2.2-019 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ′′ 设函数z =f(xcosy,yg(x))，其中(cid:12) 函数f 具有二阶连续偏导数，且f (1
> ,0)=1，函数g(x)可导，且在x=1 1 2 ∂2z 处取得极值 g(1)=2。求 ∂x∂y x=1 y
> =0
>
> 题源：900 第四章数二 A 类 32　|　题源类型：900　|　页码：p.352　|　模块：3.2 多元复合函数求偏导
