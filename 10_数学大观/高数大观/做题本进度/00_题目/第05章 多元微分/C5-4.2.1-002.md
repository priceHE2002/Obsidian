...
> 【6】设可微函数 在点 处取得极大值，则（ ） f(x,y) P(x ,y ) 0 0 在 处导数小于零 在
>  处导数大于零 A. f(x ,y) y =y B. f(x ,y) y =y 0 0 0 0 在 处导数等
> 于零 在 处导数不存在 C. f(x ,y) y =y D. f(x ,y) y =y 0 0 0 0
>
> 题源：880 第四章基础选择 6　|　题源类型：880　|　页码：p.368　|　模块：4.2 无条件极值
