...
> ∂2f ∂2f 设函数 具有二阶连续偏导数，且在点 处取极大值，记 ，b= ，则 f(x,y) (x ,y 
> ) a= 0 0 ∂x2 ∂y2 (x0,y0) (x0,y0) （ ）。 a⩾0,b⩾0 a⩽0,b⩽0 
> A. a>0,b>0 B. C. a<0,b<0 D. 直接给出函数
>
> 题源：26 版 1000 第十三章强化 22　|　题源类型：1000　|　页码：p.369　|　模块：4.2 无条件极值
