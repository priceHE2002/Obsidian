...
> Z x+y u(x,y)=φ(x+y)+φ(x−y)+ 设函数 ψ(t)dt，其中函数 具有二阶导数，ψ 具
> 有一阶导数，则 (9) φ x−y 必有 ∂2u ∂2u ∂2u ∂2u =− A. B. = ∂x2 ∂y
> 2 ∂x2 ∂y2 ∂2u ∂2u ∂2u ∂2u C. D. = = ∂y2 ∂x2 ∂x∂y ∂x∂y
>
> 题源：2005 数一二　|　题源类型：真题　|　页码：p.346　|　模块：3.1 多元函数求偏导
