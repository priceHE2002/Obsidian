...
备注:
---
# 3.4.1.1.1-007 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂z ∂z =xf(y2−z2) 设隐函数 由方程 确定，f 可微，则 等于 z =z(x,y) y+z x
>  +z ∂x ∂y A. 1 B. x C. y D. z
>
> 题源：26 版 660 数一二三第 231 题　|　题源类型：660　|　页码：p.356　|　模块：3.4 多元隐函数求偏导
