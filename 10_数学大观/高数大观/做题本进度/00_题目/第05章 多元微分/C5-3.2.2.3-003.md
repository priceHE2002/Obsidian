...
备注:
---
# 3.2.2.3-003 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> 2，f′(1,2) 1，f′(1,2) 3，设函数 已知函数 在点 处可微，且 = φ(x) = = z =
>  f(x,y) (1,2) f(1,2) = y x φ′(1)= f(x,2f(x,2x))，则
>
> 题源：25 版 660 数一二三第 92 题　|　题源类型：660　|　页码：p.353　|　模块：3.2 多元复合函数求偏导
