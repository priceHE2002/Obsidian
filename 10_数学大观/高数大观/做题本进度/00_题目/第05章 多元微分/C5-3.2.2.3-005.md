...
备注:
---
# 3.2.2.3-005 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> 0，f′(0,1) 1，f′(0,1) f(f(x,ex),ex)，则 已知(cid:12) 函数 可微，且
>  2。令 f(u,v) f(0,1) = = = y(x) = 1 2 dy(cid:12) = dx x=
> 0
>
> 题源：900 第四章数二 A 类 19　|　题源类型：900　|　页码：p.353　|　模块：3.2 多元复合函数求偏导
