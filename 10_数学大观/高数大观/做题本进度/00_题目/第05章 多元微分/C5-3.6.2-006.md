...
备注:
---
# 3.6.2-006 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> x 设 ，y >0，P(x,y)dx+Q(x,y)dy 是某二元函数的全微分，则 可取为（ ）. Q(x,y
> )= P(x,y) y2 x2 x2 1 1 1 1 x2− − − y2− B. C. D. A. y3 
> y2 y3 x2 y y
>
> 题源：26 版 1000 第十三章基础 10　|　题源类型：1000　|　页码：p.366　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
