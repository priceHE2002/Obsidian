...
备注:
---
# 3.6.3-001 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z 【例5.5】(1)设f(x,y)可微，满足f′(x,y)=−f(x,y)，f′(x,y)=e−xcosy
> ，且f(0,0)=0，求 f(x,x)dx。 x y
>
> 题源：姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.367　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
