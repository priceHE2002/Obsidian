...
备注:
---
# 3.6.3-006 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> u 1 ∂z ∂z +e−ux+f(u)，u(x,y) xe−ux−f′(u)= 【11】设 满足 ，其中 
> 和 均可微，且 ， z = u(x,y) f(u) = y y ∂x ∂y 求 u(x,y)。 多元微分应用
>  4 单调性
>
> 题源：880 第四章基础解答 11　|　题源类型：880　|　页码：p.367　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
