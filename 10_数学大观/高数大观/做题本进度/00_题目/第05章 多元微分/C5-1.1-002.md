...
源题号: "1.1-002"
序: 2678
题源: "2002 数一; 26 版 660 数一二三第 239 题"
题源大类: "真题"
重点: false
页码: 332
状态: "未开始"
...
> 考虑二元函数 的下面 条性质: (1) f(x,y) 4 ⃝ 在点 处连续; f(x,y) (x ,y ) 
> 1 0 0 ⃝ 在点 处的两个偏导数连续; f(x,y) (x ,y ) 2 0 0 ⃝ 在点 处可微; f
> (x,y) (x ,y ) 3 0 0 ⃝ 在点 处的两个偏导数存在. f(x,y) (x ,y ) 4 0
>  0 ⇒Q” 若用”P 表示可由性质 推出性质 则有 P Q, ⃝ ⇒ ⃝ ⇒ ⃝ ⃝ ⇒ ⃝ ⇒ ⃝ ⃝ 
> ⇒ ⃝ ⇒ ⃝ ⃝ ⇒ ⃝ ⇒ ⃝ A. B. C. D. 2 3 1 3 2 1 3 4 1 3 1 4
>
> 题源：2002 数一; 26 版 660 数一二三第 239 题　|　题源类型：真题　|　页码：p.332　|　模块：1.1 基本概念题
