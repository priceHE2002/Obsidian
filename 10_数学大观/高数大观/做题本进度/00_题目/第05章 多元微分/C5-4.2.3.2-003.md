...
> =(3x2−3)dx+(6y−6)dy，则 设二元函数 的全微分 z =f(x,y) dz ( ). 是极小
> 值，f(−1,1) 是极大值，f(−1,1) 不是极值 不是极值 A. f(1,1) B. f(1,1) 是
> 极大值，f(−1,1) 是极小值，f(−1,1) 是极小值 是极大值 C. f(1,1) D. f(1,1)
>  ▶4.2.3.3 已知关系式
>
> 题源：26 版 1000 第十三章强化 37　|　题源类型：1000　|　页码：p.374　|　模块：4.2 无条件极值
