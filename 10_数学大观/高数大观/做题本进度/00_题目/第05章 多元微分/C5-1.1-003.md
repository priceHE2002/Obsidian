...
> 函数 的两个偏导数在点 处连续是函数 在该点处可微的 f(x,y) (x ,y ) f(x,y) 0 0 充
> 分但非必要条件 必要但非充分条件 A. B. 充分必要条件 既不充分也不必要条件 C. D.
>
> 题源：26 版 660 数一二三第 240 题　|　题源类型：660　|　页码：p.332　|　模块：1.1 基本概念题
