...
备注:
---
# 3.4.1.2.1-007 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> x2+y2+z2−2x−4y−2z 设 由方程 确定，则当 时，（ ） z =z(x,y) =0 (z >0
> ) x=2,y =4 z′ z′ z′′ z′′ =−2. A. =1. B. =2. C. D. =5. 
> x y xx yy
>
> 题源：900 第四章数二 A 类 13　|　题源类型：900　|　页码：p.359　|　模块：3.4 多元隐函数求偏导
