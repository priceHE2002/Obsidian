...
备注:
---
# 3.2.2.4-001 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> 2 2 ∂f ∂f 设函数 可微，满足 =1，z(r,θ) 为 在极坐标系下的表示，则对单位圆周上 f(x,
> y) + f(x,y) ∂x ∂y 2 2 ∂z ∂z 的任一点 (1,θ)， + = ∂r ∂θ
>
> 题源：900 第四章数二 B 类 20　|　题源类型：900　|　页码：p.354　|　模块：3.2 多元复合函数求偏导
