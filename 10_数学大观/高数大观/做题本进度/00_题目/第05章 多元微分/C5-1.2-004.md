...
备注:
---
# 1.2-004 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> ( x̸=0, sinxcosy, 设 则（）. f(x,y)= 1−cosy, x=0, f′(0,0)=
> 0 B. lim limf(x,y)=0 A. x x→0y→0 f′(0,0)=1 f′′ (0,0)=1
>  D. C. y yx
>
> 题源：26 版 1000 第十三章强化 2　|　题源类型：1000　|　页码：p.334　|　模块：1.2 已知具体多元函数判断其他
