...
> 1 1 有二阶连续偏导数，u=x− 【23】设 y，v y，且满足 z =f(u,v) =x+ 2 2 ∂2
> z ∂2z −4 (a̸=0). =12a ∂x2 ∂y2 ∂2f ； 求 (I) ∂u∂v ∂f(u,0)
>  =−3u2，f(0,v)=−v3，求 若 的极值。 (II) f(u,v) ∂u 多元隐函数极值
>
> 题源：880 第四章综合解答 23　|　题源类型：880　|　页码：p.374　|　模块：4.2 无条件极值
