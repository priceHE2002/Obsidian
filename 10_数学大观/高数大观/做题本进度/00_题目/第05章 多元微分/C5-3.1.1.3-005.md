...
> xy−x2 1 1 已知 ，则 f , = f(x,y)= x−2y y x x−y x−y y−x y−x
>  A. B. C. D. xy−2x2 xy−2y2 xy−2x2 xy−2y2
>
> 题源：26 版 660 数一二三第 225 题　|　题源类型：660　|　页码：p.345　|　模块：3.1 多元函数求偏导
