...
> p 【16】设 x2+y2φ(x,y)，φ(x,y) 在点 处连续，且 φ(0,0)=0。 f(x,y)= 
> (0,0) f′(0,0)，f′(0,0)； （I）求 x y （II）证明：f(x,y) 在点 处可微，并
> 求全微分 (0,0) df (0,0) ▶3.5.1.2 隐函数
>
> 题源：880 第四章综合解答 16　|　题源类型：880　|　页码：p.363　|　模块：3.5 求全微分
