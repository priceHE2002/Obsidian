...
备注:
---
# 3.2.2.2-006 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z x y 设 ，其中 具有二阶连续偏导数，g 具有二阶连续导数，求 z =f xy, +g f y x
>  ∂x∂y
>
> 题源：2000 数一; 880 第四章基础填空 15　|　题源类型：真题　|　页码：p.350　|　模块：3.2 多元复合函数求偏导
