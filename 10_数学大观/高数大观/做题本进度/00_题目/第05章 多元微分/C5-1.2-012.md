...
备注:
---
# 1.2-012 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 >< x2y (x,y)̸=(0,0), , x4+y2 二元函数 在点 处 f(x,y)= (0,0)
>  >: 0, (x,y)=(0,0) f′(0,0) 连续. 不连续且 不存在. A. B. x ·第 页，
> 共 页· 324 402
>
> 题源：26 版 660 数一二三第 226 题　|　题源类型：660　|　页码：p.335　|　模块：1.2 已知具体多元函数判断其他
