...
源题号: "4.1-001"
序: 2949
题源: "2012 数二; 880 第四章综合选择 5; 26 版 660 数一二三第 228 题"
题源大类: "真题"
重点: false
页码: 368
状态: "未开始"
...
> ∂f(x,y) ∂f(x,y) （5）设函数 可微，且对任意 都有 >0， <0，则使不等式 f(x,y) 
> x,y f(x ,y )<f(x ,y ) 1 1 2 2 ∂x ∂y 成立的一个充分条件是（） ，y ，y
>  A. x >x <y B. x >x >y 1 2 1 2 1 2 1 2 ，y ，y C. x <x <
> y D. x <x >y 1 2 1 2 1 2 1 2
>
> 题源：2012 数二; 880 第四章综合选择 5; 26 版 660 数一二三第 228 题　|　题源类型：真题　|　页码：p.368　|　模块：4.1 单调性
