...
源题号: "3.2.1.1-008"
序: 2809
题源: "2022 数一; 26 版 1000 第十三章基础 14"
题源大类: "真题"
重点: false
页码: 348
状态: "未开始"
...
备注:
---
# 3.2.1.1-008 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> y ∂z ∂z =y2(lny−lnx)，则（ 设 可导，z ，若 ） (2) f(u) =xyf x +y
>  x ∂x ∂y 1 1 f′(1)=0 f′(1)=− A. f(1)= , B. f(1)=0, 2 2
>  1 f′(1)=1 f′(1)=1 C. f(1)= , D. f(1)=0, 2
>
> 题源：2022 数一; 26 版 1000 第十三章基础 14　|　题源类型：真题　|　页码：p.348　|　模块：3.2 多元复合函数求偏导
