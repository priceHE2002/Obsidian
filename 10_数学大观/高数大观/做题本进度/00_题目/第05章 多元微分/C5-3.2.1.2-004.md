...
备注:
---
# 3.2.1.2-004 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z ∂2z =xf(x−y)+yg(x+y)，其中 − 设 与 有二阶连续导数，则 等于 z f g ∂
> x2 ∂y2 2(f′−g′) f′−g′ f′+g′ xf′′+yg′′ A. B. C. D.
>
> 题源：26 版 660 数一二三第 233 题　|　题源类型：660　|　页码：p.349　|　模块：3.2 多元复合函数求偏导
