...
备注:
---
# 1.2-002 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> ( ̸=0, xy, xy 设 则下列命题成立的个数为 f(x,y)= 1, xy =0. 在 点处两个偏导
> 数都存在. (1) f(x,y) (0,0) ′ ′ ′ ′ (0,0)，且 (2) limf (x,0)=
> f limf (0,y)=f (0,0). x x y y x→0 y→0 在 点处两个偏导数都连续. (3
> ) f(x,y) (0,0) 在 点处可微. (4) f(x,y) (0,0) A. 1 B. 2 C. 3
>  D. 4
>
> 题源：26 版 660 数一二三第 242 题　|　题源类型：660　|　页码：p.334　|　模块：1.2 已知具体多元函数判断其他
