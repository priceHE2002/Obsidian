...
备注:
---
# 3.2.2.1-006 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂z ∂z −y 设函数 与 均可微，z =f[xy,lnx+g(xy)]，则 )。 f g x =( ∂x
>  ∂y f′ f′ f′ +f′ f′ −f′ A. B. C. D. 1 2 1 2 1 2 ·第 页，共
>  页· 338 402
>
> 题源：26 版 1000 第十三章强化 16　|　题源类型：1000　|　页码：p.349　|　模块：3.2 多元复合函数求偏导
