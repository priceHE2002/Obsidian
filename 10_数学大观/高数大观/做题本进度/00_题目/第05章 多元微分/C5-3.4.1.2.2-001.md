...
备注:
---
# 3.4.1.2.2-001 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z f(z−x,z−y)=1 设 存在二阶连续偏导数，z 是由方程 确定的隐函数，求 f(u,v) =z
> (x,y) ∂x∂y 一个方程两个未知数
>
> 题源：26 版 1000 第十三章强化 20　|　题源类型：1000　|　页码：p.360　|　模块：3.4 多元隐函数求偏导
