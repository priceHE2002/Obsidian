...
备注:
---
# 3.2.1.1-009 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> p 2y2 y ∂z ∂z p 设函数 ，则 ，且 可导，若 x2+y2f z = +y = f(u) x 
> x ∂x ∂y x2+y2 f′(1)=0 f′(1)=1 A. f(1)=1, B. f(1)=0, f′
> (1)=0 f′(1)=1 C. f(1)=0, D. f(1)=1,
>
> 题源：26 版 660 数一二三第 229 题　|　题源类型：660　|　页码：p.348　|　模块：3.2 多元复合函数求偏导
