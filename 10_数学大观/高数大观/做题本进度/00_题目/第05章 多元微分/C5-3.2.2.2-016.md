...
备注:
---
# 3.2.2.2-016 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z ∂2z ∂2z =xy−z，z =0，作变换 u=x+y， 【22】设 有二阶连续的偏导数，且满足 
> +2 w =z(x,y) + ∂x2 ∂y2 ∂x∂y =x−y。 v ∂2w （I）求 ； ∂u2 v2 
> ∂w(0,v) =ve−v，w(0,v)= （II）若 ，求 的表达式。 z(x,y) ∂u 4
>
> 题源：880 第四章综合解答 22　|　题源类型：880　|　页码：p.351　|　模块：3.2 多元复合函数求偏导
