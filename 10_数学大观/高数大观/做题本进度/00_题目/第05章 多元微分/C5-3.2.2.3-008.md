...
备注:
---
# 3.2.2.3-008 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z 已知函数f(u,v) 具有二阶连续偏导数，f(1,1)=1 是f(x,y) 的极值，且z =f[xy
> ,f(x,y)]，则 = ∂x∂y (1,1) )。 ( f′′ (1,1)+f′′ 2f′′ A. (1,
> 1) B. (1,1) uu vv uv ·第 页，共 页· 342 402
>
> 题源：26 版 1000 第十三章强化 43　|　题源类型：1000　|　页码：p.353　|　模块：3.2 多元复合函数求偏导
