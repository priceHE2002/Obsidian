...
备注:
---
# 3.3.1-001 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> ( u=x−2y, ∂2z ∂2z ∂2z ∂2z − （2）设变换 可把方程 简化为 =0，求常数 a。（
> 这里应假设 6 + =0 ∂x2 ∂y2 ∂x∂y ∂u∂v v =x+ay 有二阶连续偏导数） z
>
> 题源：1996 数一　|　题源类型：真题　|　页码：p.354　|　模块：3.3 利用变量代换化简偏微分方程
