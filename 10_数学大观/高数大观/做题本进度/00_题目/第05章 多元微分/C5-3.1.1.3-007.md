...
> ∂f(x,y) ∂f(x,y) f(x+y,x−y)=x2−y2 已知函数 对任何 与 成立，则 等于 x 
> y + ∂x ∂y 2x−2y x−y A. B. 2x+2y C. x+y D. 二阶偏导
>
> 题源：26 版 660 数一二三第 230 题　|　题源类型：660　|　页码：p.345　|　模块：3.1 多元函数求偏导
