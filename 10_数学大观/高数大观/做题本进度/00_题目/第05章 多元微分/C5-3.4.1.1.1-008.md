...
备注:
---
# 3.4.1.1.1-008 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z y ∂z ∂z f(x+y−t)dt确定二元函数z 设f(x)为连续函数，且x2+y2+z2 =z(x,
> y)，则z = + = ∂x ∂y x
>
> 题源：25 版 660 数一二三第 103 题　|　题源类型：660　|　页码：p.356　|　模块：3.4 多元隐函数求偏导
