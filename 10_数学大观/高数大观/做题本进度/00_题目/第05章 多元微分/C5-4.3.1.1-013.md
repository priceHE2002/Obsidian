...
> √ x2，f′(x,0) 2x，f′′ 设函数 具有二阶连续偏导数，且满足 4，求 在约 f(x,y) f(
> x,0) = = (x,y) = f(x,y) y yy x2+2y2 束条件 下的最大值与最小值。 =4
>
> 题源：26 版 1000 第十三章强化 34　|　题源类型：1000　|　页码：p.377　|　模块：4.3 条件极值
