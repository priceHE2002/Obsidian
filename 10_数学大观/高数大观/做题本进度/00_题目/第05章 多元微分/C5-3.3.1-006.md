...
备注:
---
# 3.3.1-006 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2u ∂2u ∂2u 设函数 具有二阶连续偏导数，且满足等式 =0。确定 的值，使等式在 u=f(x,y)
>  2 +3 + a,b ∂x2 ∂y2 ∂x∂y ∂2u (ab̸=2) 变换 =x+ay，η 下简化为 =
> 0。 ξ =bx+2y ∂ξ∂η
>
> 题源：900 第四章数二 A 类 38　|　题源类型：900　|　页码：p.355　|　模块：3.3 利用变量代换化简偏微分方程
