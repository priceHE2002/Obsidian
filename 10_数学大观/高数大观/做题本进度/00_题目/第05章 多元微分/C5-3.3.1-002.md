...
备注:
---
# 3.3.1-002 · 利用变量代换化简偏微分方程

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2u ∂2u ∂2u 设函数 具有二阶连续偏导数，且满足等式 =0。确定 的值，使等式 u=f(x,y) 
> 4 +12 +5 a,b ∂x2 ∂y2 ∂x∂y ∂2u =0。 在变换 下简化为 ξ =x+ay,η =
> x+by ∂ξ∂η
>
> 题源：2010 数二　|　题源类型：真题　|　页码：p.354　|　模块：3.3 利用变量代换化简偏微分方程
