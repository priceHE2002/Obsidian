...
备注:
---
# 3.4.1.1.1-010 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ezyz2，若 设函数 是由方程 所确定的隐函数，记 f(x,y,z) = z = z(x,y) x+y +
> z +xyz = 0 g(x,y) = g′(0,1)= f(x,y,z(x,y))，则 y ▶3.4.1.
> 1.2 抽象
>
> 题源：900 第四章数二 A 类 23　|　题源类型：900　|　页码：p.356　|　模块：3.4 多元隐函数求偏导
