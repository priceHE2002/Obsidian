...
> +2xez−x−y −y 设 所确定的隐函数，则函数 是由方程 在点 处的全微分 = z(x,y) z z(
> x,y) (0,1) z = 0 = dz (0,1) −2dx+dy A. 2dx+dy B. 2dx−d
> y −2dx−dy C. D.
>
> 题源：26 版 660 数一二三第 232 题　|　题源类型：660　|　页码：p.363　|　模块：3.5 求全微分
