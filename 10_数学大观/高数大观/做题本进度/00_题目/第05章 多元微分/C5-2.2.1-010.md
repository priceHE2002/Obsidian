...
> f(x,y)−a−bx−cy 设f(x,y)在点(0,0)处连续，且 =1，其中a,b,c为常数，则df(x
> ,y) lim = ln(1+x2+y2) (0,0) (x,y)→(0,0)
>
> 题源：26 版 660 数一二三第 100 题　|　题源类型：660　|　页码：p.340　|　模块：2.2 已知重极限推导其他
