...
备注:
---
# 3.4.1.2.1-008 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z 3xy+2x−4y−z =ez 设 是由方程 确定的隐函数，且 z(1,1)=0，则 = z =z(
> x,y) ∂x∂y (1,1) 1 1 1 1 A. 4 B. 2 C. 4 D. 8 2 8 4 4 ·第
>  页，共 页· 348 402
>
> 题源：26 版 660 数一二三第 234 题　|　题源类型：660　|　页码：p.359　|　模块：3.4 多元隐函数求偏导
