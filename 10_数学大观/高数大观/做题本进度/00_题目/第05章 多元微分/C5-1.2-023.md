...
备注:
---
# 1.2-023 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> ( 0, xy =0, 设函数 若函数 在点 处可微，则 可能为（） g(x,y)= F(x,y)=f(x,
> y)g(x,y) (0,0) f(x,y) ̸=0. 1, xy x2+y2 A. y+cosxy B. y
> +sinxy C. siny+xy D.
>
> 题源：900 第四章数二 B 类 6　|　题源类型：900　|　页码：p.337　|　模块：1.2 已知具体多元函数判断其他
