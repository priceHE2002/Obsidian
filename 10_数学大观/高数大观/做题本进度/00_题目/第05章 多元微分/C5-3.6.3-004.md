...
备注:
---
# 3.6.3-004 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> f′(0,y) y =coty，f′(x,y)=−f(x,y)， （第二十届北京市大学生数学竞赛题，2009
>  年）设 可微，满足 f(x,y) x f(0,y) π 且 =1，求 f(x,y)。 f 0, 2
>
> 题源：2009 年第十二届北京市大学生数学竞赛题（重点）　|　题源类型：真题　|　页码：p.367　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
