...
备注:
---
# 1.2-008 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 >< xαyβ ̸=0, x2+y2 , x2+y2 【例 5.1】设 其中 证明： f(x,y)= α
> >0,β >0. >: x2+y2 0, =0, ⇔α+β 在点 处连续 (I) f(x,y) (0,0) 
> >2. ⇔α+β 在点 处可微 (II) f(x,y) (0,0) >3.
>
> 题源：姜晓千真题同源 150（重点）　|　题源类型：真题同源　|　页码：p.335　|　模块：1.2 已知具体多元函数判断其他
