...
> ( x=u+vz, 设方程组 在点(2,1,1)的某一个邻域内确定隐函数u(x,y,z)与v(x,y,z)，
> 且u(2,1,1)> =−u2+v+z y (cid:19)(cid:12) ∂u ∂v ∂u 0，则 + 
> + = ∂x ∂y ∂z (2,1,1) 1 1 A. B. 9 3 三个方程四个未知数
>
> 题源：26 版 660 数一二三第 246 题　|　题源类型：660　|　页码：p.362　|　模块：3.4 多元隐函数求偏导
