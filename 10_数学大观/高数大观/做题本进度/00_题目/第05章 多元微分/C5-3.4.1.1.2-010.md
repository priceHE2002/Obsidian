...
备注:
---
# 3.4.1.1.2-010 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> 若由方程 可确定有连续偏导数的三个函数 h(x,y)，则下列结论 F(x,y,z) = 0 x = f(y,
> z), y = g(z,x), z = 中，正确的是（ ） ·第 页，共 页· 346 402
>
> 题源：900 第四章数二 A 类 11　|　题源类型：900　|　页码：p.357　|　模块：3.4 多元隐函数求偏导
