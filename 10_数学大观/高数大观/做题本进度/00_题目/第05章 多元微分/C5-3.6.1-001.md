...
备注:
---
# 3.6.1-001 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> f′(x,y) f(x,sinx)=x+sinx，f′(x,y)=1+2cosx，则 设函数 = . y x
>  y=sinx
>
> 题源：26 版 1000 第十三章基础 6　|　题源类型：1000　|　页码：p.365　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
