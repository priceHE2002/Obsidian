...
备注:
---
# 3.6.1-006 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2[f(x,y)] 设函数 具有二阶连续偏导数，且满足 1，f(0,y) siny，f(x,0) sinx
> ，则 f(x,y) = = = ∂x∂y π π f , = . 2 2 已知全微分
>
> 题源：26 版 1000 第十三章基础 7　|　题源类型：1000　|　页码：p.366　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
