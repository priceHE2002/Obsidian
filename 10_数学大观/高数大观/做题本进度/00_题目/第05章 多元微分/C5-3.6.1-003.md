...
备注:
---
# 3.6.1-003 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> ∂2z f(x,0)=x，f(0,y)=y2，则 设 满足 =x+y，且 z =f(x,y) f(x,y)=
>  ∂x∂y
>
> 题源：25 版 660 数一二三第 96 题　|　题源类型：660　|　页码：p.365　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
