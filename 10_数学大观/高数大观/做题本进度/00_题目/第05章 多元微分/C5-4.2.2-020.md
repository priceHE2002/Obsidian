...
> =x3+y2 =(x2+y2)2，易知有驻点 设函数 与 (0,0)，则在该点处（） z z 1 2 =x3
> +y2 =(x2+y2)2 函数 有极小值，而函数 无极值 A. z z 1 2 =x3+y2 =(x2+y
> 2)2 函数 无极值，而函数 有极小值 B. z z 1 2 上述两个函数都有极值 C. 上述两个函数都无极
> 值 D.
>
> 题源：26 版 1000 第十三章强化 48　|　题源类型：1000　|　页码：p.371　|　模块：4.2 无条件极值
