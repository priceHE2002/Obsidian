...
备注:
---
# 3.2.2.2-015 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> g(x,y)=f(2x+y,3x−y) 已知函数 具有 阶连续偏导数，且函数 满足 f(u,v) 2 ∂2g
>  ∂2g ∂2g −6 + =1. ∂x2 ∂y2 ∂x∂y ∂2f （I）求 ； ∂u∂v ∂f(u,0)
>  1 =ue−u，f(0,v)= v2−1，求 （II）若 的表达式。 f(u,v) ∂u 50
>
> 题源：2024 数二　|　题源类型：真题　|　页码：p.351　|　模块：3.2 多元复合函数求偏导
