...
> f(x,y)=x3+y3−(x+y)2+3，设 已知函数 是曲面 在点 处的切平面，D 为 与坐 T z =
> f(x,y) (1,1,1) T 标平面所围有界区域在 平面上的投影. xOy 求 的方程； (I) T 求
>  在 上的最大值和最小值. (II) f(x,y) D
>
> 题源：2024 数一　|　题源类型：真题　|　页码：p.382　|　模块：4.4 闭区域最值
