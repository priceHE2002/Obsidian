...
备注:
---
# 3.6.2-004 · 已知偏导数相关求多元函数（偏积分）

> [!question] 题目（程序自动提取，公式可能有偏差）
> df(x,y)=(2y2+2xy+3x2)dx+(4xy+x2)dy，则 已知 f(x,y)= 2xy2+x
> 2y 2xy2+x2y+x3 A. B. 2xy2+x2y+x3+C 3xy2+x2y+x3+C C. D.
>
> 题源：26 版 660 数一二三第 249 题　|　题源类型：660　|　页码：p.366　|　模块：3.6 已知偏导数相关求多元函数（偏积分）
