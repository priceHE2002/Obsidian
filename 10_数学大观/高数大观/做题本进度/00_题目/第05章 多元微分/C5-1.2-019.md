...
备注:
---
# 1.2-019 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 1 >< yarctanp (x,y)̸=(0,0) , x2+y2 【3】设 则 在点 处（ ） f(
> x,y)= f(x,y) (0,0) >: 0, (x,y)=(0,0) 连续但不可微 偏导数存在但不连续 
> A. B. 可微 连续但偏导数不存在 C. D.
>
> 题源：880 第四章综合选择 3　|　题源类型：880　|　页码：p.337　|　模块：1.2 已知具体多元函数判断其他
