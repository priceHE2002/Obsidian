...
备注:
---
# 3.2.2.1-007 · 多元复合函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> =6dx+5dy，则f′(6,5)+f′(6,5)= dz| 设函数f(u,v) 具有连续偏导数，z =f(
> xy,x+y)。若 x=2 u v y=3 ▶3.2.2.2 常规二阶
>
> 题源：26 版 1000 第十三章强化 8　|　题源类型：1000　|　页码：p.350　|　模块：3.2 多元复合函数求偏导
