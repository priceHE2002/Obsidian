...
备注:
---
# 3.4.1.1.3-003 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> Z t 0，f′(0,1) 设函数 在点 的某邻域内一阶偏导数连续，f(0,1) 1，则 f(x,y) (0
> ,1) = = f x, lnxdx = 0 y 1 （）。 ·第 页，共 页· 347 402
>
> 题源：26 版 1000 第十三章强化 47　|　题源类型：1000　|　页码：p.358　|　模块：3.4 多元隐函数求偏导
