...
备注:
---
# 1.2-022 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> p 已知函数 可微，其中 为可导函数，则 可能是以下四个函数中的（ ） x2+y2) f(x,y)=g( g
> (t) g(t) et cost2 A. 2t B. C. D. sint
>
> 题源：900 第四章数二 B 类 1　|　题源类型：900　|　页码：p.337　|　模块：1.2 已知具体多元函数判断其他
