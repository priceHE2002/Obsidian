...
备注:
---
# 3.4.1.1.2-011 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> F′(1,1,1) −2，F′(1,1,1) 设方程 确定隐函数 若已知 可微，且 2， F(x,y,z) 
> = 0 z = z(x,y). F(x,y,z) = = x y z′(1,1)=3，则 z′(1,1) 和
>  等于 z(1,1)=1 y x −3 −4 A. B. C. 3 D. 4
>
> 题源：26 版 660 数一二三第 247 题　|　题源类型：660　|　页码：p.358　|　模块：3.4 多元隐函数求偏导
