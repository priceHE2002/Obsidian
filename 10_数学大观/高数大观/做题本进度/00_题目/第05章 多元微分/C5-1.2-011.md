...
备注:
---
# 1.2-011 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 >< xy3 (x,y)̸=(0,0), , x2+y2 则 在点 处（ ） 设函数 f(x,y) (0
> ,0) f(x,y)= >: 0, (x,y)=(0,0), 不连续，偏导数也不存在 偏导数存在，但不连续 
> A. B. 连续且偏导数存在，但不可微 可微 C. D.
>
> 题源：900 第四章数二 B 类 4　|　题源类型：900　|　页码：p.335　|　模块：1.2 已知具体多元函数判断其他
