...
备注:
---
# 1.2-017 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 xy <p (x,y)̸=(0,0), , x2+y2 设 则 在点 处 f(x,y)= f(x,y) 
> (0,0) : 0, (x,y)=(0,0), 两个偏导数都不存在。 两个偏导数都存在但不可微。 A. B.
>  偏导数连续。 可微但偏导数不连续。 C. D. ·第 页，共 页· 325 402
>
> 题源：26 版 660 数一二三第 227 题　|　题源类型：660　|　页码：p.336　|　模块：1.2 已知具体多元函数判断其他
