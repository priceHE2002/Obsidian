...
> f(x,y)=x3−y3−3x+3y，则（）. 设 f(1,−1) 是极大值，f(−1,1) f(1,−1)
>  是极小值，f(−1,1) 是极小值 是极大值 A. B. 是极大值，f(−1,−1) 是极小值，f(−1,
> −1) 是极小值 是极大值 C. f(1,1) D. f(1,1)
>
> 题源：26 版 1000 第十三章强化 38　|　题源类型：1000　|　页码：p.371　|　模块：4.2 无条件极值
