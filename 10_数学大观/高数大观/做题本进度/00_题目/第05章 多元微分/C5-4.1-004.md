...
> |x | |x |, 已知二元函数 存在一阶偏导数. 对于任意 若 则 对于任意 若 f(x,y) y, >
>  f(x ,y) > f(x ,y); x, 1 2 1 2 |y |>|y |, 则 下列结论中, 正确的
> 是 f(x,y )<f(x,y ). ( ) 1(cid:12) 2 1 2 ∂f(cid:12) ∂f(c
> id:12) ∂f(cid:12) ∂f(cid:12) ⩾ ⩾ A. B. ∂x ∂ y ∂x ∂y (c
> id:12)(−1,1) (1,−1) (cid:12)(1,−1) (−(cid:12)1,1) ∂f(c
> id:12) ∂f(cid:12) ∂f(cid:12) ∂f(cid:12) ⩾ ⩾ D. C. ∂x ∂
> y ∂x ∂y (−1,−1) (−1,−1) (1,1) (1,1) 无条件极值
>
> 题源：900 第四章数二 A 类 7　|　题源类型：900　|　页码：p.368　|　模块：4.1 单调性
