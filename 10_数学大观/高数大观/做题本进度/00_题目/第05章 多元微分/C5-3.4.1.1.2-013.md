...
备注:
---
# 3.4.1.1.2-013 · 多元隐函数求偏导

> [!question] 题目（程序自动提取，公式可能有偏差）
> 1 φ′(t)̸=− 2xy−z 设 是由方程 所确定的函数，其中 具有二阶导数，且 . z =z(x,y)
>  =φ(x+2y+3z) φ(t) 3 求 dz； (I) 1 ∂z ∂u ∂z ∂u − − 记 ，求 (
> II) u(x,y)= . 2 x−2y ∂x ∂y ∂x ∂y ▶3.4.1.1.3 隐函数存在定理
>
> 题源：900 第四章数二 B 类 25　|　题源类型：900　|　页码：p.358　|　模块：3.4 多元隐函数求偏导
