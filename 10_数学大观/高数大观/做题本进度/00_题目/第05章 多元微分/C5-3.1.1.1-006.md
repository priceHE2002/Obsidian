...
> 设函数 8 p 1 < (x,y)̸=(0,0), x2+y2sin , x2+y2 f (x,y)= 1 
> : 0, (x,y)=(0,0), 8 1 >< (x2+y2)sinp (x,y)̸=(0,0), , x
> 2+y2 f (x,y)= 2 >: 0, (x,y)=(0,0), 则（ ） 在点 处，f 和 的偏导数均
> 存在 A. (0,0) (x,y) f (x,y) 1 2 在点 处，f 的偏导数不存在，f 的偏导数存在 
> B. (0,0) (x,y) (x,y) 1 2 在点 处，f 的偏导数存在，f 的偏导数不存在 C. (0
> ,0) (x,y) (x,y) 1 2 在点 处，f 和 的偏导数均不存在 D. (0,0) (x,y) f
>  (x,y) 1 2 ▶3.1.1.2 常规 ·第 页，共 页· 332 402
>
> 题源：900 第四章数二 A 类 4　|　题源类型：900　|　页码：p.343　|　模块：3.1 多元函数求偏导
