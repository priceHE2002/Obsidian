...
备注:
---
# 1.2-003 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> f(x,y)=x|x|+x|y|+y|x|+y|y|，则以下命题： 已知函数 ⃝ limf(x,y)=f(0
> ,0)； 1 x→0 y→0 ∂f(0,0) ⃝ =0； 2 ∂x ∂f(0,0) ⃝ =1； 3 ∂y ⃝
>  df(0,0)=0。 4 正确命题的个数为（ ）。 A. 1 B. 2 C. 3 D. 4
>
> 题源：26 版 1000 第十三章强化 3　|　题源类型：1000　|　页码：p.334　|　模块：1.2 已知具体多元函数判断其他
