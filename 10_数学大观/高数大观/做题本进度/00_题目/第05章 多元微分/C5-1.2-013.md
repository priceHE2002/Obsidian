...
备注:
---
# 1.2-013 · 已知具体多元函数判断其他

> [!question] 题目（程序自动提取，公式可能有偏差）
> 8 >< x2y (x,y)̸=(0,0), , x2+y2 设 则 在点 处 f(x,y)= f(x,y)
>  (0,0) >: 0, (x,y)=(0,0), 不连续. 连续但偏导数不存在. A. B. 连续且偏导数
> 存在但不可微. 可微. C. D.
>
> 题源：26 版 660 数一二三第 241 题　|　题源类型：660　|　页码：p.336　|　模块：1.2 已知具体多元函数判断其他
