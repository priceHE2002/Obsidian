...
| 21 | [[LoRA]] | rank=32, 7B 模型 | ~22GB (bf16) | ~14GB | QLoRA 4-bit: ~12-16GB ✅ |
...
- **VLA 关键组件**：DINOv2 推理（OpenVLA 的空间编码器）、Llama 2 7B 量化推理 + LoRA 微调（QLoRA r=32 在 RTX 4070 Ti 16GB 上 batch_size=1 可行）
...
| 21 | [[LoRA]] | 用低秩分解 `BA` 近似全量微调的权重更新，使 7B VLA 在消费级 GPU 上可微调 |
