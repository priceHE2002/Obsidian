...
按技术发展脉络排列，覆盖从深度学习革命（AlexNet, 2012）到现代 LLM 基础架构的核心演进。共 **22 篇论文**（LoRA 已移至 [[../03_训练基础设施/03_训练基础设施论文精讲.md|03_训练基础设施]]），分为四大主题：**CNN 架构演进**（6 篇）、**归一化技术**（3 篇）、**Transformer 与视觉基础模型**（7 篇）、**生成模型与 VLA 训练基础设施**（6 篇）。
...
### 22. LoRA — 已移至 [[../03_训练基础设施/12_LoRA/LoRA.md|03_训练基础设施]]

**LoRA（Low-Rank Adaptation）** 从"深度学习基础"移至"训练基础设施"专题。作为 PEFT 领域引用量最高的论文（~28,000+），LoRA 在训练效率方面的影响远超基础理论范畴。详见 [[../03_训练基础设施/03_训练基础设施论文精讲.md|03_训练基础设施论文总览]] 的第七节。
...
**LoRA 移至 [[../03_训练基础设施/03_训练基础设施论文精讲.md|03_训练基础设施]]** ——LoRA、QLoRA、DoRA、Adapter 等 PEFT 技术现已独立成专题。

**学完 Level 4 你应该能回答：**
- Llama 2 的四个架构特性分别解决了什么问题？
- LoRA 的秩 r 选 8、32 还是 64？各自的权衡是什么？（参考 [[../03_训练基础设施/12_LoRA/LoRA.md|03_训练基础设施/LoRA]]）
...
**LoRA 移至 [[../03_训练基础设施/03_训练基础设施论文精讲.md|03_训练基础设施]]** —— LoRA、QLoRA 的硬件需求详见训练基础设施总览。
